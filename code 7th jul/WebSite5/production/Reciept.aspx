...
<head runat="server">
    ...
    <style>
        ...
        #img1 {
         ...
         #update,#receiptCode,#head,#Venue,#directory,#insert,#receiptStart,#Status,#receiptID{
             display:none;
         }
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    data: "{'venue':'" + venue + "','receiptStart':'" + receiptStart + "','receiptCode':'" + receiptCode + "'}",
                    async: false,
                          ...
                          //  alert(data.d);
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td></tr>");
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'receiptID':'" + receiptID + "','venue':'" + venue + "','receiptStart':'" + receiptStart + "','receiptCode':'" + receiptCode + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox2").val("");
                            $("#TextBox3").val("");
