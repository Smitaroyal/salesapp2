...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD FLYBUY AGENT</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="fly_Agent_ID">
                  <div class="form-group">
                      <label for="sel1">Flybuy Agent ID:</label>
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="fly_Agent_Name">
                  <div class="form-group">
                      <label for="sel1">Flybuy Agent  Name:</label>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center"> FLYBUY AGENT DIRECTORY</h4>
                               </div>
