...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD FLYBUY OFFICE SOURCE</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="fly_off_ID">
                  <div class="form-group">
                      <label for="sel1">Flybuy_Office_Source ID:</label>
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="fly_off_Name">
                  <div class="form-group">
                      <label for="sel1">Flybuy_Office_Source  Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Country" runat="server"></asp:TextBox>
                  </div>
              </div>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center"> FLYBUY OFFICE SOURCE DIRECTORY</h4>
                               </div>
