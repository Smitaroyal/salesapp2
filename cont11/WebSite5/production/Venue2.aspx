...
box-shadow: -1px 1px 3px 0px rgba(0,0,0,0.75);
    ...
    #success-alert,#danger-alert,#danger-alert1{
      ...
      #update,#head,#venue2ID,#venueCountry,#venue2Name,#venue2Status,#Venue,#directory,#insert,#Type1,#cgsCode,#cglCode,#fgsCode,#fglCode,#fiVal{
          display:none;
      }
      #TextBox5{
          text-align:center;
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    data: "{'venue2Name':'" + venue2Name + "','venueCountry':'" + venueCountry + "','venue':'" + venue + "','cgsCode':'" + cgsCode + "','cglCode':'" + cglCode + "','fgsCode':'" + fgsCode + "','fglCode':'" + fglCode + "','fiVal':'" + fiVal + "'}",
                    async: false,
                           ...
                           // alert(data.d);
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td style='display:none;'>" + value1[3] + "</td><td>" + value1[4] + "</td><td style='display:none;'>" + value1[5] + "</td><td>" + value1[6] + "</td><td>" + value1[7] + "</td><td>" + value1[8] + "</td><td>" + value1[9] + "</td><td>" + value1[10] + "</td><td>" + value1[11] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'venue2ID':'" + venue2ID + "','venue2Name':'" + venue2Name + "','status':'" + status + "','venueCountry':'" + venueCountry + "','venue':'" + venue + "','cgsCode':'" + cgsCode + "','cglCode':'" + cglCode + "','fgsCode':'" + fgsCode + "','fglCode':'" + fglCode + "','fiVal':'" + fiVal + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
