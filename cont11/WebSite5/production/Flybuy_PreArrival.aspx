...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD FLYBUY PRE ARRIVAL</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="fly_PreArrival_ID">
                  <div class="form-group">
                      <label for="sel1">Flybuy Pre Arrival ID:</label>
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="fly_PreArrival">
                  <div class="form-group">
                      <label for="sel1">Flybuy Pre Arrival:</label>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center">FLYBUY PRE ARRIVAL DIRECTORY</h4>
                               </div>
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    if (confirmation) {
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            data: "{'flyPreArrivalID':'" + flyPreArrivalID + "'}",
                            async: false,
                            success: function (data) {
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
                                    $("#success-alert").slideUp(500);
