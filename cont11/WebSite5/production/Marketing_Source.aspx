...
box-shadow: -1px 1px 3px 0px rgba(0,0,0,0.75);
    ...
    #success-alert,#danger-alert,#danger-alert1{
      ...
      #update,#head,#marktSourceID,#marktSourceName,#marktSourceStatus,#Markt,#directory,#insert,#Type1{
          display:none;
      }
      #TextBox5{
          text-align:center;
    ...
    <script>
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    if (confirmation) {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            data: "{'marktSourceID':'" + marktSourceID + "'}",
                            async: false,
                            success: function (data) {
        ...
        <script>
            $(document).ready(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Marketing_Source.aspx/getAllMarketing',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
