...
public partial class Contractsite_Edit_Contract : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
           ...
           // contsalesrepDropDownList.Items.Add(ds5.Tables[0].Rows[0]["Contract_Finance_Sales_Rep"].ToString());
            ...
            DataSet dsec19 = Queries2.LoadTOManager(officeo, VenueDropDown, vencountry, GroupVenueDropDownListval);
            ...
            DataSet dsec20 = Queries2.LoadButtonUp(officeo, VenueDropDown, vencountry, GroupVenueDropDownListval);
            ...
            else if (conttype == "Points")
            {
                ...
                GlobContClub = ds5.Tables[0].Rows[0]["CT_Points_Club"].ToString();
            ...
            else if (conttype == "Trade Into Points")
            {
                ...
                GlobContClub = ds5.Tables[0].Rows[0]["TP_New_CLub"].ToString();
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            int PmentDetails = Queries2.InserPaymentDetails(PmentDetailsId, PCard_Type, PIssuing_Bank, PCredit_Card_No, PCard_Holders_Name, PExpiry, PSecurity_No,
                       PFor_Depo, PFor_Bala, SCard_Type, SIssuing_Bank, SCredit_Card, SCard_Holders_Name, SExpiry, SSecurity_No, SFor_Depo, SFor_Bala, ProfileIDo, fracido, entrydate, officeo, Pcomments, Scomments);
        ...
        else if(conttype == "Trade Into Points")
        {
            ...
            int contup = Queries2.UpdatePointPS(Deposit_PM, DepositP, DepoPPA, DepositSAP, AdmissFeesP, ApplicationFeesP, AdminFeesP, AdminServiceP, PurchasePriceP, TotalServicePriceP, CoutryTaxP, GrandTotalP, BalanceDuePAP, BalanceDueSAP, PANoOfInstallP, PAFirstPayDateP, PAAmountInstallP, PAFirstInstallP, BalanceDueDatesPAP, BalanceDueDatesSAP, RemarksP, TotalBalance, EuroRatesF, AusRatesF, GbpRatesF, IdaRatesF, YearOfInterestP, DateTime.Now.ToString(), fracido, InitDepotp, BalDepotp, DepoDatetp, remarkTP2, BalanceDueDatesPATP2, BalanceDueDatesSATP2,CPATP,IniBalNoInstallTP,IniBalInstAmtTP,BalloonPay,LastInstDate,CPADepoTP);
            int contFina = Queries2.UpdateContFrac(affilice, affilhp, salesrep, tomanager, buttonup, FinaCurrency, PurchasePrice, AdminFees, MCFees, DealDrawer, PaymentMethod, FinanceNumb, ID_Card, CrownCurr, fracido, DealRegDate, ft1, ft2, DateTime.Now,cweekno,ContComment, PaymentMethodDeatils);
        ...
        DataSet ds21 = Queries2.LoadPrintFiles(ContType1, officeo,GlobContClub);
    ...
    public static string SalesRepTypeList(string venueid, string countid,string venue)
    {
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnectionString"].ConnectionString))
        {
            ...
            else
            {
                ...
                using (SqlCommand cmd = new SqlCommand("select Sales_Rep_Name  from Sales_Rep where Venue_country_ID='" + vencountry + "' and venue= '" + venue + "'", con))
                {
                    con.Open();
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    da.Fill(dt);
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, membertype2, employmentstatus, Secondemploymentstatus, maritalstatus, primarytitle, primarynationality, leadsource,prearrival,verifi,comm1;
            ...
            int updateprofile = Queries2.UpdateProfile(profile, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs, "", "", "", comm1, reception, subvenue, regTerms, VPID,regTerms2, Secondemploymentstatus, leadsource,prearrival,verifi);
