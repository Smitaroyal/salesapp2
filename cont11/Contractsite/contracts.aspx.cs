...
public partial class _Default : System.Web.UI.Page
{
        ...
        if (!Page.IsPostBack)
        {
          ...
          //  SecCountryDropDownList.DataBind();
           ...
           // salesrepDropDownList.Items.Add(ds4.Tables[0].Rows[0]["Tour_Details_Guest_Sales_Rep"].ToString());
            ...
            DataSet ds19 = Queries2.LoadTOManager(officeo, VenueDropDownListval,vencountry, GroupVenueDropDownListval);
            ...
            DataSet ds20 = Queries2.LoadButtonUp(officeo, VenueDropDownListval,vencountry, GroupVenueDropDownListval);
        ...
        try
        {
            ...
            if (conttype == "Points")
            {
                ...
                int PurchaseService2 = Queries2.InserPurchaseService(contPASAid, Deposit_PM, DepositP, DepoPPA, DepositSAP, AdmissFeesP, ApplicationFeesP, AdminFeesP, AdminServiceP, PurchasePriceP, TotalServicePriceP, CoutryTaxP, GrandTotalP, BalanceDuePAP, BalanceDueSAP, PANoOfInstallP, SANoOfInstallP, PAFirstPayDateP, SAFirstPayDateP, PAAmountInstallP, SAAmountInstallP, PAFirstInstallP, SAFirstInstallP, BalanceDueDatesPAP,
                  BalanceDueDatesSAP, RemarksP, EuroRatesP, AusRatesP, GbpRates, IdaRates, UsePayProtectP, YearOfInterestP, ProfileIDo, contfinaid, TotalBalance, DateTime.Now, officeo,BalanceDueDatesPAP2,BalanceDueDatesSAP2,RemarksP2,InitDepop,BalDepop,DepoDatep,CPAP, IniBalNoInstallP,IniBalInstAmtP,BalloonPay,LastInstDate,CPADepo);
            ...
            else if (conttype == "Fractional")
            {
                ...
                int PurchaseService = Queries2.InserPurchaseService(contPASAid, Deposit_PM, DepositF, "", "", AdmissFeesF, "", AdminFeesF, "", PurchasePriceF, "", CoutryTaxF, "", BalanceDuePAF, "", PANoOfInstallF, "", PAFirstPayDateF, "", PAAmountInstallF, "", PAFirstInstallF, "", BalanceDueDatesPAF,
                    "", RemarksF, EuroRatesF, AusRatesF, GbpRatesF, IdaRatesF, UsePayProtectF, YearOfInterestP, ProfileIDo, contfinaid, TotalBalanceF, DateTime.Now, officeo, BalanceDueDatesPAF2, "", RemarksF2, InitDepof, BalDepof,DepoDatef,CPAF,IniBalNoInstallF,IniBalInstAmtF,BalloonPay,LastInstDate,CPADepoF);
            ...
            else if (conttype == "Trade Into Fractional")
            {
                ...
                int PurchaseService = Queries2.InserPurchaseService(contPASAid, Deposit_PM, DepositTF, "", "", AdmissFeesTF, "", AdminFeesTF, "", PurchasePriceTF, "", CoutryTaxTF, "", BalanceDuePATF, "", PANoOfInstallTF, "", PAFirstPayDateTF, "", PAAmountInstallTF, "", PAFirstInstallTF, "", BalanceDueDatesPATF,
                    "", RemarksTF, EuroRatesP, AusRatesP, GbpRates, IdaRates, UsePayProtectP, YearOfInterestP, ProfileIDo, contfinaid, TotalBalanceTF, DateTime.Now, officeo, BalanceDueDatesPATF2, "", RemarksTF2, InitDepotf,BalDepotf,DepoDatetf,CPATF,IniBalNoInstallTF,IniBalInstAmtTF,BalloonPay,LastInstDate, CPADepoTF);
            ...
            else if (conttype == "Trade Into Points")
            {
              ...
              //  string DepositPayMethodTP = "";//DPMTPointsDropDownList.SelectedItem.Text;
                ...
                BalanceDueDatesSATP, remarkTP, EuroRatesP, AusRatesP, GbpRates, IdaRates, UsePayProtectP, YearOfInterestP, ProfileIDo, contfinaid, TotalBalanceTP, DateTime.Now, officeo,BalanceDueDatesPATP2,BalanceDueDatesSATP2,remarkTP2,InitDepotp,BalDepotp,DepoDatetp,CPATP,IniBalNoInstallTP,IniBalInstAmtTP,BalloonPay,LastInstDate,CPADepoTP);
   ...
   /* protected void Button5_Click(object sender, EventArgs e)
    ...
    public static string helo1(string name,string venue,string club,string mark, string conttype, string markp)
    {
        ...
        {
             finaInstI = Queries2.LoadPointCont(officeo, club, name, venue, mark,markp);
        }
        else if (conttype == "Fractional" || conttype == "Trade Into Fractional")
        {
             finaInstI = Queries2.LoadFracCont(officeo, club, name, venue, mark,markp);
        }
        //using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnectionString"].ConnectionString))
        //{
        //    /*SqlCommand SqlCmd = new SqlCommand("select Contract_Code from Contract_Club where Contract_Club_Name=@club_name  and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)and Venue_ID in (select Venue_ID from venue where Venue_Name = @venue)", cs1);
