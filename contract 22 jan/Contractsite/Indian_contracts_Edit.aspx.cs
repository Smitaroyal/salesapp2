         ...
         //   sp4dobdatepicker.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["Sub_Profile4_DOB"].ToString()).ToString("yyyy-MM-dd");
            ...
            else if (conttypevalue == "Points")
            {
                ...
                else
                {
                    ...
                    baladepamtdateTextBox.Text= dsptsf.Tables[0].Rows[0]["BalanceDeposit_Date"].ToString();
                ...
                if (NoinstallmentTextBox.Text == ""|| NoinstallmentTextBox.Text == "0"|| NoinstallmentTextBox.Text == "NaN")
                {
                    ...
                    if (exists == 1)
                    {
                        ...
                        for (int j = 0; j < dsin.Tables[0].Rows.Count; j++)
                        {
                            ...
                            int insertdel = Queries.InsertContract_Installments_Indian_Deleted(Installment_ID, ProfileID, ContractNo, Installment_no, Installment_Amount, Installment_Date, Installment_Invoice_No, DateTime.Now.ToString(),ContractdetailsIDTextBox.Text);
                ...
                if (NoinstallmentTextBox.Text == "" || NoinstallmentTextBox.Text == "0" || NoinstallmentTextBox.Text == "NaN")
                {
                    ...
                    if (exists == 1)
                    {
                        ...
                        for (int j = 0; j < dsin.Tables[0].Rows.Count; j++)
                        {
                            ...
                            string Installment_Invoice_No = dsin.Tables[0].Rows[j]["Installment_Invoice_No"].ToString();
                            int insertdel = Queries.InsertContract_Installments_Indian_Deleted(Installment_ID, ProfileID, ContractNo, Installment_no, Installment_Amount, Installment_Date, Installment_Invoice_No, DateTime.Now.ToString(), ContractdetailsIDTextBox.Text);
                            string log5 = "Installment Details Deleted:" + "Profile id: " + ProfileID + "," + "ContractNo: " + ContractNo + "," + "Installment #:" + Installment_no + "," + "Installment Amt:" + Installment_Amount + "," + "Installment Date:" + Installment_Date + "," + "Installment_Invoice_No:" + Installment_Invoice_No + "," + "Deleted Datetime:" + DateTime.Now.ToString() + "," + "Contract details ID:" + ContractdetailsIDTextBox.Text;
                            int insertlog5 = Queries.InsertContractLogs_India(profileidTextBox.Text, contractno, log5, user, DateTime.Now.ToString());
                            int delrow = Queries.DeleteContract_Installments_Indian(Installment_ID);
                        }
...
protected void Button5_Click(object sender, EventArgs e)
    {
        if (financeradiobuttonlist.SelectedItem.Text == "Finance")
        {
            ...
            {
                DataTable datatable = Queries.Fractional_PA(ContractdetailsIDTextBox.Text);// contractnoTextBox.Text);
            ...
            {
                DataTable datatable = Queries.NewPoints_PA(ContractdetailsIDTextBox.Text);// contractnoTextBox.Text);
                string printr = PrintPdfDropDownList.SelectedItem.Text;
                ReportDocument crystalReport = new ReportDocument(); // creating object of crystal report
                crystalReport.Load(Server.MapPath("~/reports/" + printr + ".rpt")); // path of report       
                crystalReport.SetDataSource(datatable);
            ...
            {
                DataTable datatable = Queries.TradeInPoints_PA(ContractdetailsIDTextBox.Text);// contractnoTextBox.Text);
                string printr = PrintPdfDropDownList.SelectedItem.Text;
                ReportDocument crystalReport = new ReportDocument(); // creating object of crystal report
                crystalReport.Load(Server.MapPath("~/reports/" + printr + ".rpt")); // path of report       
                crystalReport.SetDataSource(datatable);
            ...
            {
                DataTable datatable = Queries.TradeInWeeks_PA(ContractdetailsIDTextBox.Text);// contractnoTextBox.Text);
                string printr = PrintPdfDropDownList.SelectedItem.Text;
                ReportDocument crystalReport = new ReportDocument(); // creating object of crystal report
                crystalReport.Load(Server.MapPath("~/reports/" + printr + ".rpt")); // path of report       
                crystalReport.SetDataSource(datatable);
                ...
                DataTable datatable = Queries.FractionalTradeIn_PA(ContractdetailsIDTextBox.Text);// contractnoTextBox.Text);
                string printr = PrintPdfDropDownList.SelectedItem.Text;
                ReportDocument crystalReport = new ReportDocument(); // creating object of crystal report
                crystalReport.Load(Server.MapPath("~/reports/" + printr + ".rpt")); // path of report       
                crystalReport.SetDataSource(datatable);
