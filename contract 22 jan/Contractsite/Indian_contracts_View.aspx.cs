            ...
            else
            {
                ...
                if (Finance_Details == "Finance")
                {
                    if (ContractType == "Fractionals")
                    {
                        ...
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(ContractType, office, dsf.Tables[0].Rows[0]["resort"].ToString(), dsf.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details,dsfinance.Tables[0].Rows[0]["Affiliate_Type"].ToString(), ds.Tables[0].Rows[0]["MCWaiver"].ToString());
                    ...
                    else if (ContractType == "Points")
                    {
                        ...
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(ContractType, office, club, curr, Finance_Details,aff,mc);
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
                    ...
                    else if (ContractType == "Trade-In-Points")
                    {
                        ...
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(ContractType, office, dsp.Tables[0].Rows[0]["New_Club"].ToString(), dsp.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details, dsfinance.Tables[0].Rows[0]["Affiliate_Type"].ToString(), ds.Tables[0].Rows[0]["MCWaiver"].ToString());
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
                    ...
                    else if (ContractType == "Trade-In-Weeks")
                    {
                        ...
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(ContractType, office, dsp.Tables[0].Rows[0]["NewPointsW_Club"].ToString(), dsp.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details, dsfinance.Tables[0].Rows[0]["Affiliate_Type"].ToString(), ds.Tables[0].Rows[0]["MCWaiver"].ToString());
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
                ...
                else if (Finance_Details == "Non Finance")
                {
                    ...
                    else if (ContractType == "Points")
                    {
                        DataSet dsp = Queries.LoadNewPointsDetails(ContractDetails_ID);// contractno);
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(ContractType, office, dsp.Tables[0].Rows[0]["club"].ToString(), dsp.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details, dsfinance.Tables[0].Rows[0]["Affiliate_Type"].ToString(), ds.Tables[0].Rows[0]["MCWaiver"].ToString());
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
