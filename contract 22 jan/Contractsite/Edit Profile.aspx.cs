...
public partial class _Default : System.Web.UI.Page
{
    ...
    static string ProfileIDo, regTerms;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //update profile
            int updateprofile = Queries2.UpdateProfile(profile, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs, "","","","",reception,"",regTerms,VPID);
            ...
            string subprofilecheck3 = Queries2.checksubprofile("SP3", profile);
            string subprofilecheck4 = Queries2.checksubprofile("SP4", profile);
            if (sp3fname != "")
            {
                if(subprofilecheck3 != "")
                {
