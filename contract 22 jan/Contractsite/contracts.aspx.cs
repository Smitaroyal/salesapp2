...
public partial class _Default : System.Web.UI.Page
{
    ...
    static string GenContNumbglob,ofname,olname, regTerms, DealRegDate;
       ...
       // string ProfileID = "IVO20178";
        ...
        if (!Page.IsPostBack)
        {
           ...
           ofname= pfnameTextBox.Text = ds4.Tables[0].Rows[0]["Profile_Primary_Fname"].ToString();
            ...
            DataSet primanat = Queries2.LoadNationality();
          ...
          //  SecCountryDropDownList.DataBind();
           ...
           palternateTextBox.Text = ds4.Tables[0].Rows[0]["Primary_Alternate"].ToString();
            ...
            DataSet seconnat = Queries2.LoadNationality();
            ...
            DataSet sp1nat = Queries2.LoadNationality();
           ...
           // datepicker4.Text = ds4.Tables[0].Rows[0]["Sub_Profile2_DOB"].ToString();
            ...
            DataSet sp2nat = Queries2.LoadNationality();
           ...
           // salesrepDropDownList.Items.Add(ds4.Tables[0].Rows[0]["Tour_Details_Guest_Sales_Rep"].ToString());
            ...
            DataSet dssr = Queries.LoadSalesReps(officeo);
   ...
   /* protected void Button5_Click(object sender, EventArgs e)
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int updateprofile = Queries2.UpdateProfile(profile, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs, "","","","",reception,subvenue, regTerms, VPID);
            ...
            {
                tprimarydob = TextPrimaryAge.Text; //Convert.ToDateTime(primarydob).ToString("yyyy-MM-dd");
            }
            ...
            int primary = Queries.UpdateProfilePrimary(profile, primarytitle, primaryfname, primaylname, tprimarydob, primarynationality, primarycountry, primaryage, "","");
            ...
            {
                tsecondarydob = datepicker2.Text; //Convert.ToDateTime(secondarydob).ToString("yyyy-MM-dd");
            }
            ...
            int secondary = Queries.UpdateProfileSecondary(profile, secondarytitle, secondaryfname, secondarylname, tsecondarydob, secondarynationality, secondarycountry, secondaryage, "","");
            ...
            {
                tsp1dob = datepicker3.Text;// Convert.ToDateTime(sp1dob).ToString("yyyy-MM-dd");
            }
            ...
            int sp1 = Queries.UpdateSubProfile1(profile, sp1title, sp1fname, sp1lname, tsp1dob, sp1nationality, sp1country, SubProfile1age);
            ...
            {
                tsp2dob = datepicker4.Text;// Convert.ToDateTime(sp1dob).ToString("yyyy-MM-dd");
            }
            ...
            int sp2 = Queries.UpdateSubProfile2(profile, sp2title, sp2fname, sp2lname, tsp2dob, sp2nationality, sp2country, Subprofile2);
            ...
            if (sp3fname != "")
            {
                ...
                {
                    tsp3dob = SubP3DOB.Text;// Convert.ToDateTime(sp3dob).ToString("yyyy-MM-dd");
                }
            ...
            if (sp4fname != "")
            {
                ...
                {
                    tsp4dob = SubP4DOB.Text; //Convert.ToDateTime(sp4dob).ToString("yyyy-MM-dd");
                }
                ...
                int sp4 = Queries.UpdateSubProfile4(profile, sp4title, sp4fname, sp4lname, tsp4dob, sp4nationality, sp4country, Subprofile4);
            ...
            {
                tarrivaldate = datepicker5.Text; //Convert.ToDateTime(arrivaldate).ToString("yyyy-MM-dd");
            }
            ...
            {
                tdeparturedate = datepicker6.Text;// Convert.ToDateTime(departuredate).ToString("yyyy-MM-dd");
            }
            ...
            {
                ttourdate = tourdatedatepicker.Text; //Convert.ToDateTime(tourdate).ToString("yyyy-MM-dd");
            }
            ...
            int tour = Queries.UpdateTourDetails(profile, gueststatus, salesrep, ttourdate, timeIn, timeOut, taxin, taxirefin, taxiout, taxirefout,QualiStatus);
