      ...
      /*  DataSet ds4 = Queries.LoadAgents();
       ...
       /* DataSet ds8 = Queries.LoadCountryName();
        ...
        subprofile2alternateDropDownList.DataBind();
            ...
            DataSet sp3altcc1 = Queries.LoadCountryWithCode();
            ...
            DataSet sp4altcc1 = Queries.LoadCountryWithCode();
        ...
        try
        {
           ...
           // }
            ...
            if (exists == 0)
            {
                ...
                {
                    int profile = Queries.InsertProfile(ProfileIDTextBox.Text, DateTime.Now, createdby, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs, office, commentTextBox.Text, "","","",reception,"",regTerms,VPID);
                    ...
                    int primary = Queries.InsertPrimaryProfile(primaryprofileid, primarytitle, primaryfname, primaylname, tprimarydob, primarynationality, primarycountry, ProfileIDTextBox.Text,primaryage,"","");
                    string log2 = "Primary details:" + " " + "primary id:" + primaryprofileid + "," + "title:" + primarytitle + "," + "Fname:" + primaryfname + "," + "Lname:" + primaylname + "," + "DOB:" + primarydob + "," + "nationality:" + primarynationality + "," + "Country:" + primarycountry + "," + "Profile ID:" + ProfileIDTextBox.Text + "," + "Profile Primary Age:" + primaryage ;
                    ...
                    int secondary = Queries.InsertSecondaryProfile(secondaryprofileid, secondarytitle, secondaryfname, secondarylname, tsecondarydob, secondarynationality, secondarycountry, ProfileIDTextBox.Text,secondaryage,"","");
                    ...
                    int subprofielid = Queries.InsertSub_Profile1(subprofile1id, sp1title, sp1fname, sp1lname, tsp1dob, sp1nationality, sp1country, ProfileIDTextBox.Text,SubProfile1age);
                    ...
                    int subprofielid2 = Queries.InsertSub_Profile2(subprofile2id, sp2title, sp2fname, sp2lname, tsp2dob, sp2nationality, sp2country, ProfileIDTextBox.Text,Subprofile2);
                    ...
                    if (sp3fname != "")
                    {
                        ...
                        int subprofielid3 = Queries.InsertSub_Profile3(subprofile3id, sp3title, sp3fname, sp3lname, tsp3dob, sp3nationality, sp3country, ProfileIDTextBox.Text, Subprofile3);
                        string log11 = "sub profile3 details:" + " " + "sp3 id:" + subprofile3id + "," + "title:" + sp3title + "," + "Fname:" + sp3fname + "," + "Lname:" + sp3lname + "," + "DOB:" + sp3dob + "," + "nationality:" + sp3nationality + "," + "Country:" + sp3country + "," + "Profiel ID:" + ProfileIDTextBox.Text + "," + "Sub Profile 3 Age:" + Subprofile3; 
                    ...
                    if (sp4fname != "")
                    {
                        ...
                        int subprofielid4 = Queries.InsertSub_Profile4(subprofile4id, sp4title, sp4fname, sp4lname, tsp4dob, sp4nationality, sp4country, ProfileIDTextBox.Text, Subprofile4);
                        string log12 = "sub profile4 details:" + " " + "sp4 id:" + subprofile4id + "," + "title:" + sp4title + "," + "Fname:" + sp4fname + "," + "Lname:" + sp4lname + "," + "DOB:" + sp4dob + "," + "nationality:" + sp4nationality + "," + "Country:" + sp4country + "," + "Profiel ID:" + ProfileIDTextBox.Text + "," + "Sub Profile 4 Age:" + Subprofile4;
                    ...
                    int tourdetails = Queries.InsertTourDetails(tourid, gueststatus, salesrep, ttourdate, timeIn, timeOut, taxin, taxirefin, taxiout, taxirefout, ProfileIDTextBox.Text, QualiStatus);
