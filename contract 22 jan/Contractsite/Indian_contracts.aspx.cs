    ...
    public void CreateButton_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (mcRadioButtonList.Checked == true)
              ...
              double indeposit = Convert.ToDouble(intialdeppercentTextBox.Text);
                ...
                PrintPdfDropDownList.Items.Clear();
                    DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, resortDropDownList.SelectedItem.Text, currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
            ...
            //    string contractdetailsID = Queries.GetContractDetails_Indian();
                ...
                DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, Request.Form[pointsclubDropDownList.UniqueID], currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type,mcwaiver);
                PrintPdfDropDownList.DataSource = ds21;
                    PrintPdfDropDownList.DataTextField = "printname";
                    PrintPdfDropDownList.DataValueField = "printname";
                    PrintPdfDropDownList.AppendDataBoundItems = true;
              ...
              //  string contractdetailsID = Queries.GetContractDetails_Indian();
                ...
                PrintPdfDropDownList.Items.Clear();
                    DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, Request.Form[ntipclubDropDownList.UniqueID], currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
                    PrintPdfDropDownList.DataSource = ds21;
                    PrintPdfDropDownList.DataTextField = "printname";
                    PrintPdfDropDownList.DataValueField = "printname";
                    PrintPdfDropDownList.AppendDataBoundItems = true;
              ...
              //  string contractdetailsID = Queries.GetContractDetails_Indian();
                ...
                PrintPdfDropDownList.Items.Clear();
                    ...
                    DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, Request.Form[nmclubDropDownList.UniqueID], currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
                    PrintPdfDropDownList.DataSource = ds21;
                    PrintPdfDropDownList.DataTextField = "printname";
                    PrintPdfDropDownList.DataValueField = "printname";
                    PrintPdfDropDownList.AppendDataBoundItems = true;
                ...
                else if (contracttype == "Trade-In-Fractionals")
                {
                    ...
                    PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, Request.Form[fwresortDropDownList.UniqueID], currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
                   ...
                   // string contractdetailsID = Queries.GetContractDetails_Indian();
                    ...
                    PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, fptsresortDropDownList.SelectedItem.Text, currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
