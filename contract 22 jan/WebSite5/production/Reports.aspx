<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reports.aspx.cs" Inherits="WebSite5_production_Country" %>
                            ...
                            <div class="col-md-3" id="date">
                                <div class="form-group">
                                    <label for="sel1">Date:</label>
                                     <asp:TextBox ID="example1"  class="form-control" runat="server"></asp:TextBox>
    ...
    <script>
        $(document).ready(function () {
            $("#insert").click(function () {
                var reportName = $("#reports option:selected").text();
                var reportPro = $("#reports").val();
                ...
                $.ajax({
                    ...
                    data: "{'reportName':'" + reportName + "','reportPro':'" + reportPro + "','date':'" + date + "','office':'" + office + "'}",
                    async: false,
