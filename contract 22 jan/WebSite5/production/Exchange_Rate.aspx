<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Exchange_Rate.aspx.cs" Inherits="WebSite5_production_Country" %>
...
<head runat="server">
    ...
    <style>
        ...
        #exchangeRateID,#eRatesIDR,#eRatesINR,#eRatesAUD,#eRatesEUR,#eRatesGBP,#directory,#insert,#directory,#head,#update{
 ...
 <% Response.Write(getdata()); %>
        ...
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-md-3" id="exchangeRateID">
                  <div class="form-group">
                      <label for="sel1">Exchange Rate ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right" runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

              <div class="col-md-3" id="eRatesIDR">
                  <div class="form-group">
                      <label for="sel1">ERates IDR:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" runat="server"></asp:TextBox>
                  </div>
              </div>
              <div class="col-md-3" id="eRatesINR">
                  <div class="form-group">
                      <label for="sel1">ERates INR:</label>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-3" id="eRatesAUD">
                                <div class="form-group">
                                    <label for="sel1">ERates AUD:</label>
                                    <asp:TextBox ID="TextBox4" class="form-control pull-right" runat="server"></asp:TextBox>
                                </div>
                            </div>
                             <div class="col-md-3" id="eRatesEUR">
                                <div class="form-group">
                                    <label for="sel1">ERates EUR:</label>
                                    <asp:TextBox ID="TextBox6" class="form-control pull-right" runat="server"></asp:TextBox>
                                </div>
                            </div>

                             <div class="col-md-3" id="eRatesGBP">
                                <div class="form-group">
                                    <label for="sel1">ERates GBP:</label>
