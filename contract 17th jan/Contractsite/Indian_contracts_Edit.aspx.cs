...
public partial class _Default : System.Web.UI.Page
{
    ...
    static string ocsalesrep, ocTomgr, obuttonup, odealdate, odealstatus,oadhar,opan;
    static string opts_club, opts_newpts, opts_entitlement, opts_totalpts, opts_firstyr, opts_Tenure, opts_lastyr;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           ...
           ProfileID = Queries.GetProfileIDOnContractNo(contractno);
            ...
            DataSet dsfd = Queries.LoadFinanceContractDetails(contractno);
         ...
         //   sp4dobdatepicker.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["Sub_Profile4_DOB"].ToString()).ToString("yyyy-MM-dd");
            ...
            //dealstatusDropDownList.Items.Add(dsct.Tables[0].Rows[0]["DealStatus"].ToString());
            DataSet dsdstatus = Queries.contractdealstatus(contractnoTextBox.Text);
            //dealstatusDropDownList.Items.Add(dsdstatus.Tables[0].Rows[0]["Status_Type"].ToString());
            ...
            dealdateTextBox.Text = Convert.ToDateTime(dsct.Tables[0].Rows[0]["DealRegistered_Date"].ToString()).ToString("dd-MM-yyyy");
            ...
            else if (conttypevalue == "Points")
            {
                ...
                visibilityfalse();
                DataSet dspts = Queries.LoadNewPointsDetails(contractno);
                ...
                else
                {
                    ...
                    DataSet dsptsf = Queries.LoadFinanceContractDetails(contractno);
                    ...
                    DataSet dscur = Queries.currencyfinancedetails(contractnoTextBox.Text, officeTextBox.Text);
                  ...
                  //  lblafftype.Text = dsptsf.Tables[0].Rows[0]["Affiliate_Type"].ToString();
                    ...
                    DataSet dspym = Queries.paymethodfinancedetails(contractnoTextBox.Text, officeTextBox.Text);
                    ...
                    if (dsptsf.Tables[0].Rows[0]["Finance_Method"].ToString() == "Finance")
                    {
                        ...
                        DataSet dsfin = Queries.financemethodfinancedetails(contractnoTextBox.Text, officeTextBox.Text);
                        ...
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeTextBox.Text, office, dspts.Tables[0].Rows[0]["club"].ToString(), dspts.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details);
                    ...
                    //load installments
                    DataSet dsin = Queries.contractInstallment(contractnoTextBox.Text);
            ...
            else if (conttypevalue == "Trade-In-Points")
            {
                ...
                DataSet dstip = Queries.LoadTradeinPointsDetails(contractno);
                ...
                else
                {
                    ...
                    DataSet dstipen = Queries.tradeinpointsentitlement(contractnoTextBox.Text);
             ...
             //   lblafftype.Text = dsptsf.Tables[0].Rows[0]["Affiliate_Type"].ToString();
                ...
                if (dsptsf.Tables[0].Rows[0]["Finance_Method"].ToString() == "Finance")
                {
                    ...
                    PrintPdfDropDownList.Items.Clear();
                    DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeTextBox.Text, office, dstip.Tables[0].Rows[0]["New_Club"].ToString(), dsptsf.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details);
                    PrintPdfDropDownList.DataSource = ds21;
                    PrintPdfDropDownList.DataTextField = "printname";
                    PrintPdfDropDownList.DataValueField = "printname";
                    PrintPdfDropDownList.AppendDataBoundItems = true;
            ...
            else if (conttypevalue == "Trade-In-Weeks")
            {
                ...
                visibilityfractionalfalse();
                DataSet dstiw = Queries.LoadTradeinWeeksDetails(contractno);
                ...
                else
                {
                    ...
                    DataSet dstiwk = Queries.tradeinwksseason(contractnoTextBox.Text);

                    //    tnmseasonDropDownList.Items.Add(dstiw.Tables[0].Rows[0]["Trade_In_Weeks_Season"].ToString());
                    //   tnmseasonDropDownList.Items.Add(dstiwk.Tables[0].Rows[0]["Season_Name"].ToString());
                    ...
                    DataSet dstiwen = Queries.tradeinwksentitlement(contractnoTextBox.Text);
                    ...
                    memsgstTextBox.Text = dsct.Tables[0].Rows[0]["MembersGST"].ToString();
                    DataSet dscur = Queries.currencyfinancedetails(contractnoTextBox.Text, officeTextBox.Text);
                    //currencyDropDownList.Items.Add(dsptsf.Tables[0].Rows[0]["currency"].ToString());
                    //currencyDropDownList.Items.Add(dscur.Tables[0].Rows[0]["Finance_Currency_Name"].ToString());
                    currencyDropDownList.DataSource = dscur;
                    currencyDropDownList.DataTextField = "Finance_Currency_Name";
                    currencyDropDownList.DataValueField = "Finance_Currency_Name";
                    currencyDropDownList.AppendDataBoundItems = true;
                 ...
                 //   lblafftype.Text = dsptsf.Tables[0].Rows[0]["Affiliate_Type"].ToString();
                    ...
                    DataSet dspym = Queries.paymethodfinancedetails(contractnoTextBox.Text, officeTextBox.Text);
                    PayMethodDropDownList.Items.Add(dsptsf.Tables[0].Rows[0]["Payment_Method"].ToString());
                    //    PayMethodDropDownList.Items.Add(dspym.Tables[0].Rows[0]["pay_method_name"].ToString());
                    NoinstallmentTextBox.Text = dsptsf.Tables[0].Rows[0]["No_Installments"].ToString();
                    installmentamtTextBox.Text = dsptsf.Tables[0].Rows[0]["Installment_Amount"].ToString();
                    balamtpayableTextBox.Text = dsptsf.Tables[0].Rows[0]["Bal_Amount_Payable"].ToString();
                    omcfees = dsct.Tables[0].Rows[0]["MC_Charges"].ToString();
                    ...
                    if (dsptsf.Tables[0].Rows[0]["Finance_Method"].ToString() == "Finance")
                    {
                        ...
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeTextBox.Text, office, dstiw.Tables[0].Rows[0]["NewPointsW_Club"].ToString(), dsptsf.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details);
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
            ...
            else if (conttypevalue == "Trade-In-Fractionals")
            {
                ...
                visibilityfractionaltrue();
                //load finance details
                DataSet dstif = Queries.loadtradeinfractional(contractnoTextBox.Text);
                ...
                {
                    oldcontracttypeDropDownList.Items.Add(dstif.Tables[0].Rows[0]["Oldcontracttype"].ToString());
                    oldcontracttypeDropDownList.Items.Add("Points");
                    oldcontracttypeDropDownList.Items.Add("Weeks");
                    DataSet dsfres = Queries.loadtradeinfractionalResort(contractnoTextBox.Text, officeTextBox.Text);
                    ...
                    else
                    {
                        ...
                        // fwresortDropDownList.Items.Add(dstif.Tables[0].Rows[0]["resort"].ToString());
                        //  fwresortDropDownList.Items.Add(dsfres.Tables[0].Rows[0]["Contract_Resort_Name"].ToString());
                    }

                    DataSet dsfresidenceno = Queries.loadtradeinfractionalResidence(contractnoTextBox.Text);
                    ...
                    else
                    {
                        ...
                        // fwresidencenoDropDownList.Items.Add( dstif.Tables[0].Rows[0]["residence_no"].ToString());
                        // fwresidencenoDropDownList.Items.Add(dsfresidenceno.Tables[0].Rows[0]["Contract_Residence_Name"].ToString());


                    }
                    DataSet dsftype = Queries.loadtradeinfractionalResidencetype(contractnoTextBox.Text);
                    ...
                    else
                    {
                        ...
                        //fwresidencetypeDropDownList.Items.Add(dstif.Tables[0].Rows[0]["residence_type"].ToString());
                        //fwresidencetypeDropDownList.Items.Add(dsftype.Tables[0].Rows[0]["Contract_Resi_Type_Name"].ToString());

                    }



                    DataSet dsfint = Queries.loadtradeinfractionalFractionalInt(contractnoTextBox.Text);
                    ...
                    else
                    {
                        ...
                        // fwfractIntDropDownList.Items.Add(dstif.Tables[0].Rows[0]["fractional_interest"].ToString());
                        // fwfractIntDropDownList.Items.Add(dsfint.Tables[0].Rows[0]["Contract_Fractional_Int_Name"].ToString());
                    }

                    DataSet dstifen = Queries.tradeinfractionalentitlement(contractnoTextBox.Text);
                    ...
                    else if (dstif.Tables[0].Rows[0]["Oldcontracttype"].ToString() == "Weeks")
                    {
                        ...
                        DataSet dsfseason = Queries.tradeinfractionalseason(contractnoTextBox.Text);
                        ...
                        //tnmseasonDropDownList.Items.Add(dstif.Tables[0].Rows[0]["SEASON"].ToString());
                        //tnmseasonDropDownList.DataSource = dsfseason;
                        //tnmseasonDropDownList.DataBind();
                   ...
                   // lblafftype.Text = dsptsf.Tables[0].Rows[0]["Affiliate_Type"].ToString();
                    ...
                    if (dsptsf.Tables[0].Rows[0]["Finance_Method"].ToString() == "Finance")
                    {
                        ...
                        DataSet dsp = Queries.LoadNewPointsDetails(contractno);
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeTextBox.Text, office, dstif.Tables[0].Rows[0]["resort"].ToString(), dsptsf.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details);
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
                    ...
                    //load fractional pa
                    DataSet dsfpa = Queries.LoadfractionalPA(contractnoTextBox.Text);

                    // newpointsTextBox.Text = dsfpa.Tables[0].Rows[0]["New_Points_Price"].ToString();
                    //  conversionfeeTextBox.Text = dsfpa.Tables[0].Rows[0]["Conversion_Fee"].ToString();
...
public void CreateButton_Click(object sender, EventArgs e)
    {
      string user =(string)Session["username"];
        ...
        if (contract=="Points")
        {
                DataSet dspts = Queries.LoadNewPointsDetails(contractnoTextBox.Text);
            ...
            DataSet dsptsf = Queries.LoadFinanceContractDetails(contractnoTextBox.Text);
            ...
            string dealstatus = dealstatusDropDownList.SelectedItem.Text; // Request.Form[dealstatusDropDownList.UniqueID];
            ...
            if (String.Compare(ofinance, finance) != 0)
            {
                if(finance=="Finance")
                {
                    //get last genrated financeno

                }
                else if(finance=="Non Finance")
                {
                    // get finance no updated nad minus by 1
                    int update = Queries.UpdateFinanceNoFromNFtoF(VenueDropDownList.SelectedItem.Text, financemethod, contracttypeTextBox.Text);
            ...
            if (String.Compare(oinstallment, installment) != 0)
            {
                ...
                if (NoinstallmentTextBox.Text == ""|| NoinstallmentTextBox.Text == "0"|| NoinstallmentTextBox.Text == "NaN")
                {
                    ...
                    int exists = Queries.ContractNoInInstallmentTable(contractnoTextBox.Text);
                    if (exists == 1)
                    {
                        //delete from table
                        DataSet dsin = Queries.LoadcontractInstallment(contractnoTextBox.Text);
                        for (int j = 0; j < dsin.Tables[0].Rows.Count; j++)
                        {
                            string Installment_ID = dsin.Tables[0].Rows[j]["Installment_ID"].ToString();
                            string ProfileID = dsin.Tables[0].Rows[j]["ProfileID"].ToString();
                            ...
                            int insertdel = Queries.InsertContract_Installments_Indian_Deleted(Installment_ID, ProfileID, ContractNo, Installment_no, Installment_Amount, Installment_Date, Installment_Invoice_No, DateTime.Now.ToString());
                ...
                else
                {
                    ...
                    for (i = 1; i <= Convert.ToInt32(noinstallment); i++)
                    {
                        ...
                        int FinanceInvoice = Queries.InsertContract_Installments_Indian(profileidTextBox.Text, contractno, installemnt_No, iamt, idate, Queries.GetInstallmentInvoiceNo(office));
            ...
            int updatecontractdetailsIndian = Queries.UpdateContractDetails_Indian(csalesrep, cTomgr, buttonup, dealdate, dealstatus, mcwaiver, finance, pancrd, adhar, mcfees, mcdate, memberfee, memebercgst, membersgst, contractnoTextBox.Text);
            int updatefinancedetails = Queries.UpdateFinanceDetails_Indian(finance, currency, affiliate, totalintax, depamt,"", balpayable,"", depbal, totalbalance,paymethod, noinstallment, installment, financemethod, Financeno, isgtrate, interestrate, findocfee, igstamt, noemi, emiamt, finmonth, contractnoTextBox.Text);
            int updatecontractPA = Queries.UpdateContract_PA_Indian(newpoints, conversionfee, adminfee, totpurchprice, cgst, sgst, totalpriceInTax, deposit, balance, balancedue, remarks, contractnoTextBox.Text);
            //  int updatepointscontract = Queries.UpdateContract_Points_Indian(pts_club,pts_newpts, pts_entitlement, pts_totalpts, pts_firstyr, pts_Tenure, pts_lastyr,contractnoTextBox.Text);
            ...
            Page.ClientScript.RegisterStartupScript(GetType(), "popup", "alert('" + msg + "');", true);
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeTextBox.Text, office, dspts.Tables[0].Rows[0]["club"].ToString(), dspts.Tables[0].Rows[0]["Currency"].ToString(), finance);
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
        ...
        {
            DataSet dstip = Queries.LoadTradeinPointsDetails(contractnoTextBox.Text);
            if (dstip.Tables[0].Rows.Count == 0)
            {
                otip_Trade_In_Details_club_resort = "";
                otip_Trade_In_Details_No_rights = "";
                otip_Trade_In_Details_ContNo_RCINo = ""; 
                otip_Trade_In_Details_Points_value = "";
                otip_New_Club = "";
                otip_New_Club_Points_Rights = "";
                otip_New_MemebrshipType = "";
                otip_New_TotalPointsRights = "";
                otip_New_First_year_occupancy = "";
                otip_New_Tenure = "";
                otip_New_Last_year_occupancy = "";
            }
            else
            {
                otip_Trade_In_Details_club_resort = dstip.Tables[0].Rows[0]["Trade_In_Details_club_resort"].ToString();
            ...
            string totalbalance = balamtpayableTextBox.Text;
            string paymethod = PayMethodDropDownList.SelectedItem.Text;// Request.Form[PayMethodDropDownList.UniqueID];
                                                                       //string financemethod = financemethodDropDownList.SelectedItem.Text;// Request.Form[financemethodDropDownList.UniqueID];
                                                                       //string Financeno = FinancenoTextBox.Text;
                                                                       //string finmonth = finmonthTextBox.Text;
                                                                       //string noemi = noemiTextBox.Text;
                                                                       //string emiamt = emiamtTextBox.Text;
                                                                       //string findocfee = findocfeeTextBox.Text;
                                                                       //string isgtrate = isgtrateTextBox.Text;
                                                                       //string igstamt = igstamtTextBox.Text;
            ...
            int updatefinancedetails = Queries.UpdateFinanceDetails_Indian(finance, currency, affiliate, totalintax, depamt, "", balpayable, "", depbal, totalbalance, paymethod, noinstallment, installment, financemethod, Financeno, isgtrate, interestrate, findocfee, igstamt, noemi, emiamt, finmonth, contractnoTextBox.Text);
            int updatecontractPA = Queries.UpdateContract_PA_Indian(newpoints, conversionfee, adminfee, totpurchprice, cgst, sgst, totalpriceInTax, deposit, balance, balancedue, remarks, contractnoTextBox.Text);
            int updatepointscontract = Queries.UpdateContract_Trade_In_Points_Indian( tpresort,tpnpts,tpcontno,tpptsval,pts_club, pts_newpts, pts_entitlement, pts_totalpts, pts_firstyr, pts_Tenure, pts_lastyr, contractnoTextBox.Text);
            ...
            Page.ClientScript.RegisterStartupScript(GetType(), "popup", "alert('" + msg + "');", true);
            PrintPdfDropDownList.Items.Clear();
            DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeTextBox.Text, office, dstip.Tables[0].Rows[0]["New_Club"].ToString(), dsptsf.Tables[0].Rows[0]["Currency"].ToString(), finance);
            PrintPdfDropDownList.DataSource = ds21;
            PrintPdfDropDownList.DataTextField = "printname";
            PrintPdfDropDownList.DataValueField = "printname";
            PrintPdfDropDownList.AppendDataBoundItems = true;
        ...
        {
            DataSet dstiw = Queries.LoadTradeinWeeksDetails(contractnoTextBox.Text);
            if (dstiw.Tables[0].Rows.Count == 0)
            {
                

                otiw_Trade_In_Weeks_resort = " ";
                otiw_Trade_In_Weeks_Apt = " ";
                otiw_Trade_In_Weeks_Season = " ";
                otiw_Trade_In_Weeks_NoWks = " ";
                otiw_Trade_In_Weeks_ContNo_RCINo = " ";
                otiw_Trade_In_Weeks_Points_value = " ";
                otiw_NewPointsW_Club = " ";
                otiw_NewPointsW_Club_Points_Rights = " ";
                otiw_NewPointsW_MemebrshipType = " ";
                otiw_NewPointsW_Total_Points_rights = " ";
                otiw_NewPointsW_First_year_occupancy = " ";
                otiw_NewPointsW_Tenure = " ";
                otiw_NewPointsW_Last_year_occupancy = " ";
            ...
            //string financemethod = financemethodDropDownList.SelectedItem.Text;
            //string Financeno = FinancenoTextBox.Text;
            //string finmonth = finmonthTextBox.Text;
            //string noemi = noemiTextBox.Text;
            //string emiamt = emiamtTextBox.Text;
            ...
            int updatefinancedetails = Queries.UpdateFinanceDetails_Indian(finance, currency, affiliate, totalintax, depamt, "", balpayable, "", depbal, totalbalance, paymethod, noinstallment, installment, financemethod, Financeno, isgtrate, interestrate, findocfee, igstamt, noemi, emiamt, finmonth, contractnoTextBox.Text);
            int updatecontractPA = Queries.UpdateContract_PA_Indian(newpoints, conversionfee, adminfee, totpurchprice, cgst, sgst, totalpriceInTax, deposit, balance, balancedue, remarks, contractnoTextBox.Text);
            int updatepointscontract = Queries.UpdateContract_Trade_In_Weeks_Indian(tpresort,apt,season,nowks, tpcontno,tpptsval, pts_club, pts_newpts, pts_entitlement, pts_totalpts, pts_firstyr, pts_Tenure, pts_lastyr, contractnoTextBox.Text);
            ...
            Page.ClientScript.RegisterStartupScript(GetType(), "popup", "alert('" + msg + "');", true);
            PrintPdfDropDownList.Items.Clear();
            DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeTextBox.Text, office, dstiw.Tables[0].Rows[0]["NewPointsW_Club"].ToString(), dsptsf.Tables[0].Rows[0]["Currency"].ToString(), finance);
            PrintPdfDropDownList.DataSource = ds21;
            PrintPdfDropDownList.DataTextField = "printname";
            PrintPdfDropDownList.DataValueField = "printname";
            PrintPdfDropDownList.AppendDataBoundItems = true;
        ...
        else if (contract == "Fractional")
        {
            ...
            int updatecontractdetailsIndian = Queries.UpdateContractDetails_Indian(csalesrep, cTomgr, buttonup, dealdate, dealstatus, mcwaiver, finance, pancrd, adhar, mcfees, mcdate, memberfee, memebercgst, membersgst, contractnoTextBox.Text);
            int updatefinancedetails = Queries.UpdateFinanceDetails_Indian(finance, currency, affiliate, totalintax, depamt, "", balpayable, "", depbal, totalbalance, paymethod, noinstallment, installment, financemethod, Financeno, isgtrate, interestrate, findocfee, igstamt, noemi, emiamt, finmonth, contractnoTextBox.Text);
            int updatecontractPA = Queries.UpdateContract_FractionalPA_Indian(adminfee, oAdministrationFees, totpurchprice, cgst, sgst, totalpriceInTax, deposit, balance, balancedue, remarks, contractnoTextBox.Text);
           // int updatepointscontract = Queries.UpdateContract_Trade_In_Fractional_Indian(ocontracttype, tpresort, apt, season, nowks, tpnopts, tpptsval, tpcontno, contractnoTextBox.Text);
            int updatefractionalcontract = Queries.UpdateContract_Fractional_Indian(resort, residence_no, residence_type, fractional_interest, entitlement, firstyear_Occupancy, tenure, lastyear_Occupancy, "", mcfees, contractnoTextBox.Text);


            string msg = "Details updated for Contract :" + " " + contractnoTextBox.Text;
            Page.ClientScript.RegisterStartupScript(GetType(), "popup", "alert('" + msg + "');", true);
            PrintPdfDropDownList.Items.Clear();
            DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(contracttypeTextBox.Text, office, dstif.Tables[0].Rows[0]["resort"].ToString(), dsptsf.Tables[0].Rows[0]["Currency"].ToString(), finance);
            PrintPdfDropDownList.DataSource = ds21;
            PrintPdfDropDownList.DataTextField = "printname";
            PrintPdfDropDownList.DataValueField = "printname";
            PrintPdfDropDownList.AppendDataBoundItems = true;
        ...
        else if (contract == "Trade-In-Fractionals")
        {
            ...
            string apt = tnmapttypeTextBox.Text;
            string season;
           // if(tnmseasonDropDownList.SelectedItem.Text=="")
...
protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        else if (financeradiobuttonlist.SelectedItem.Text == "Non Finance")
        {
            ...
            else if (contracttypeTextBox.Text == "Fractional")
            {
                DataTable datatable = Queries.Fractional_PA(contractnoTextBox.Text);
                string printr = PrintPdfDropDownList.SelectedItem.Text;
                ReportDocument crystalReport = new ReportDocument(); // creating object of crystal report
