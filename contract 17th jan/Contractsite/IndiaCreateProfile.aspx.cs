        ...
        try
        {
         ...
         //   string user = CreatedByTextBox.Text;
            ...
            if (exists == 0)
            {
                ...
                {
                    int profile = Queries.InsertProfile(ProfileIDTextBox.Text, DateTime.Now, createdby, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs, office, commentsTextBox.Text, mgr, photoidentity, card,"","", regTerms);
                    string log1 = "Profile Details:" + " " + "Profile ID:" + ProfileIDTextBox.Text + "," + "Created date:" + createddateTextBox.Text + "," + CreatedByTextBox.Text + "," + "venue country:" + venuecountry + "," + "mktg prgm:" + mktg + "," + "Agent:" + agents + "," + "TO Name:" + agentcode + "," + "Manager:" + mgr + "," + "membertype1:" + membertype1 + "," + "memno1:" + memno1 + "," + "membertype2:" + membertype2 + "," + "memno2:" + memno2 + "," + "Employmentstatus:" + employmentstatus + "," + "Maritalstatus:" + maritalstatus + "," + "Living Yrs:" + livingyrs + "," + "Office:" + office + "," + "Comments:" + commentsTextBox.Text + "," + "Mgr:" + mgr + "," + "Photo Identity:" + photoidentity + "," + "Card Holder:" + card+","+"Registration Terms:"+ regTerms;
