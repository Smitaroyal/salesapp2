            ...
            else
            {
                ...
                if (Finance_Details == "Finance")
                {
                    if (ContractType == "Fractionals")
                    {
                        ...
                        DataSet ds21 = Queries.LoadPrintPDFFiles_Indian(ContractType, office, dsf.Tables[0].Rows[0]["resort"].ToString(), dsf.Tables[0].Rows[0]["Currency"].ToString(), Finance_Details);
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Finance_Details == "Finance")
            {
                if (ContractType == "Fractionals")
                {
                    DataTable datatable = Queries.Fractional_PA(contractdetailsID);
                ...
                {
                    DataTable datatable = Queries.NewPoints_PA(contractdetailsID);
                    string printr = PrintPdfDropDownList.SelectedItem.Text;
                ...
                {
                    DataTable datatable = Queries.TradeInPoints_PA(contractdetailsID);
                    string printr = PrintPdfDropDownList.SelectedItem.Text;
                    ReportDocument crystalReport = new ReportDocument(); // creating object of crystal report
                    crystalReport.Load(Server.MapPath("~/reports/" + printr + ".rpt")); // path of report       
                    crystalReport.SetDataSource(datatable);
                ...
                {
                    DataTable datatable = Queries.TradeInWeeks_PA(contractdetailsID);
                    string printr = PrintPdfDropDownList.SelectedItem.Text;
                    ReportDocument crystalReport = new ReportDocument(); // creating object of crystal report
                    crystalReport.Load(Server.MapPath("~/reports/" + printr + ".rpt")); // path of report       
                    crystalReport.SetDataSource(datatable);
                ...
                else if (ContractType == "Trade-In-Fractionals")
                {
                    ...
                    DataTable datatable = Queries.FractionalTradeIn_PA(contractdetailsID);
                    string printr = PrintPdfDropDownList.SelectedItem.Text;
                    ReportDocument crystalReport = new ReportDocument(); // creating object of crystal report
                    crystalReport.Load(Server.MapPath("~/reports/" + printr + ".rpt")); // path of report       
                    crystalReport.SetDataSource(datatable);
