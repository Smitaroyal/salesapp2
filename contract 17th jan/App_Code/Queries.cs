   ...
   /* public static DataSet LoadAgentsOnVenue(string venue,string venuegroup)
    ...
    public static DataSet LoadTOOPCOnVenue11(string profile_ID, string venue)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            SqlCommand SqlCmd = new SqlCommand("select distinct to_name from OPC_TOs where TO_Status='Active' and  to_name not in(select Profile_Agent_Code from Profile where Profile_ID =@profile_ID) and venue=@venue", cs1);
    ...
    public static DataSet LoadTOOPCOnVenue12(string profile_ID, string venue)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            SqlCommand SqlCmd = new SqlCommand(" select distinct TO_Manager_Name from TO_Manager where TO_Manager_Status = 'Active' and TO_Manager_Name not in(select Profile_Agent_Code from Profile where Profile_ID =@Profile_ID) and Venue =@venue", cs1);
            SqlCmd.Parameters.Add("@profile_ID", SqlDbType.VarChar).Value = profile_ID;
            SqlCmd.Parameters.Add("@venue", SqlDbType.VarChar).Value = venue;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
   ...
   /* public static DataSet LoadPointsContract(string Currency)
    ...
    public static int InsertContract_Installments_Indian(string ProfileID, string ContractNo, string Installment_no, string Installment_Amount, string Installment_Date,string Installment_Invoice_No,string ContractDetails_ID)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Contract_Installments_Indian values(@ProfileID,	@ContractNo,@Installment_no,@Installment_Amount,@Installment_Date,@Installment_Invoice_No,@ContractDetails_ID)", cs1);
                da.InsertCommand.Parameters.Add("@ProfileID ", SqlDbType.VarChar).Value = ProfileID;
                da.InsertCommand.Parameters.Add("@ContractNo ", SqlDbType.VarChar).Value = ContractNo;
    ...
    public static DataSet LoadCurrency_Edit(string contractno)
    {
    ...
    public static DataSet LoadFinanceContractDetails(string contractno)
    {
    ...
    public static DataSet pointsentitlement(string contractno)
    {
    ...
    public static DataSet contractdealstatus(string contractno)
    {
    ...
    public static DataSet currencyfinancedetails(string contractno, string office)
    {
    ...
    public static DataSet paymethodfinancedetails(string contractno, string office)
    {
    ...
    public static DataSet financemethodfinancedetails(string contractno, string office)
    {
    ...
    public static DataSet contractPA(string contractno)
    {
    ...
    public static DataSet contractInstallment(string contractno)
    {
    ...
    public static DataSet tradeinpointsentitlement(string contractno)
    {
    ...
    public static DataSet tradeinwksentitlement(string contractno)
    {
    ...
    public static DataSet tradeinwksseason(string contractno)
    {
    ...
    public static DataSet loadtradeinfractional(string contractno)
    {
    ...
    public static DataSet loadtradeinfractionalResort(string contractno, string office)
    {
    ...
    public static DataSet loadtradeinfractionalResidence(string contractno)
    {
    ...
    public static DataSet loadtradeinfractionalResidencetype(string contractno)
    {
    ...
    public static DataSet loadtradeinfractionalFractionalInt(string contractno)
    {
    ...
    public static DataSet tradeinfractionalentitlement(string contractno)
    {
    ...
    public static DataSet tradeinfractionalseason(string contractno)
    {
    ...
    public static DataSet LoadfractionalPA(string contractno)
    {
    ...
    public static int UpdateContractDetails_Indian(string Sales_Rep, string TO_Manager, string ButtonUp_Officer, string DealRegistered_Date, string DealStatus, string MCWaiver, string Finance_Details, string pan_card, string Adhar_Card, string MC_Charges, string First_MC_Payable_Date, string MemberFee, string MemberCGST, string MembersGST, string contractno)
    {
        int rows = 0;
    ...
    public static int UpdateFinanceDetails_Indian(string Finance_Method, string Currency, string Affiliate_Type, string Total_Price_Including_Tax, string Initial_Deposit_Percent, string Initial_Deposit_Amount, string Balance_Payable, string Total_Inital_Deposit, string Initial_Deposit_Balance, string Bal_Amount_Payable, string Payment_Method, string No_Installments, string Installment_Amount, string Finance_Type, string Finance_No, string IGSTrate, string Interestrate, string documentationfee, string IGST_Amount, string No_Emi, string Emi_Installment, string financeMonth, string contractno)
    {
        int rows = 0;
    ...
    public static int UpdateContract_PA_Indian(string New_Points_Price, string Conversion_Fee, string Admin_Fee, string Total_Purchase_Price, string Cgst, string Sgst, string Total_Price_Including_Tax, string Deposit, string Balance, string Balance_Due_Dates, string Remarks, string contractno)
    {
        int rows = 0;
    ...
    public static int UpdateContract_Points_Indian(string club, string New_points_rights, string Type_membership, string Total_points_rights, string First_year_occupancy, string Tenure, string Last_year_occupancy, string contractno)
    {
        int rows = 0;
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand scd = new SqlCommand("update Contract_Points_Indian  SET club = '" + club + "', New_points_rights = '" + New_points_rights + "',Type_membership = '" + Type_membership + "',Total_points_rights = '" + Total_points_rights + "',First_year_occupancy = '" + First_year_occupancy + "', Tenure = '" + Tenure + "',Last_year_occupancy = '" + Last_year_occupancy + "'where contractno = '" + contractno + "'", cs1);
                scd.Parameters.Add("@contractno", SqlDbType.VarChar).Value = contractno;
                rows = scd.ExecuteNonQuery();
            }
            catch (Exception ex)
    ...
    public static int UpdateContract_Trade_In_Points_Indian(string Trade_In_Details_club_resort, string Trade_In_Details_No_rights, string Trade_In_Details_ContNo_RCINo, string Trade_In_Details_Points_value, string New_Club, string New_Club_Points_Rights, string New_MemebrshipType, string New_TotalPointsRights, string New_First_year_occupancy, string New_Tenure, string New_Last_year_occupancy, string contractno)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand scd = new SqlCommand("update Contract_Trade_In_Points_Indian  SET Trade_In_Details_club_resort = '" + Trade_In_Details_club_resort + "', Trade_In_Details_No_rights = '" + Trade_In_Details_No_rights + "',Trade_In_Details_ContNo_RCINo = '" + Trade_In_Details_ContNo_RCINo + "',Trade_In_Details_Points_value = '" + Trade_In_Details_Points_value + "' where contractno = '" + contractno + "'", cs1);
                scd.Parameters.Add("@contractno", SqlDbType.VarChar).Value = contractno;
                rows = scd.ExecuteNonQuery();
            }
            catch (Exception ex)
    ...
    public static int UpdateContract_Trade_In_Weeks_Indian(string Trade_In_Weeks_resort, string Trade_In_Weeks_Apt, string Trade_In_Weeks_Season, string Trade_In_Weeks_NoWks, string Trade_In_Weeks_ContNo_RCINo, string Trade_In_Weeks_Points_value, string NewPointsW_Club, string NewPointsW_Club_Points_Rights, string NewPointsW_MemebrshipType, string NewPointsW_Total_Points_rights, string NewPointsW_First_year_occupancy, string NewPointsW_Tenure, string NewPointsW_Last_year_occupancy, string contractno)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand scd = new SqlCommand("update Contract_Trade_In_Weeks_Indian  SET Trade_In_Weeks_resort = '" + Trade_In_Weeks_resort + "', Trade_In_Weeks_Apt = '" + Trade_In_Weeks_Apt + "',Trade_In_Weeks_Season = '" + Trade_In_Weeks_Season + "', Trade_In_Weeks_NoWks = '" + Trade_In_Weeks_NoWks + "', Trade_In_Weeks_ContNo_RCINo = '" + Trade_In_Weeks_ContNo_RCINo + "', Trade_In_Weeks_Points_value = '" + Trade_In_Weeks_Points_value + "' where contractno = '" + contractno + "'", cs1);
                scd.Parameters.Add("@contractno", SqlDbType.VarChar).Value = contractno;
                rows = scd.ExecuteNonQuery();
            }
            catch (Exception ex)
    ...
    public static int UpdateContract_FractionalPA_Indian(string Admission_fees, string administration_fees, string Total_Purchase_Price, string Cgst, string Sgst, string Total_Price_Including_Tax, string Deposit, string Balance, string Balance_Due_Dates, string Remarks, string contractno)
    {
        int rows = 0;
    ...
    public static int UpdateContract_Fractional_Indian(string resort, string residence_no, string residence_type, string fractional_interest, string entitlement, string firstyear_Occupancy, string tenure, string lastyear_Occupancy, string leaseback, string Mc_Charges, string contractno)
    {
        int rows = 0;
    ...
    public static int UpdateContract_Trade_In_Fractional_Indian(string Oldcontracttype, string RESORT, string APT_TYPE, string SEASON, string NO_WEEKS, string NO_POINTS, string POINTS_VALUE, string oldContract_No, string contractno)
    {
        int rows = 0;
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand scd = new SqlCommand("update Contract_Trade_In_Fractional_Indian  SET Oldcontracttype = '" + Oldcontracttype + "', RESORT = '" + RESORT + "',APT_TYPE = '" + APT_TYPE + "', SEASON = '" + SEASON + "', NO_WEEKS = '" + NO_WEEKS + "', NO_POINTS = '" + NO_POINTS + "', POINTS_VALUE = '" + POINTS_VALUE + "', oldContract_No = '" + oldContract_No + "'where contractno = '" + contractno + "'", cs1);
                scd.Parameters.Add("@contractno", SqlDbType.VarChar).Value = contractno;
                rows = scd.ExecuteNonQuery();
            }
            catch (Exception ex)
    ...
    public static int ContractNoInInstallmentTable(string contractno)
    {
        int exists;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
    ...
    public static int InsertContract_Installments_Indian_Deleted(string Installment_ID,string ProfileID, string ContractNo, string Installment_no, string Installment_Amount, string Installment_Date, string Installment_Invoice_No,string DeleteDate,string ContractDetails_ID)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Contract_Installments_Indian_Deleted values(@Installment_ID,@ProfileID,	@ContractNo,@Installment_no,@Installment_Amount,@Installment_Date,@Installment_Invoice_No,@DeleteDate,@ContractDetails_ID)", cs1);
    ...
    public static DataSet LoadcontractInstallment(string contractno)
    {
    ...
    public static int InsertContract_Indian_Deposit_Receipt(string Deposit_Receipt_Id, string ContractDetails_ID, string ContractNo, string Receipt_No, string Receipt_Date, string place_supply, string state, string state_code, string Product_Name, string SAC, string Amount,string taxable_value,string cgstrate,string cgstamt,string sgstrate,string sgstamt,string totalamt)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Contract_Indian_Deposit_Receipt values(@Deposit_Receipt_Id,@ContractDetails_ID ,	 @ContractNo ,	@Receipt_No ,	@Receipt_Date ,	@place_supply ,	@state ,	@state_code ,	@Product_Name,	@SAC ,	@Amount,@taxable_value,@cgstrate,@cgstamt,@sgstrate,@sgstamt,@totalamt)", cs1);
