      ...
      <div class="main_container">
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="countryName">
                  <div class="form-group">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="countryCode">
                  <div class="form-group">
                      <label for="sel1">Country  Code:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="Enter Country Code" runat="server"></asp:TextBox>
                  </div>
              </div>
