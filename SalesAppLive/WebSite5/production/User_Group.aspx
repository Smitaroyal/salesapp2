...
.has-search .form-control {
    ...
    padding-left: 34px;
     ...
     .title{
      ...
      #update,#userGroupID,#head,#userGroupName,#directory,#insert{
          display:none;
      }
      #TextBox5{
          text-align:center;
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="userGroupID">
              ...
              <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="userGroupName">
                  <div class="form-group">
                      <label for="sel1">User Group Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter User Group Name" runat="server"></asp:TextBox>
                  </div>
              </div>
              <div id="alert">
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'User_Group.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'User_Group.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
