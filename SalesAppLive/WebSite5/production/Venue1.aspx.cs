...
public partial class WebSite5_production_Venue1 : System.Web.UI.Page
{
    ...
    static string user;
    static string Venue_Name1;
    static string Venue_Status1;
    static string Venue_Country_ID1;
    static string GSTIN1;

    static string Venue_Address;
    static string Venue_PhoneNo;
    ...
    public static void insertVenue(string venuename,string venuecountry ,string gstin,string Address,string phone)
    {
        ...
        string details = "Venue Created : Venue Name: " + venuename + ", venueCountry: " + venuecountry + ", gstin: " + gstin+", Address:"+Address+", Phone:"+phone;
    ...
    public static void updateVenue(string venueID, string venueName, string status,string venueCountryID ,string gstin,string g_ID,string Address, string phone)
    {
        ...
        while (reader.Read())
        {
            Venue_Name1 = reader.GetString(0);
            Venue_Status1 = reader.GetString(1);

            Venue_Country_ID1 = reader.GetString(2);
            GSTIN1 = reader.GetString(3);

            Venue_Address = reader.GetString(4);
            Venue_PhoneNo = reader.GetString(5);
        }

        if (Venue_Name1.Equals(venueName))
        { }
        else
        {
            string pageName = "Venue";
            string details = "venue Name changed from: " + Venue_Name1 + "To: " + venueName;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }


        if (Venue_Status1.Equals(status))
        { }
        else
        {
            string pageName = "Venue";
            string details = "Status changed from: " + Venue_Status1 + "To: " + status;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }

        if (Venue_Country_ID1.Equals(venueCountryID))
        { }
        else
        {
            string pageName = "Venue";
            string details = "Venue Country changed from: " + Venue_Country_ID1 + "To: " + venueCountryID;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }
        ...
        {
            string pageName = "Venue";
            string details = "gstin changed from: " + GSTIN1 + "To: " + gstin;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }


        if (Venue_Address.Equals(Address))
        { }
        else
        {
            string pageName = "Venue";
            string details = "Address changed from: " + Venue_Address + "To: " + Address;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }


        if (Venue_PhoneNo.Equals(phone))
        { }
        else
        {
            string pageName = "Venue";
            string details = "Phone No changed from: " + Venue_PhoneNo + "To: " + phone;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }
