<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SeapInhouseCons.aspx.cs" Inherits="WebSite5_production_SeapInhouseCons" %>
                              ...
                              <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12" id="">
                                      <div class="form-group">
                                          ...
                                          <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="500px" Height="600px">
                                          </rsweb:ReportViewer>
                                      </div>
                                  </div>
                              </div>
     ...
     <script>
            ...
            $("#country").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapInhouseCons.aspx/getVenue',
            ...
            $("#venue").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapInhouseCons.aspx/getVenueGroup',
                    contentType: "application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "'}",
                    async: false,
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapInhouseCons.aspx/getSubVenue',
                    contentType: "application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "'}",
                    async: false,
                    success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'SeapInhouseCons.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapInhouseCons.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapInhouseCons.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
