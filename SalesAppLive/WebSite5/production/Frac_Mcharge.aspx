<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frac_Mcharge.aspx.cs" Inherits="WebSite5_production_Frac_Mcharge" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#mchargeID,#head,#mchargeName,#mchargeWeek,#directory,#insert,#Status,#mchargeYear{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD FRACTIONAL MC</h3>
              </div>
              </div>
            </div>
              <br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-sm-3" id="mchargeID">
                  <div class="form-group">
                      <label for="sel1">MC ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right" runat="server" ReadOnly></asp:TextBox>
                    
                  </div>
              </div>

              <div class="col-md-3 col-sm-3" id="mchargeName">
                  <div class="form-group">
                      <label for="sel1">Residence:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Residence " runat="server"></asp:TextBox>
                  </div>
              </div>
              <div class="col-md-3 col-sm-3" id="mchargeWeek">
                  <div class="form-group">
                      <label for="sel1">MC Per Week:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" runat="server"></asp:TextBox>
                  </div>
              </div>
               <div class="col-md-3 col-sm-3" id="mchargeYear">
                  <div class="form-group">
                      <label for="sel1">MC Year:</label>
                      <asp:TextBox ID="TextBox4" class="form-control pull-right" runat="server" ReadOnly></asp:TextBox>
                  </div>
              </div>

                <div class="col-md-3 col-sm-3" id="Status">
                  <div class="form-group">
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12" "><br />
                        <h3 class="text-center">MCHARGE DIRECTORY</h3>
                               </div>
           ...
           <div class="row">
            ...
            <thead>
                <tr>
                    <th>MCHARGE ID</th>
                    <th>MCHARGE RESIDENCE TYPE</th>
                    <th>MCHARGE PER WEEK</th>
                     <th>MCHARGE YEAR</th>
                     <th>STATUS</th>
                    <th>EDIT</th>
                    <th>DELETE</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
               var mchargeName = $("#TextBox2").val();
               var mchargeWeek = $("#TextBox3").val();
               var mchargeYear = $("#TextBox4").val();
               
                $.ajax({

                    type:'Post',
                    url: 'Frac_Mcharge.aspx/insertMcharge',
                    contentType:"application/json; charset=utf-8",
                    data: "{'mchargeName':'" + mchargeName + "','mchargeWeek':'" + mchargeWeek + "','mchargeYear':'" + mchargeYear + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var mchargeID = row.find("td:eq(0)").text();
                    var mchargeName = row.find("td:eq(1)").text();
                    var mchargeWeek = row.find("td:eq(2)").text();
                 
                    var mchargeStatus = row.find("td:eq(4)").text();

                    $("#TextBox1").val(mchargeID);
                    $("#TextBox2").val(mchargeName);
                    $("#TextBox3").val(mchargeWeek);
                    $("#status option[value='" + mchargeStatus + "']").prop('selected', true);
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Frac_Mcharge.aspx/getAllMcharge',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    var mchargeName = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + mchargeName + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Frac_Mcharge.aspx/deleteMcharge',
                            contentType: "application/json; charset=utf-8",
                            data: "{'mchargeID':'" + mchargeID + "','mchargeName':'" + mchargeName + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var mchargeID = $("#TextBox1").val();
                    var mchargeName = $("#TextBox2").val();
                    if (mchargeName == "" || mchargeName == null) {
                        mchargeName = "";
                    } else {
                        var mchargeName = $("#TextBox2").val();
                    }
                    ...
                    var mchargeWeek = $("#TextBox3").val();
                    if (mchargeWeek == "" || mchargeWeek == null) {
                        mchargeWeek = "";
                    } else {
                        var mchargeWeek = $("#TextBox3").val();
                    }
                    var mchargeYear = $("#TextBox4").val();
                    if (mchargeYear == "" || mchargeYear == null) {
                        mchargeYear = "";
                    } else {
                        mchargeYear = $("#TextBox4").val();
                    }
                    var mchargeStatus = $("#status").val();
                    if (mchargeStatus == "" || mchargeStatus == null) {
                        mchargeStatus = "";
                    } else {
                        mchargeStatus = $("#status").val();
                    }
                    $.ajax({
                        type: 'POST',
                        url: 'Frac_Mcharge.aspx/updateMcharge',
                        contentType: "application/json; charset=utf-8",
                        data: "{'mchargeID':'" + mchargeID + "','mchargeName':'" + mchargeName + "','mchargeWeek':'" + mchargeWeek + "','mchargeYear':'" + mchargeYear + "','mchargeStatus':'" + mchargeStatus + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
       ...
       <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Frac_Mcharge.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Frac_Mcharge.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
