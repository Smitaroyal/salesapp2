<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SeapConsoInhouse.aspx.cs" Inherits="WebSite5_production_SeapConsoInhouse" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h4 class="text-center">SEAP. CONSOLIDATE RECAP IN-HOUSE TS & FRACTIONAL</h4>
                            </div>
                        </div>
                    </div>
                    <br />
                  ...
                  <div class="container-fluid">
                      <div class="row">
                          ...
                          <div class="col-md-8 col-xs-12 col-sm-12 col-lg-8" id="">
                              ...
                              <div class="row">
                                  <div class="col-md-4 col-xs-12 col-sm-12 col-lg-4" id="Venue">
                                      <div class="form-group">
       ...
       <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'SeapConsoInhouse.aspx/getAdminRights',
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapConsoInhouse.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapConsoInhouse.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
