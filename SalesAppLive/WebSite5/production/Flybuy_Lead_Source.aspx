<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Flybuy_Lead_Source.aspx.cs" Inherits="WebSite5_production_Flybuy_Lead_Source" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#fly_LeadSource,#head,#fly_LeadSource_ID,#Status,#directory,#insert{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD GUEST RELATIONS</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="fly_LeadSource_ID">
                  <div class="form-group">
                      <label for="sel1">Guest Relations ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>
             
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="fly_LeadSource">
                  <div class="form-group">
                      <label for="sel1">Guest Relations:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Guest Relations" runat="server"></asp:TextBox>
                  </div>
              </div>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center">GUEST RELATIONS DIRECTORY</h4>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var fly_LeadSource = $("#TextBox2").val();
                if (fly_LeadSource == "" || fly_LeadSource == "") {
                    fly_LeadSource = "";
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Flybuy_Lead_Source.aspx/insertFlybuy_LeadSource',
                    contentType:"application/json; charset=utf-8",
                    data: "{'fly_LeadSource':'" + fly_LeadSource + "'}",
                    async: false,
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Flybuy_Lead_Source.aspx/getAllFlybuy_LeadSource',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var flyLeadSourceID = row.find("td:eq(0)").text();
                    var flyLeadSource = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + flyLeadSource + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Flybuy_Lead_Source.aspx/deleteFlybuy_LeadSource',
                            contentType: "application/json; charset=utf-8",
                            data: "{'flyLeadSourceID':'" + flyLeadSourceID + "','flyLeadSource':'" + flyLeadSource + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var fly_LeadSource_ID = $("#TextBox1").val();
                    var fly_LeadSource = $("#TextBox2").val();
                
                    var status = $("#status").val();

                    if (fly_LeadSource == "" || fly_LeadSource == null) {
                        fly_LeadSource = "";
                    } else {
                        var fly_LeadSource = $("#TextBox2").val();
                    }
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Flybuy_Lead_Source.aspx/updateFlybuy_LeadSource',
                        contentType: "application/json; charset=utf-8",
                        data: "{'fly_LeadSource_ID':'" + fly_LeadSource_ID + "','fly_LeadSource':'" + fly_LeadSource + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Flybuy_Lead_Source.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Flybuy_Lead_Source.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Flybuy_Lead_Source.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
