<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SeapRecap.aspx.cs" Inherits="WebSite5_production_SeapRecap" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h4 class="text-center">SEAP. RECAP</h4>
                            </div>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-xs-12 col-sm-12 col-lg-8" id="">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4" id="SubVenue">
                                        <div class="form-group">
     ...
     <script>
            ...
            $("#venue").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapRecap.aspx/getVenueGroup',
                    contentType: "application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "'}",
                    async: false,
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapRecap.aspx/getSubVenue',
                    contentType: "application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "'}",
                    async: false,
                    success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'SeapRecap.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapRecap.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
