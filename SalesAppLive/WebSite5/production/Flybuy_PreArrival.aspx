<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Flybuy_PreArrival.aspx.cs" Inherits="WebSite5_production_Flybuy_PreArrival" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#fly_PreArrival,#head,#fly_PreArrival_ID,#Status,#directory,#insert{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD PRE ARRIVAL</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="fly_PreArrival_ID">
                  <div class="form-group">
                      <label for="sel1">Pre Arrival ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>
             
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="fly_PreArrival">
                  <div class="form-group">
                      <label for="sel1">Pre Arrival:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Pre Arrival" runat="server"></asp:TextBox>
                  </div>
              </div>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center">PRE ARRIVAL DIRECTORY</h4>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var fly_PreArrival = $("#TextBox2").val();
                if (fly_PreArrival == "" || fly_PreArrival == "") {
                    fly_PreArrival = "";
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Flybuy_PreArrival.aspx/insertFlybuy_PreArrival',
                    contentType:"application/json; charset=utf-8",
                    data: "{'fly_PreArrival':'" + fly_PreArrival + "'}",
                    async: false,
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Flybuy_PreArrival.aspx/getAllFlybuy_PreArrival',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var flyPreArrivalID = row.find("td:eq(0)").text();
                    var flyPreArrival = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + flyPreArrival + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Flybuy_PreArrival.aspx/deleteFlybuy_PreArrival',
                            contentType: "application/json; charset=utf-8",
                            data: "{'flyPreArrivalID':'" + flyPreArrivalID + "','flyPreArrival':'" + flyPreArrival + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var fly_PreArrival_ID = $("#TextBox1").val();
                    var fly_PreArrival = $("#TextBox2").val();
                
                    var status = $("#status").val();

                    if (fly_PreArrival == "" || fly_PreArrival == null) {
                        fly_PreArrival = "";
                    } else {
                        var fly_PreArrival = $("#TextBox2").val();
                    }
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Flybuy_PreArrival.aspx/updateFlybuy_PreArrival',
                        contentType: "application/json; charset=utf-8",
                        data: "{'fly_PreArrival_ID':'" + fly_PreArrival_ID + "','fly_PreArrival':'" + fly_PreArrival + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Flybuy_PreArrival.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
                ...
                $("#searchPro").keyup(function () {
                   ...
                   // alert(profileID);
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Flybuy_PreArrival.aspx/searchProfile',
                        contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Flybuy_PreArrival.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
