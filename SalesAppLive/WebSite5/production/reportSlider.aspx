<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reportSlider.aspx.cs" Inherits="WebSite5_production_reportSlider" %>
   ...
   <script>
            ...
            $("#country").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'reportSlider.aspx/getVenue',
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'reportSlider.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'reportSlider.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
