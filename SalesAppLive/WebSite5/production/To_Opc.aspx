<%@ Page Language="C#" AutoEventWireup="true" CodeFile="To_Opc.aspx.cs" Inherits="WebSite5_production_To_Opc" %>
...
.has-search .form-control {
    ...
    padding-left: 34px;
     ...
     .title{
      ...
      #update,#toOpcID,#head,#toOpcName,#Office,#opcstatus,#directory,#insert,#Venue,#VenueGroup{
          display:none;
      }
      #TextBox5{
          text-align:center;
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h3 class="text-center">ADD TO OPC</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="toOpcID">
                  <div class="form-group">
                      <label for="sel1">TO OPC ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

               <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="toOpcName">
                  <div class="form-group">
                      <label for="sel1">TO OPC:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter To OPC" runat="server"></asp:TextBox>
                  </div>
              </div>
             
              <%-- <div class="col-md-2 col-sm-2 col-xs-12 col-lg-2" id="Office">
                  <div class="form-group">
               ...
               <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="opcstatus">
                  <div class="form-group">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12  col-lg-12 " ">
        <h3 class="text-center"> TO OPC DIRECTORY</h3>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var toOpcName = $("#TextBox2").val();
                if (toOpcName == "" || toOpcName == null) {
                    toOpcName = "";
                } else {
                    toOpcName = $("#TextBox2").val();
                }
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'To_Opc.aspx/insertToOpc',
                    contentType:"application/json; charset=utf-8",
                    data: "{'toOpcName':'" + toOpcName + "','venue':'" + venue + "','venueGroup':'" + venueGroup + "'}",
                    async: false,
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click','.delete-btn',function () {
                    var row = $(this).closest("tr");
                    var to_opc_ID = row.find("td:eq(0)").text();
                    //alert(ToManagerID);
                    var to_opcName = row.find("td:eq(1)").text();
                    var confirmation = confirm("are you sure you want to delete " + to_opcName + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'To_Opc.aspx/deleteTo_Opc',
                            contentType: "application/json; charset=utf-8",
                            data: "{'to_opc_ID':'" + to_opc_ID + "'}",
                            async: false,
                            success: function (data) {
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
                                    $("#success-alert").slideUp(500);
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var toOpcStatus = $("#status").val();
                    if (toOpcStatus == "" || toOpcStatus == null) {
                        toOpcStatus = "";
                    } else {
                        toOpcStatus = $("#status").val();
                    }
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'To_Opc.aspx/updateTo_Opc',
                        contentType: "application/json; charset=utf-8",
                        data: "{'toOpcID':'" + toOpcID + "','toOpcName':'" + toOpcName + "','venue':'" + venue + "','toOpcStatus':'" + toOpcStatus + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
            ...
            $(document).ready(function () {
                ...
                $("#venue").change(function () {
                  var venue=  $("#venue").val();
                    $.ajax({
                        type: 'POST',
                        url: 'To_Opc.aspx/getAllVenueGroup',
                        contentType: "application/json; charset=utf-8",
                        data: "{'venue':'" + venue + "'}",
                        async: false,
                        success: function (data) {
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'To_Opc.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
