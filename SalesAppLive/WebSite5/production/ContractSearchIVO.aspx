<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractSearchIVO.aspx.cs" Inherits="WebSite5_production_ContractSearchIVO" %>
        ...
        <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3 left_col">
                  <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border-bottom: 2px; height:auto; color: #172D44;" id="img">
                          ...
                          <img src="../production/images/Gold.png" class="img-square" alt="" style="margin-top:3px; margin-bottom:5px;"  width="160" height="50" /><br />
                  ...
                  <li class="">
                      ...
                      <div class="main">
                          ...
                          <div class="form-group has-feedback has-search">
                              ...
                              <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Search for Profile/Contract No.."></asp:TextBox>
                          </div>
    ...
    <script src="../build/js/custom.min.js"></script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'ContractSearchIVO.aspx/getAdminRights',
        ...
        $(document).ready(function () {
            ...
            $("#TextBox1").keyup(function () {
                ...
                var contractNo = $("#TextBox1").val();

                $.ajax({

                    type: 'Post',
                    url: 'ContractSearchIVO.aspx/searchcontract',
                    contentType: "application/json; charset=utf-8",
                        ...
                        $.each(subJson, function (key, value) {
                            ...
                            $.each(value, function (index1, value1) {
                                ...
                                if (value1[0] == "") {
                                    ...
                                    $("#task-table2 tbody").append("<tr><td><a href='" + value1[0] + "' id='contractclick'>" + value1[0] + "</a></td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td></tr>");
                                }
                            });
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#contractclick', function () {

                  var row = $(this).closest("tr");
                  var contractNo = row.find("td:eq(0)").text();
                $.ajax({

                    type: 'Post',
                    url: 'ContractSearchIVO.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'contractNo':'" + contractNo + "'}",
                    async: false,
                    success: function (data) {
