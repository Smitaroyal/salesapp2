		...
		DataSet dsT = Queries2.LoadTaxiprice(ProfileID);
          ...
          //  primarytitleDropDownList.Items.Add(ds.Tables[0].Rows[0]["Profile_Primary_Title"].ToString());
           ...
           // primarynationalityDropDownList.Items.Add(ds.Tables[0].Rows[0]["Profile_Primary_Nationality"].ToString());
            ...
            officecc = ""; officenum = ""; homecc = ""; homenum = "";

            officecc = ds.Tables[0].Rows[0]["Primary_office_cc"].ToString();
            officenum = ds.Tables[0].Rows[0]["Primary_office_num"].ToString();
            homecc = ds.Tables[0].Rows[0]["Secondary_office_cc"].ToString();
            homenum = ds.Tables[0].Rows[0]["Secondary_office_num"].ToString();
...
Array.Clear(er, 0, er.Length);
		...
		ogiftoptionDropDownList=""; ogiftoptionDropDownList2 = ""; ogiftoptionDropDownList3 = ""; ogiftoptionDropDownList4 = ""; ogiftoptionDropDownList5 = ""; ogiftoptionDropDownList6 = ""; ogiftoptionDropDownList7 = "";
            ...
            oSecond_Employment_status = ds.Tables[0].Rows[0]["Secondary_Employment_Status"].ToString(); //
            ...
            oPrimary_Email2 = ds.Tables[0].Rows[0]["Primary_Email2"].ToString();
            ...
            {
                oProfile_Stay_Arrival_Date = "";
            }
            else
            {
                oProfile_Stay_Arrival_Date = String.Format("{0:dd-MM-yyyy}", ds.Tables[0].Rows[0]["Profile_Stay_Arrival_Date"]);
            ...
            {
                oProfile_Stay_Departure_Date = "";
            }
            else
            {
                oProfile_Stay_Departure_Date = String.Format("{0:dd-MM-yyyy}", ds.Tables[0].Rows[0]["Profile_Stay_Departure_Date"]);
           ...
           // oProfile_Stay_Departure_Date = String.Format("{0:dd-MM-yyyy}", ds.Tables[0].Rows[0]["Profile_Stay_Departure_Date"]); //Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Stay_Departure_Date"].ToString()).ToString("yyyy-MM-dd");
            ...
            {
                oTour_Details_Tour_Date = "";
            }
            else
            {
                oTour_Details_Tour_Date = String.Format("{0:dd-MM-yyyy}", ds.Tables[0].Rows[0]["Tour_Details_Tour_Date"]);
...
string comments = commentTextBox.Text;
            ...
            {
                string act = "Secondary employment status changed from:" + oSecond_Employment_status + "To:" + Secondemploymentstatus;
                int insertlog2 = Queries2.InsertContractLogs(ProfileIDTextBox.Text, "", act, "Profile", user, DateTime.Now.ToString());
            }
            else { }
            ...
            if (String.Compare(String.IsNullOrEmpty(ovouchernoTextBox) ? "" : ovouchernoTextBox, voucher1) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ovouchernoTextBox2) ? "" : ovouchernoTextBox2, voucher2) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ovouchernoTextBox3) ? "" : ovouchernoTextBox3, voucher3) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ovouchernoTextBox4) ? "" : ovouchernoTextBox4, voucher4) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ovouchernoTextBox5) ? "" : ovouchernoTextBox5, voucher5) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ovouchernoTextBox6) ? "" : ovouchernoTextBox6, voucher6) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ovouchernoTextBox7) ? "" : ovouchernoTextBox7, voucher7) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ogiftprice1) ? "0" : ogiftprice1, giftprice1) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ogiftprice2) ? "0" : ogiftprice2, giftprice2) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ogiftprice3) ? "0" : ogiftprice3, giftprice3) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ogiftprice4) ? "0" : ogiftprice4, giftprice4) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ogiftprice5) ? "0" : ogiftprice5, giftprice5) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ogiftprice6) ? "0" : ogiftprice6, giftprice6) != 0)
            {
            ...
            if (String.Compare(String.IsNullOrEmpty(ogiftprice7) ? "0" : ogiftprice7, giftprice7) != 0)
            {
            ...
            if (String.Compare(oSP3Age, String.IsNullOrEmpty(Subprofile3) ? "" : Subprofile3) != 0)
            {
            ...
            if (String.Compare(oSP4Age, String.IsNullOrEmpty(Subprofile4) ? "" : Subprofile4) != 0)
            {
            ...
            //update profile
            int updateprofile = Queries2.UpdateProfile(profile, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs, "","","",comments,reception,subvenue,regTerms,VPID,regTerms2, Secondemploymentstatus,leadsource,prearrival,verifi,promosource,teleagent);
