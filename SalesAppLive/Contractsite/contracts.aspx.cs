...
public partial class _Default : System.Web.UI.Page
{
    ...
    static string ofname, olname, regTerms, regTerms2, DealRegDate;
...
Array.Clear(er, 0, er.Length);
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                test1 = helo1(VenueCountryDropDownList.SelectedItem.Text, VenueDropDownList.SelectedItem.Text, club, GroupVenueDropDownList.SelectedItem.Text, conttype, MarketingPrgmDropDownList.SelectedItem.Text);
                GenContNumb = test1;

                int ContractFinance = Queries2.InsertContractFinance(contfinaid, GenContNumb, ContType, affilice, affilhp, salesrep, tomanager,
                buttonup, FinaCurrency, PurchasePrice, AdminFees, MCFees, DealDrawer, PaymentMethod, FinanceNumb, BPaymethod, Pan, Adhar, ID_Card, ProfileIDTextBox.Text, Session["GlobOffice"].ToString(), CrownCurr, DealRegDate, ft1, ft2, DateTime.Now, DateTime.Now, cweekno, ContComment, PaymentMethodDeatils);
          ...
          /*  if (ContUPDG != "UPDW")
            ...
            if (conttype == "Points")
            {
                ...
                if (PayMethodDropDownList.SelectedItem.Text == "Crown Finance")
                {
                    ...
                    int FD = Queries2.InsertFDetails(FDID, tPurchase1, QDepo1, AmtCre1, CreCurr1, NoOfMonth1, RateOfInt1, MonthlyRepay1, ProfileIDTextBox.Text, contFinance, DateTime.Now.ToString(), MonthlyRepay110, MonthlyRepay1Payprotectcharge, PayProtect,FinaDate1);
                    ...
                    string log4 = "Finance_Details_ID:" + FDID + "," + "Finance_Details_Total_Pur:" + tPurchase1 + "," + "Finance_Details_Qual_Depo:" + QDepo1 + "," + "Finance_Details_Credit_Amount:" + AmtCre1 + "," + "Finance_Details_Amount_Curr:" + CreCurr1 + ","
                         + "Finance_Details_No_Of_Month:" + NoOfMonth1 + "," + "Finance_Details_Int_Rate:" + RateOfInt1 + "," + "Finance_Details_Monthly_Repay:" + MonthlyRepay1 + "," + "Profile_ID:" + ProfileIDTextBox.Text + "," + "Contract_Finance_ID:" + contFinance + "," + "Finance_Details_Entry_Date:" + DateTime.Now.ToString();
            ...
            else if (conttype == "Fractional")
            {
                ...
                string desc, amot1, date, date1, curr, text11, text12, text13, text14, BalloonPay, LastInstDate="";
                string PA = "PA";
            ...
            else if (conttype == "Trade Into Points")
            {
              ...
              //  string DepositPayMethodTP = "";//DPMTPointsDropDownList.SelectedItem.Text;
                ...
                BalanceDueDatesSATP, remarkTP, EuroRatesP, AusRatesP, GbpRates, IdaRates, UsePayProtectP, YearOfInterestP, ProfileIDTextBox.Text, contfinaid, TotalBalanceTP, DateTime.Now, Session["GlobOffice"].ToString(),BalanceDueDatesPATP2,BalanceDueDatesSATP2,remarkTP2,InitDepotp,BalDepotp,DepoDatetp,CPATP,IniBalNoInstallTP,IniBalInstAmtTP,BalloonPay,LastInstDate,CPADepoTP, BalanceDuePATPTD);
            ...
            string ContType1 = DropDownList40.SelectedItem.Text;
            DataSet ds21 = Queries2.LoadPrintFiles2(ContType1, Session["GlobOffice"].ToString(),GlobContClub, PaymentMethod2, affil2, CrownCurr);
            ...
            if (PCard_Type != "")
            {
                ...
                int PmentDetails = Queries2.InserPaymentDetails(PmentDetailsId, PCard_Type, PIssuing_Bank, PCredit_Card_No, PCard_Holders_Name, PExpiry, PSecurity_No,
                    PFor_Depo, PFor_Bala, SCard_Type, SIssuing_Bank, SCredit_Card, SCard_Holders_Name, SExpiry, SSecurity_No, SFor_Depo, SFor_Bala, ProfileIDTextBox.Text, contFinance, entrydate, Session["GlobOffice"].ToString(), Pcomments, Scomments);
            }
   ...
   /* protected void Button5_Click(object sender, EventArgs e)
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        DataTable datatable = Queries2.loadreport(TextContractNumb.Text, printr,Session["GlobOffice"].ToString());
    ...
    public static string helo1(string name,string venue,string club,string mark, string conttype, string markp)
    {
        //return "Hello "+name;
        string finaInstI = "";
        ...
        {
             finaInstI = Queries2.LoadPointCont(HttpContext.Current.Session["GlobOffice"].ToString(), club, name, venue, mark,markp);
        }
        else if (conttype == "Fractional" || conttype == "Trade Into Fractional")
        {
             finaInstI = Queries2.LoadFracCont(HttpContext.Current.Session["GlobOffice"].ToString(), club, name, venue, mark,markp);
        }
        //using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnectionString"].ConnectionString))
        //{
        //    /*SqlCommand SqlCmd = new SqlCommand("select Contract_Code from Contract_Club where Contract_Club_Name=@club_name  and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)and Venue_ID in (select Venue_ID from venue where Venue_Name = @venue)", cs1);
        ...
        try
        {
           ...
           // subvenue = Request.Form[VenueDropDownList2.UniqueID];
            ...
            if (giftoptionDropDownList.SelectedItem.Text != "")
            {
                ...
                {
                    int gift = Queries2.UpdateGiftValue(ogiftoptionDropDownList, gifto1, voucher1, ProfileIDTextBox.Text, chargeback, giftprice1);
                }
            }
            if (giftoptionDropDownList2.SelectedItem.Text != "")
            {
                ...
                {
                    int gift = Queries2.UpdateGiftValue(ogiftoptionDropDownList2, gifto2, voucher2, ProfileIDTextBox.Text, "", giftprice2);
                }
            }
            if (giftoptionDropDownList3.SelectedItem.Text != "")
            {
                ...
                else
                {
                    ...
                    int gift = Queries2.UpdateGiftValue(ogiftoptionDropDownList3, gifto3, voucher3, ProfileIDTextBox.Text, "", giftprice3);
                }
            }
            ...
            if (giftoptionDropDownList4.SelectedItem.Text != "")
            {
                ...
                else
                {
                    ...
                    int gift = Queries2.UpdateGiftValue(ogiftoptionDropDownList4, gifto4, voucher4, ProfileIDTextBox.Text, "", giftprice4);
                }
            }
            ...
            if (giftoptionDropDownList5.SelectedItem.Text != "")
            {
                ...
                else
                {
                    ...
                    int gift = Queries2.UpdateGiftValue(ogiftoptionDropDownList5, gifto5, voucher5, ProfileIDTextBox.Text, "", giftprice5);
                }
            }
            ...
            if (giftoptionDropDownList6.SelectedItem.Text != "")
            {
                ...
                else
                {
                    ...
                    int gift = Queries2.UpdateGiftValue(ogiftoptionDropDownList6, gifto6, voucher6, ProfileIDTextBox.Text, "", giftprice6);
                }
            }
            ...
            if (giftoptionDropDownList7.SelectedItem.Text != "")
            {
                ...
                else
                {
                    ...
                    int gift = Queries2.UpdateGiftValue(ogiftoptionDropDownList7, gifto7, voucher7, ProfileIDTextBox.Text, "", giftprice7);
                }
            }
