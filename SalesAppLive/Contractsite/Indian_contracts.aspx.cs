...
public partial class _Default : System.Web.UI.Page
{
	...
	comment2.Text= ds.Tables[0].Rows[0]["comment2"].ToString();
         ...
         /* DataSet dsc = Queries.LoadPointsClub(office,Queries.GetVenueCode(VenueDropDownList.SelectedItem.Text,Queries.GetVenueCountryCode(VenueCountryDropDownList.SelectedItem.Text)));
            ...
            //    ffresortDropDownList.DataSource = dsres1;
            //    ffresortDropDownList.DataTextField = "Contract_Resort_Name";
            //    ffresortDropDownList.DataValueField = "Contract_Resort_Name";
            //    ffresortDropDownList.AppendDataBoundItems = true;
            //    ffresortDropDownList.Items.Insert(0, new ListItem("", ""));
    ...
    public void CreateButton_Click(object sender, EventArgs e)
    {
        ...
        int dealwkno = Queries.GetWkNumber(Convert.ToDateTime(dt));
       
	string dealdate1=Convert.ToDateTime(dealdateTextBox.Text).ToString("dd-MM-yyyy");
		...
		string ncompanyname=companynameTextBox.Text.ToUpper();
                if (String.Compare(ocompanyname, ncompanyname) != 0)
                {
                    ...
                    string log3 = "Company Name changed from:" + ocompanyname + " " + "to" + ncompanyname;
          ...
          //  } 
            ...
            if (mcRadioButtonList.Checked == true)
                ...
                if (contracttype == "Fractional")
                {
                    ...
                    string mcstartdate = "01/11/" + occyr;
                ...
                int insertcontractdetails = Queries.InsertContractDetails_Indian(contractno, profileid, contsalesrepDropDownList.SelectedItem.Text, TOManagerDropDownList.SelectedItem.Text, ButtonUpDropDownList.SelectedItem.Text, dealdate1, dealstatusDropDownList.SelectedItem.Text, DateTime.Now.ToString(), "", contracttypeDropDownList.SelectedItem.Text, mcwaiver, financeradiobuttonlist.SelectedItem.Text, "", pancardnoTextBox.Text.ToUpper(), adharcardTextBox.Text.ToUpper(), propertyfee, mcstartdate, memberfee, membercgst, membersgst, CanxContractNoTextBox.Text, contractdetailsID,"",LoanBUOfficerTextBox.Text.ToUpper(),gstinTextBox.Text.ToUpper(), companypanoTextBox.Text.ToUpper(), dealwkno.ToString(), "", "", contractcommentTextBox.Text, user);
                ...
                if (NoinstallmentTextBox.Text == ""|| NoinstallmentTextBox.Text == "0"|| NoinstallmentTextBox.Text == "NaN")
                {
                    if (financeradio == "Finance")
                    {
                        ...
                        else
                        {
                         ...
                         financebreakup(noemiTextBox.Text, balamtpayableTextBox.Text, emiamtTextBox.Text, contractdetailsID, contracttypeDropDownList.SelectedItem.Text, contractno, NoinstallmentTextBox.Text);
                ...
                if (frpdoldamtTextBox.Text==""|| frpdoldamtTextBox.Text=="NaN"|| frpdoldamtTextBox.Text=="0"|| frpdoldamtTextBox.Text==null)
                {
                    ...
                    else
                    {
                        ...
                        double taxableamt = 0;
                        string Contract_Indian_Deposit_ReceiptID = Queries.GetContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                        int receipt = Queries.InsertContract_Indian_Deposit_Receipt(Contract_Indian_Deposit_ReceiptID, contractdetailsID, contractno, invoiceno, DateTime.Now.ToShortDateString(), dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString(), dsrecp.Tables[0].Rows[0]["State"].ToString(), dsrecp.Tables[0].Rows[0]["StateCode"].ToString(), "SALE OF POINTS (TIMESHARE)", "996311", taxableamt.ToString(), taxableamt.ToString(), "9%", gst.ToString(), "9%", gst.ToString(), indeposit.ToString(), depositmethodDropDownList.SelectedItem.Text, currencyDropDownList.SelectedItem.Text, "Rs.", currentrate.ToString(), DateTime.Now.ToString(), intialdeppercentTextBox.Text, "Deposit");
                        string logr = "Invoice Details:" + "Deposit_ReceiptID:" + Contract_Indian_Deposit_ReceiptID + "," + "contractdetails ID:" + contractdetailsID + "," + "Contractno:" + contractno + "," + "Invoice No:" + invoiceno + "," + "Date:" + DateTime.Now.ToShortDateString() + "," + "Supply Place:" + dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString() + "State:" + dsrecp.Tables[0].Rows[0]["State"].ToString() + "," + "State Code:" + dsrecp.Tables[0].Rows[0]["StateCode"].ToString() + "," + "Product Code:" + "PRESTIGE ROYAL RESIDENCES" + "," + "SAC:" + "996311" + "," + "Amount:" + taxableamt.ToString() + "," + "Taxable value:" + taxableamt.ToString() + "," + "CGST:" + "9%" + "," + "CGST Amt.:" + gst.ToString() + "," + "SGST:" + "9%" + "," + "SGST Amt:" + gst.ToString() + "," + "Total Amount:" + indeposit.ToString() + "," + "Deposit Payment mode:" + depositmethodDropDownList.SelectedItem.Text + "," + "Actual currency:" + currencyDropDownList.SelectedItem.Text + "," + "Converted Currency:" + "Rs." + "," + "Current rate:" + currentrate.ToString() + "," + "Exchanged date:" + DateTime.Now.ToShortDateString() + "," + "Actual Amt:" + intialdeppercentTextBox.Text + "," + "contractdetailsID:" + contractdetailsID;
                        int insertlogr = Queries.InsertContractLogs_India(profileid, contractdetailsID, logr, user, DateTime.Now.ToString());
                        int updategenno = Queries.UpdateContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                        //update receiptgen no
                        int updaterecno = Queries.UpdateIndian_ReceiptGeneration(VenueDropDownList.SelectedItem.Text);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        double taxableamt = 0;
                        string Contract_Indian_Deposit_ReceiptID = Queries.GetContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                        int receipt = Queries.InsertContract_Indian_Deposit_Receipt(Contract_Indian_Deposit_ReceiptID, contractdetailsID, contractno, invoiceno, DateTime.Now.ToShortDateString(), dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString(), dsrecp.Tables[0].Rows[0]["State"].ToString(), dsrecp.Tables[0].Rows[0]["StateCode"].ToString(), "PRESTIGE ROYAL RESIDENCES", "996311", taxableamt.ToString(), taxableamt.ToString(), "9%", gst.ToString(), "9%", gst.ToString(), indeposit.ToString(), depositmethodDropDownList.SelectedItem.Text, currencyDropDownList.SelectedItem.Text, "Rs.", currentrate.ToString(), DateTime.Now.ToString(), intialdeppercentTextBox.Text, "Deposit");
                        string logr = "Invoice Details:" + "Deposit_ReceiptID:" + Contract_Indian_Deposit_ReceiptID + "," + "contractdetails ID:" + contractdetailsID + "," + "Contractno:" + contractno + "," + "Invoice No:" + invoiceno + "," + "Date:" + DateTime.Now.ToShortDateString() + "," + "Supply Place:" + dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString() + "State:" + dsrecp.Tables[0].Rows[0]["State"].ToString() + "," + "State Code:" + dsrecp.Tables[0].Rows[0]["StateCode"].ToString() + "," + "Product Code:" + "PRESTIGE ROYAL RESIDENCES" + "," + "SAC:" + "996311" + "," + "Amount:" + taxableamt.ToString() + "," + "Taxable value:" + taxableamt.ToString() + "," + "CGST:" + "9%" + "," + "CGST Amt.:" + gst.ToString() + "," + "SGST:" + "9%" + "," + "SGST Amt:" + gst.ToString() + "," + "Total Amount:" + indeposit.ToString() + "," + "Deposit Payment mode:" + depositmethodDropDownList.SelectedItem.Text + "," + "Actual currency:" + currencyDropDownList.SelectedItem.Text + "," + "Converted Currency:" + "Rs." + "," + "Current rate:" + currentrate.ToString() + "," + "Exchanged date:" + DateTime.Now.ToShortDateString() + "," + "Actual Amt:" + intialdeppercentTextBox.Text + "," + "contractdetailsID:" + contractdetailsID;
                        int insertlogr = Queries.InsertContractLogs_India(profileid, contractdetailsID, logr, user, DateTime.Now.ToString());
                        int updategenno = Queries.UpdateContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                        //update receiptgen no
              ...
              //  DataSet dsmc = Queries.LoadMCChart(pointsclubDropDownList.SelectedItem.Text, firstyrTextBox.Text, currencyDropDownList.SelectedItem.Text);
                ...
                string log1 = "Contract Created:" + " " + "with Contract # : " + contractno + " " + "for profile ID:" + profileid + "  " + "SalesRep:" + contsalesrepDropDownList.SelectedItem.Text + "," + "TO Manager:" + TOManagerDropDownList.SelectedItem.Text + "," + "Button Up:" + ButtonUpDropDownList.SelectedItem.Text + "," + "Deal Date:" + dealdate1 + "," + "Deal Status:" + dealstatusDropDownList.SelectedItem.Text + "," + "Contract Created DAte:" + DateTime.Now.ToShortDateString() + "," + "" + "Contract type:" + contracttypeDropDownList.SelectedItem.Text + "," + "MC Waiver Applicable:" + mcwaiver + "," + "Mode:" + financeradiobuttonlist.SelectedItem.Text + "," + "Remark:" + "" + "Pancard:" + pancardnoTextBox.Text + "," + "Adhar card:" + adharcardTextBox.Text + "," + "Property fee:" + propertyfee + "," + "MC First Yr:" + mcstartdate + "," + "Memberfee:" + memberfee + memberfee + "," + "Canx Contract No:" + CanxContractNoTextBox.Text + "," + "contractdetailsID:" + contractdetailsID + "," + "Canx Date:" + "" + "," + "Loan BU Officer:" + LoanBUOfficerTextBox.Text+","+"GSTIN No:"+gstinTextBox.Text + "," + "Co. Pan No:" + companypanoTextBox.Text+","+"Week no:"+ dealwkno+","+"Deck no:"+""+"Deck details:"+""+"Contract comment:"+ contractcommentTextBox.Text + "Contract Created by :" + user;
                int insertlog1 = Queries.InsertContractLogs_India(profileid, contractdetailsID, log1, user, DateTime.Now.ToString());
                ...
                if (pdoldamtTextBox.Text == "" || pdoldamtTextBox.Text == "NaN" || pdoldamtTextBox.Text == "0" || pdoldamtTextBox.Text == null)
                {
                    ...
                    else
                    {
                        ...
                        double taxableamt = 0;
                        string Contract_Indian_Deposit_ReceiptID = Queries.GetContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                        int receipt = Queries.InsertContract_Indian_Deposit_Receipt(Contract_Indian_Deposit_ReceiptID, contractdetailsID, contractno, invoiceno, DateTime.Now.ToShortDateString(), dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString(), dsrecp.Tables[0].Rows[0]["State"].ToString(), dsrecp.Tables[0].Rows[0]["StateCode"].ToString(), "SALE OF POINTS (TIMESHARE)", "996311", taxableamt.ToString(), taxableamt.ToString(), "9%", gst.ToString(), "9%", gst.ToString(), indeposit.ToString(), depositmethodDropDownList.SelectedItem.Text, currencyDropDownList.SelectedItem.Text, "INR", currentrate.ToString(), DateTime.Now.ToShortDateString(), intialdeppercentTextBox.Text, "Deposit");
                        string logr = "Invoice Details:" + "Deposit_ReceiptID:" + Contract_Indian_Deposit_ReceiptID + "," + "contractdetails ID:" + contractdetailsID + "," + "Contractno:" + contractno + "," + "Invoice No:" + invoiceno + "," + "Date:" + DateTime.Now.ToShortDateString() + "," + "Supply Place:" + dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString() + "State:" + dsrecp.Tables[0].Rows[0]["State"].ToString() + "," + "State Code:" + dsrecp.Tables[0].Rows[0]["StateCode"].ToString() + "," + "Product Code:" + "SALE OF POINTS (TIMESHARE)" + "," + "SAC:" + "996311" + "," + "Amount:" + taxableamt.ToString() + "," + "Taxable value:" + taxableamt.ToString() + "," + "CGST:" + "9%" + "," + "CGST Amt.:" + gst.ToString() + "," + "SGST:" + "9%" + "," + "SGST Amt:" + gst.ToString() + "," + "Total Amount:" + indeposit.ToString() + "," + "Deposit Payment mode:" + depositmethodDropDownList.SelectedItem.Text + "," + "Actual currency:" + currencyDropDownList.SelectedItem.Text + "," + "Converted Currency:" + "Rs." + "," + "Current rate:" + currentrate.ToString() + "," + "Exchanged date:" + DateTime.Now.ToShortDateString() + "," + "Actual Amt:" +intialdeppercentTextBox.Text  + "," + "contractdetailsID:" + contractdetailsID;
                        int insertlogr = Queries.InsertContractLogs_India(profileid, contractdetailsID, logr, user, DateTime.Now.ToString());
                        int updategenno = Queries.UpdateContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                        //update receiptgen no
            ...
            else if (contracttype == "Trade-In-Fractionals")
            {
                ...
                if (oldcontracttypeTextBox.Text == "Weeks")
                    ...
                    if (frpdoldamtTextBox.Text == "" || frpdoldamtTextBox.Text == "NaN" || frpdoldamtTextBox.Text == "0" || frpdoldamtTextBox.Text == null)
                    {
                        if(currencyDropDownList.SelectedItem.Text=="INR")
                        {
                            ...
                            double taxableamt = Math.Round(indeposit / 118 * 100);
                            string Contract_Indian_Deposit_ReceiptID = Queries.GetContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                              int receipt = Queries.InsertContract_Indian_Deposit_Receipt(Contract_Indian_Deposit_ReceiptID, contractdetailsID, contractno, invoiceno, DateTime.Now.ToShortDateString(), dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString(), dsrecp.Tables[0].Rows[0]["State"].ToString(), dsrecp.Tables[0].Rows[0]["StateCode"].ToString(), "PRESTIGE ROYAL RESIDENCES", "996311", taxableamt.ToString(), taxableamt.ToString(), "9%", gst.ToString(), "9%", gst.ToString(), indeposit.ToString(), depositmethodDropDownList.SelectedItem.Text,"", "", "", "", "", "Deposit");
                            string logr = "Invoice Details:" + "Deposit_ReceiptID:" + Contract_Indian_Deposit_ReceiptID + "," + "contractdetails ID:" + contractdetailsID + "," + "Contractno:" + contractno + "," + "Invoice No:" + invoiceno + "," + "Date:" + DateTime.Now.ToShortDateString() + "," + "Supply Place:" + dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString() + "State:" + dsrecp.Tables[0].Rows[0]["State"].ToString() + "," + "State Code:" + dsrecp.Tables[0].Rows[0]["StateCode"].ToString() + "," + "Product Code:" + "PRESTIGE ROYAL RESIDENCES" + "," + "SAC:" + "996311" + "," + "Amount:" + taxableamt.ToString() + "," + "Taxable value:" + taxableamt.ToString() + "," + "CGST:" + "9%" + "," + "CGST Amt.:" + gst.ToString() + "," + "SGST:" + "9%" + "," + "SGST Amt:" + gst.ToString() + "," + "Total Amount:" + indeposit.ToString() + "," + "Deposit Payment mode:" + depositmethodDropDownList.SelectedItem.Text + "," + "Actual currency:" + "" + "," + "Converted Currency:" + "" + "," + "Current rate:" + "0" + "," + "Exchanged date:" + "" + "," + "Actual Amt:" + " " + "," + "contractdetailsID:" + contractdetailsID;
                            int insertlogr = Queries.InsertContractLogs_India(profileid, contractdetailsID, logr, user, DateTime.Now.ToString());
                            int updategenno = Queries.UpdateContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                            //update receiptgen no
                        ...
                        else
                        {
                            ...
                            double taxableamt = 0;
                            string Contract_Indian_Deposit_ReceiptID = Queries.GetContract_Indian_Deposit_Receipt_ID(officeTextBox.Text);
                            int receipt = Queries.InsertContract_Indian_Deposit_Receipt(Contract_Indian_Deposit_ReceiptID, contractdetailsID, contractno, invoiceno, DateTime.Now.ToShortDateString(), dsrecp.Tables[0].Rows[0]["SupplyPlace"].ToString(), dsrecp.Tables[0].Rows[0]["State"].ToString(), dsrecp.Tables[0].Rows[0]["StateCode"].ToString(), "KARMA ROYAL RESIDENCES", "996311", taxableamt.ToString(), taxableamt.ToString(), "9%", gst.ToString(), "9%", gst.ToString(), indeposit.ToString(), depositmethodDropDownList.SelectedItem.Text, currencyDropDownList.SelectedItem.Text, "Rs.", currentrate.ToString(), DateTime.Now.ToString(), intialdeppercentTextBox.Text, "Deposit");
                ...
                else if (oldcontracttypeTextBox.Text == "Fractionals")
                {
                    ...
                    string log6 = "trade in Fractional to Fractional:" + "TradeInFractionalIndian_ID:" + ContractTradeInFractionalIndian_ID + "," + "Profile ID:" + profileid + "," + "Contract No:" + contractno + "," + "Old Contract No:" + oldcontracttypeTextBox.Text + "," + "Club:" + ffresorttradeTextBox.Text.ToUpper() + "," + "Apt:" + ffaptTextBox.Text.ToUpper() + "," +"Season:"+","+ "No.Weeks:" + ffnowksTextBox.Text.ToUpper() + "," + "No. Pts:"+""+ "Points Value:" + ""+ "," + "Cont.No:" + ffconnoTextBox.Text.ToUpper() + "," + "contractdetailsID:" + contractdetailsID;
                    int insertlog6 = Queries.InsertContractLogs_India(profileid, contractdetailsID, log6, user, DateTime.Now.ToString());
                    int updatefacttiw = Queries.UpdateContract_Trade_In_Fractional_Indian_ID(officeTextBox.Text);

                    int insertpointsfinancedetails = Queries.InsertFinance_Details_Indian(Finance_Details_Id, profileid, contractno, financeradio, currency, Affiliate_Type, Total_Price_Including_Tax, Initial_Deposit_Percent, Initial_Deposit_Amount, Balance_Payable, Total_Inital_Deposit, Initial_Deposit_Balance, Bal_Amount_Payable, Payment_Method, No_Installments.ToString(), Installment_Amount, Finance_Type, Finance_No, IGSTrate, Interestrate, documentationfee, IGST_Amount, No_Emi, emiamt, "", foldloanagreementnoTextBox.Text, regcollterm, regcollamt, contractdetailsID, baladepamtdateTextBox.Text, ffoldloanamountTextBox.Text);
                    int updatefinanceid = Queries.UpdateFinance_Details_Indian_ID(officeTextBox.Text);
...
public static string LoadClubNameonContractType(string contracttype)
{
	...
	ocomment2= ds.Tables[0].Rows[0]["comment2"].ToString();
 	...
 	if (String.Compare(ocomment2, Procomment2) != 0)
        {
            string act = "comment 2 changed from:" + ocomment2 + "To:" + Procomment2;
            int insertlog1 = Queries.InsertContractLogs_India(profileidTextBox.Text, "", act, user, DateTime.Now.ToString());
        }
        else { }
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
      ...
      string   ContractdetailsID  = dsct.Tables[0].Rows[0]["ContractDetails_ID"].ToString();
        ...
        LoadDocuments(ContractdetailsID, officeTextBox.Text, Finance_Details, contracttypeDropDownList.SelectedItem.Text, aftype, mc, canxcontno, companyname, statename);
        string script = "<script> $(function() {$('#tabs').tabs({ disabled: [5] });  $( '#tabs' ).tabs({ active: 4 }); });</script> ";
        ScriptManager.RegisterStartupScript(this, typeof(Page), "alert", script, false);
