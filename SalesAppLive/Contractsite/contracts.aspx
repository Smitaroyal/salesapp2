 ...
 <p class="help_text_style">Email2</p>
        ...
        <asp:DropDownList ID="secondaryalternateDropDownList" runat="server" Width="100px" style="height: 25px"></asp:DropDownList>
         ...
         <br />
             ...
             <input id="Secochs" type="checkbox" onclick="shows('Secochs', 'Sechidden');"/> <asp:Label ID="Label84" runat="server" Text="Label">ID Card?</asp:Label>
        <br />
        <div id ="Sechidden">
                ...
                <table cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                       ...
                       <table id="fbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextInitDepoF" runat="server" Enabled="True" Width="328px" onchange="load_Ibalance();adminfee();"></asp:TextBox></td>
                           </tr>
                           <tr>
                    ...
                    <tr>
                        ...
                        <td width="400px"><asp:TextBox ID="TextNoOfInstallF" runat="server" Enabled="True" Width="328px" onchange="changeInstallNo('Button9','Button13');"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td></td>
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                       ...
                       <table id="pbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextInitDepo" runat="server" Enabled="True" Width="328px" onchange="load_Ibalance();adminfee();"></asp:TextBox></td>
                           </tr>
                           <tr>
                    ...
                    <tr>
                        ...
                        <td width="400px"><asp:TextBox ID="TextPPANoInstall" runat="server" Enabled="True" Width="328px" onchange="changeInstallNo('Button7','Button12');"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td></td>
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                     ...
                     <table id="tfbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextInitDepoTF" runat="server" Enabled="True" Width="328px" onchange="load_Ibalance();adminfee();"></asp:TextBox></td>
                           </tr>
                           <tr>
                    ...
                    <tr>
                        ...
                        <td  width="400px"><asp:TextBox ID="TextNoOfInstallTF" runat="server" Enabled="True" Width="328px" onchange="changeInstallNo('Button11','Button14');"></asp:TextBox></td>
                    </tr>
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                       ...
                       <table id="tpbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextInitDepoTP" runat="server" Enabled="True" Width="328px" onchange="load_Ibalance();adminfee();"></asp:TextBox></td>
                           </tr>
                           <tr>
                    ...
                    <tr>
                        ...
                        <td width="400px"><asp:TextBox ID="TextNoOfInstallPATP" runat="server" Enabled="True" Width="328px" onchange="changeInstallNo('Button10','tButton1');"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td></td>
