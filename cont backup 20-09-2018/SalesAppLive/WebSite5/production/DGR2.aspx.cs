...
public partial class WebSite5_production_DGR2 : System.Web.UI.Page
{
    ...
    private void show_report(string office,string venue)
    {
        ...
        DataTable dt = Queries2.loadDGRBALI1(date, office, venue);
        ...
        ReportViewer2.LocalReport.ReportPath = "reports/dgrbali-fix-2.rdlc";
