<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Top_Drawer.aspx.cs" Inherits="WebSite5_production_Top_Drawer" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h4 class="text-center">TOP DRAWER</h4>
                            </div>
                        </div>
                    </div>
                    <br />
   ...
   <script>
            ...
            $("#venue").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Top_Drawer.aspx/getVenueGroup',
                    contentType: "application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "'}",
                    async: false,
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Top_Drawer.aspx/getSubVenue',
                    contentType: "application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "'}",
                    async: false,
                    success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Top_Drawer.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Top_Drawer.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
