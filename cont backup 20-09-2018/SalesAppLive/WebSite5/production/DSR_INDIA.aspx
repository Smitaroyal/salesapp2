<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DSR_INDIA.aspx.cs" Inherits="WebSite5_production_DSR_INDIA" %>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4" id="">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="currency" id="currency" multiple="multiple">
                                                <option disabled selected value>--Select an Option--</option>
   ...
   <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'DSR_INDIA.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
