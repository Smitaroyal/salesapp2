<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractSeqCold.aspx.cs" Inherits="WebSite5_production_ContractSeqCold" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#ID,#head,#clubName,#contractCode,#incVal,#contStatus,#directory,#insert{
             display:none;
         }
      ...
      <div class="main_container">
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="clubName">
                  <div class="form-group">
                      <label for="sel1">Club Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="" runat="server"></asp:TextBox>
                  </div>
              </div>
                <div class="col-md-2 col-sm-2 col-xs-12 col-lg-2" id="contStatus">
                  <div class="form-group">
              ...
              <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="contractCode">
                  <div class="form-group">
                ...
                <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="incVal">
                  <div class="form-group">
                      <label for="sel1">Inc Val:</label>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center"> CONTRACT SEQ COLD DIRECTORY</h4>
                               </div>
            ...
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                  //  $("#insertButton").show();
                    ...
                    var contCode = row.find("td:eq(3)").text();
                    var incVal = row.find("td:eq(4)").text();


                    $("#TextBox1").val(ID);
                    $("#TextBox2").val(name);
                    $("#status option[value='" + status + "']").prop('selected', true);
                    $("#TextBox3").val(contCode);
                    $("#TextBox4").val(incVal);
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'ContractSeqCold.aspx/getAllContSeqCold',
                        ...
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td></tr>");
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var ID = $("#TextBox1").val();
                    var clubName = $("#TextBox2").val();
                    var status = $("#status").val();
                    var contCode = $("#TextBox3").val();
                    var incVal = $("#TextBox4").val();
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ContractSeqCold.aspx/updateContractSeqCold',
                        contentType: "application/json; charset=utf-8",
                        data: "{'ID':'" + ID + "','clubName':'" + clubName + "','status':'" + status + "','contCode':'" + contCode + "','incVal':'" + incVal + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'ContractSeqCold.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'ContractSeqCold.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'ContractSeqCold.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
