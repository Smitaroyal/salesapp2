      ...
      <div class="main_container">
        ...
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-md-1 col-sm-2" id="exchangeRateID">
              ...
              <div class="col-md-1 col-sm-2" id="eRatesINR">
                  ...
                  <div class="col-md-1 col-sm-2" id="eRatesAUD">
                             ...
                             <div class="col-md-1 col-sm-2" id="eRatesGBP">
                                <div class="form-group">
                             ...
                             <div class="col-md-2 col-sm-2" id="date">
                                <div class="form-group">
                        ...
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    if(value1[6]=="Inactive"){
                                        $("#task-table tbody").append("<tr bgcolor='#e52464'><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td></tr>");
                                    }else{
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Exchange_Rate.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Exchange_Rate.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Exchange_Rate.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
