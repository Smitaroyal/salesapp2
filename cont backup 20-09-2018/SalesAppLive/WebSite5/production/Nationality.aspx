<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nationality.aspx.cs" Inherits="WebSite5_production_Nationality" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#ID,#head,#nationalityName,#nationalityCountry,#directory,#insert{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD NATIONALITY</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row">
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="ID">
                  <div class="form-group">
                      <label for="sel1">ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right" runat="server"></asp:TextBox>
                  </div>
              </div>
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="nationalityName">
                  <div class="form-group">
                      <label for="sel1">Nationality Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Nationality" runat="server"></asp:TextBox>
                  </div>
              </div>
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="nationalityCountry">
                  <div class="form-group">
                      <label for="sel1">Country Name:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="Enter Country" runat="server"></asp:TextBox>
                  </div>
              </div>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h3 class="text-center">NATIONALITY DIRECTORY</h3>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var nationalityName = $("#TextBox2").val();
                if (nationalityName == "" || nationalityName == null) {
                    nationalityName = "";
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Nationality.aspx/insertNationality',
                    contentType:"application/json; charset=utf-8",
                    data: "{'nationalityName':'" + nationalityName + "','countryName':'" + countryName + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                $("#insertButton").click(function () {
                    $("#head").show();
                    $("#nationalityName").show();
                    $("#nationalityCountry").show();
                ...
                $("#view").click(function () {
                    $("#head").hide();
                    $("#nationalityName").hide();
                    $("#nationalityCountry").hide();
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var nationalityName = row.find("td:eq(1)").text();
                    var nationalityCountry = row.find("td:eq(2)").text();


                    $("#TextBox1").val(ID);
                    $("#TextBox2").val(nationalityName);
                    $("#TextBox3").val(nationalityCountry);
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Nationality.aspx/getAllNationality',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    var nationalityName = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + nationalityName + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Nationality.aspx/deleteNationality',
                            contentType: "application/json; charset=utf-8",
                            data: "{'ID':'" + ID + "','nationalityName':'" + nationalityName + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Nationality.aspx/updateNationality',
                        contentType: "application/json; charset=utf-8",
                        data: "{'ID':'" + ID + "','nationalityName':'" + nationalityName + "','countryName':'" + countryName + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Country.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Country.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
