                ...
                <div class="col-md-12">
                    ...
                    <div id="all" >
                        <div class="col-md-2" id="img">
                             <img src="../production/images/k1.png" class="img-square" alt="" width="120" height="160"/>
                        ...
                        <div class="input-group"  id="pass">
                            ...
                            <asp:TextBox ID="TextBox2" class="form-control" placeholder="Password" runat="server" TextMode="Password"></asp:TextBox>
                             ...
                             <div>
                                 ...
                                 <a class="btn btn-default" style="height:35px"  href="../../Contractsite/googlesign.aspx"><img border="0"  src="../../Contractsite/img/google2.jpg" width="32" height="24"></a>
                                 &nbsp
                                   <asp:Button ID="Button1"  class="btn btn-default"  style="width:150px" runat="server" Text="Log In" />
