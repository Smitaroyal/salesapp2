...
.has-search .form-control {
    ...
    .title{
      ...
      #success-alert,#danger-alert,#danger-alert1,#menu_toggle,#profileDetails{
          ...
          #update,#giftID,#head,#giftName,#giftstatus,#directory,#insert,#item,#Office{
              display:none;
          }
        #TextBox5{
          text-align:center;
      ...
      <div class="main_container">
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="giftID">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="giftName">
                  <div class="form-group">
                      <label for="sel1">Gift Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Gift Name" runat="server"></asp:TextBox>
                  </div>
              </div>

            
                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="item">
                  <div class="form-group">
                      <label for="sel1">Item Name:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="Enter Item Name" runat="server"></asp:TextBox>
                  </div>
              </div>
                ...
                <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="giftstatus">
                  <div class="form-group">
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                if(giftName=="" || giftName==null){
                    ...
                    giftName = $("#TextBox2").val();
                }
                //  var status = $("#status").val();

                var item = $("#TextBox3").val();
                if (item == "" || item == null) {
                    item = "";
                } else {
                    item = $("#TextBox3").val();
                ...
                $.ajax({
                    ...
                    data: "{'giftname':'" + giftName + "','item':'" + item + "','office':'" + office + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var item = row.find("td:eq(3)").text();
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'giftID':'" + giftID + "','giftName':'" + giftName + "','status':'" + status + "','item':'" + item + "','office':'" + office + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Gift_Option.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Gift_Option.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
