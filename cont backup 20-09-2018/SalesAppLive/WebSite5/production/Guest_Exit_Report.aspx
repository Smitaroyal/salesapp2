<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Guest_Exit_Report.aspx.cs" Inherits="WebSite5_production_Reports" %>
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h3 class="text-center">GUEST EXIT</h3>
          </div>
          </div>
                </div>
                       <br />
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Guest_Exit_Report.aspx/getAdminRights',
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Guest_Exit_Report.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Guest_Exit_Report.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
