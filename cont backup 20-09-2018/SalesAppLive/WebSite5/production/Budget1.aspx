                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    if (value1[0] == "2") {
                                        ...
                                        $("#task-table tbody").append("<tr><td style='display:none'><input type='hidden' style='width:80px' id='month" + current + "' value='" + value1[0] + "'></td><td>" + value1[1] + "</td><td><input type='text' style='width:65px' id='DAYS" + current + "'><td><input type='text' style='width:80px' id='QT" + current + "'></td> <td><input type='text' style='width:80px' id='Close" + current + "'></td> <td><input type='text' style='width:80px' id='sales" + current + "' readonly></td> <td><input type='text' style='width:80px' id='Avg" + current + "'></td> <td><input type='text' style='width:80px' id='Net" + current + "' readonly></td></tr>");
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $(document).on('focusout', '#average0', function () {
                    ...
                    var total11 = Math.round(sales1 * Avg1);
                    $("#netvolume0").val(total11);
