<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaliConsolidated.aspx.cs" Inherits="WebSite5_production_BaliConsolidated" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h5 class="text-center">SEAP. CONSOLIDATE RECAP COUNTRY</h5>
                            </div>
                        </div>
                    </div>
                    <br />
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js"></script> 
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'BaliConsolidated.aspx/getAdminRights',
     ...
     <script>
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function (event) {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'BaliConsolidated.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'BaliConsolidated.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
