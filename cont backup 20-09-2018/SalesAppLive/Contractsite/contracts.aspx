  ...
  background-color: #555;
   ...
   #cleft {
    ...
    display:none;
      ...
      #pcurr1MP,#pcurr2MP,#pcurr3MP,#pcurr4MP,#keke,#PrintPdfTextBox2
      {
        display:none;
      }
...
<input type="radio" name="p" id="cdown" onchange="valueChanged();"/>
 	<br/>
 	<label >Old Contract Number</label> &nbsp;<input type="text" name="input1" id="input1" />
 	<br/>
 	<br/>
 	<label >New Contract Number</label>&nbsp;<input type="text" name="input2" id="input2" />
 	<br/>
 	<br/>
 	<input type="button" name="create" id="create" value="create" onclick="sp();"  style="display: inline-block; align-items: right;" />
