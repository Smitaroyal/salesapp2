...
Array.Clear(er, 0, er.Length);
            ...
            else if (conttype == "Points")
            {
               ...
               string pclub= ds5.Tables[0].Rows[0]["CT_Points_Club"].ToString();
                ...
                TextPBalaceDPATOPD.Text = ds5.Tables[0].Rows[0]["PS_BalanceDue_TD"].ToString();
               ...
               // string baldatep = String.Format("{0:dd-MM-yyyy}", ds5.Tables[0].Rows[0]["PS_Deposit_Date"]);
                ...
                TextIniInstAmtP.Text = ds5.Tables[0].Rows[0]["PS_Ini_Bal_Install_Amt"].ToString();
                //tPurchase1 = tPurchase.Text;
                //QDepo1 = QDepo.Text;
                //AmtCre1 = AmtCre.Text;
                //CreCurr1 = CreCurr.Text;
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
            ...
            if (String.Compare(oDealDrawer, DealDrawer) != 0)
        {
            ...
            int statchange = Queries2.InsertStatusChange(scid, oDealDrawer, DealDrawer, SC_Cancel_Group_Venue, SC_Cancel_Reason, SC_Cancel_Date, user, Session["ProfileIDo"].ToString(), Session["fracido"].ToString(), DateTime.Now.ToString(),"");
        }
            else
        {
            if(oDealDrawer=="Cancel")
            {
                     ...
                     if (String.Compare(oCGroupvenueDropDownList, SC_Cancel_Group_Venue) != 0 || String.Compare(oCReasonDropDownList, SC_Cancel_Reason) != 0 || String.Compare(oCancelDateTextBox, SC_Cancel_Date) != 0)
                {
                    //SC_Cancel_Group_Venue,SC_Cancel_Reason,SC_Cancel_Date
                      ...
                      int updstatuschange = Queries2.Update_Status_change(SC_Cancel_Group_Venue, SC_Cancel_Reason, SC_Cancel_Date,DateTime.Now.ToString(), oDealDrawer, Session["fracido"].ToString());
                }
        ...
        else
        {
            ...
            if (String.Compare(oBalance_Pay_Method, PaymentMethod) != 0)
            {
                ...
                int finacheck = Queries2.checkforexistingfinancedetails(Session["fracido"].ToString());
                if (finacheck == 1)
                {
        ...
        if (conttype == "Fractional")
        {
            ...
            string BalanceDuePAFTD = TextBalanceDueFTD.Text;
            ...
            string IniBalNoInstallF = TextIniInstF.Text;
            string IniBalInstAmtF = TextIniInstAmtF.Text;
        ...
        else if(conttype=="Points")
        {
           ...
           // GlobContClub = ContClub;
            ...
            string BalanceDuePAPTOPD = TextPBalaceDPATOPD.Text;
            ...
            string IniBalInstAmtP = TextIniInstAmtP.Text;
        ...
        else if(conttype == "Trade Into Points")
        {
           ...
           // string ContNewClub = ContractClubTPDropDownList2.Text;
            ...
            string BalanceDuePATPTD = TextBalanceDuePATPTD.Text;
            ...
            string IniBalNoInstallTP = TextIniInstTP.Text;
            string IniBalInstAmtTP = TextIniInstAmtTP.Text;
            ...
            int contup = Queries2.UpdatePointPS(Deposit_PM, DepositP, DepoPPA, DepositSAP, AdmissFeesP, ApplicationFeesP, AdminFeesP, AdminServiceP, PurchasePriceP, TotalServicePriceP, CoutryTaxP, GrandTotalP, BalanceDuePAP, BalanceDueSAP, PANoOfInstallP, PAFirstPayDateP, PAAmountInstallP, PAFirstInstallP, BalanceDueDatesPAP, BalanceDueDatesSAP, RemarksP, TotalBalance, EuroRatesF, AusRatesF, GbpRatesF, IdaRatesF, YearOfInterestP, DateTime.Now.ToString(), Session["fracido"].ToString(), InitDepotp, BalDepotp, DepoDatetp, BalanceDueDatesPATP2, BalanceDueDatesSATP2, remarkTP2, CPATP,IniBalNoInstallTP,IniBalInstAmtTP,BalloonPay,LastInstDate,CPADepoTP, BalanceDuePATPTD);
            int contFina = Queries2.UpdateContFrac(affilice, affilhp, salesrep, tomanager, buttonup, FinaCurrency, PurchasePrice, AdminFees, MCFees, DealDrawer, PaymentMethod, FinanceNumb, ID_Card, CrownCurr, Session["fracido"].ToString(), Session["DealRegDate"].ToString(), ft1, ft2, DateTime.Now,cweekno,ContComment, PaymentMethodDeatils);
        ...
        else if (conttype == "Trade Into Fractional")
        {
            ...
            string BalanceDuePATFTD = TextBalanceDuePATFTD.Text;
            ...
            string IniBalNoInstallTF = TextIniInstTF.Text;
            string IniBalInstAmtTF = TextIniInstAmtTF.Text;
        ...
        DataSet ds21 = Queries2.LoadPrintFiles2(ContType1, Session["Gofficeo"].ToString(), Session["ECGGlobContClub"].ToString(), PaymentMethod2, affil2, CrownCurr);
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        DataTable datatable = Queries2.loadreport(Session["ECGetContnumb"].ToString(), printr, Session["Gofficeo"].ToString());
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int updateprofile = Queries2.UpdateProfile(profile, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs, "", "", "", comm1, reception, subvenue, Session["regTerms"].ToString(), VPID,Session["regTerms2"].ToString(), Secondemploymentstatus, leadsource,prearrival,verifi,promosource,teleagent);
            ...
            else
            {
                ...
                if (secondaryfname != "")
                {
                    if (secondary1 == 0)
                    {
                        ...
                        string secondaryprofileid = Queries.GetSecondaryProfileID(Session["Gofficeo"].ToString());
                        ...
                        int updates = Queries.UpdateSecondaryValue(Session["Gofficeo"].ToString(), year);
                    }
            ...
            if (sp1fname != "")
            {
                ...
                {
                    int year = DateTime.Now.Year;
                    string subprofile1id = Queries.GetSubProfile1ID(Session["Gofficeo"].ToString());
                    ...
                    int updatesp2 = Queries.UpdateSubprofile2Value(Session["Gofficeo"].ToString(), year);
                }
                else
                {
            ...
            if (sp2fname != "")
            {
                ...
                {
                    int year = DateTime.Now.Year;
                    string subprofile2id = Queries.GetSubProfile2ID(Session["Gofficeo"].ToString());
            ...
            if (sp3fname != "")
            {
                ...
                if (sp3fname != "")
                {
                    ...
                    {
                        int year = DateTime.Now.Year;
                        string subprofile3id = Queries.GetSubProfile3ID(Session["Gofficeo"].ToString());
                        ...
                        int updatesp3 = Queries2.UpdateSubprofile3Value(Session["Gofficeo"].ToString(), year);
                    }
                    else
                    {
            ...
            if (sp4fname != "")
            {
                ...
                if (sp4fname != "")
                {
                    ...
                    {
                        int year = DateTime.Now.Year;
                        string subprofile4id = Queries.GetSubProfile4ID(Session["Gofficeo"].ToString());
                        ...
                        int updatesp4 = Queries2.UpdateSubprofile4Value(Session["Gofficeo"].ToString(), year);
           ...
           string taxin1, taxiout1, taxin, taxiout;
            ...
            else
            {
                ...
                if (giftoptionDropDownList.SelectedItem.Text != "")
                {
                    ...
                    {
                        string giftid = Queries.GetProfileGift(Session["Gofficeo"].ToString());

                        int insert = Queries2.InsertGiftOption(giftid, gifto1, voucher1, chargeback, Session["ProfileIDo"].ToString(), "", giftprice1);
                        int update1 = Queries.UpdateGiftValue(Session["Gofficeo"].ToString(), DateTime.Now.Year);
                    }
                    else
                    {
                        int gift = Queries2.UpdateGiftValue(Session["ogiftoptionDropDownList"].ToString(), gifto1, voucher1, Session["ProfileIDo"].ToString(), chargeback, giftprice1);
                    }
                }
            }
            ...
            else
            {
                ...
                if (giftoptionDropDownList2.SelectedItem.Text != "")
                {
                    if (Session["ogiftoptionDropDownList2"].ToString() == "" || Session["ogiftoptionDropDownList2"].ToString() == null)
                    {
                        ...
                        int insert = Queries2.InsertGiftOption(giftid, gifto2, voucher2, "", Session["ProfileIDo"].ToString(), "", giftprice2);
                        int update1 = Queries.UpdateGiftValue(Session["Gofficeo"].ToString(), DateTime.Now.Year);
                    }
                    else
                    {
                        int gift = Queries2.UpdateGiftValue(Session["ogiftoptionDropDownList2"].ToString(), gifto2, voucher2, Session["ProfileIDo"].ToString(), "", giftprice2);
                    }
                }
            }
            ...
            else
            {
                if (giftoptionDropDownList3.SelectedItem.Text != "")
                {
                    if (Session["ogiftoptionDropDownList3"].ToString() == "" || Session["ogiftoptionDropDownList3"].ToString() == null)
                    {
                        ...
                        int insert = Queries2.InsertGiftOption(giftid, gifto3, voucher3, "", Session["ProfileIDo"].ToString(), "", giftprice3);
                        int update1 = Queries.UpdateGiftValue(Session["Gofficeo"].ToString(), DateTime.Now.Year);
                    }
                    else
                    {

                        int gift = Queries2.UpdateGiftValue(Session["ogiftoptionDropDownList3"].ToString(), gifto3, voucher3, Session["ProfileIDo"].ToString(), "", giftprice3);
                    }
                }
            }
            ...
            else
            {
                if (giftoptionDropDownList4.SelectedItem.Text != "")
                {
                    if (Session["ogiftoptionDropDownList4"].ToString() == "" || Session["ogiftoptionDropDownList4"].ToString() == null)
                    {
                        ...
                        int insert = Queries2.InsertGiftOption(giftid, gifto4, voucher4, "", Session["ProfileIDo"].ToString(), "", giftprice4);
                        int update1 = Queries.UpdateGiftValue(Session["Gofficeo"].ToString(), DateTime.Now.Year);
                    }
                    else
                    {

                        int gift = Queries2.UpdateGiftValue(Session["ogiftoptionDropDownList4"].ToString(), gifto4, voucher4, Session["ProfileIDo"].ToString(), "", giftprice4);
                    }
                }
            }
            ...
            else
            {
                ...
                if (giftoptionDropDownList5.SelectedItem.Text != "")
                {
                    if (Session["ogiftoptionDropDownList5"].ToString() == "" || Session["ogiftoptionDropDownList5"].ToString() == null)
                    {
                        ...
                        int insert = Queries2.InsertGiftOption(giftid, gifto5, voucher5, "", Session["ProfileIDo"].ToString(), "", giftprice5);
                        int update1 = Queries.UpdateGiftValue(Session["Gofficeo"].ToString(), DateTime.Now.Year);
                    }
                    else
                    {

                        int gift = Queries2.UpdateGiftValue(Session["ogiftoptionDropDownList5"].ToString(), gifto5, voucher5, Session["ProfileIDo"].ToString(), "", giftprice5);
                    }
                }
            }
            ...
            else
            {
                ...
                if (giftoptionDropDownList6.SelectedItem.Text != "")
                {
                    if (Session["ogiftoptionDropDownList6"].ToString() == "" || Session["ogiftoptionDropDownList6"].ToString() == null)
                    {
                        ...
                        int insert = Queries2.InsertGiftOption(giftid, gifto6, voucher6, "", Session["ProfileIDo"].ToString(), "", giftprice6);
                        int update1 = Queries.UpdateGiftValue(Session["Gofficeo"].ToString(), DateTime.Now.Year);
                    }
                    else
                    {

                        int gift = Queries2.UpdateGiftValue(Session["ogiftoptionDropDownList6"].ToString(), gifto6, voucher6, Session["ProfileIDo"].ToString(), "", giftprice6);
                    }
                }
            }
            ...
            else
            {
                ...
                if (giftoptionDropDownList7.SelectedItem.Text != "")
                {
                    if (Session["ogiftoptionDropDownList7"].ToString() == "" || Session["ogiftoptionDropDownList7"].ToString() == null)
                    {
                        ...
                        int insert = Queries2.InsertGiftOption(giftid, gifto7, voucher7, "", Session["ProfileIDo"].ToString(), "", giftprice7);
                        int update1 = Queries.UpdateGiftValue(Session["Gofficeo"].ToString(), DateTime.Now.Year);
                    }
                    else
                    {

                        int gift = Queries2.UpdateGiftValue(Session["ogiftoptionDropDownList7"].ToString(), gifto7, voucher7, Session["ProfileIDo"].ToString(), "", giftprice7);
                    }
                }
            }
