       ...
       <script type="text/javascript">
		...
		document.getElementById("TextCountryTaxTP").value = Math.round((parseInt(PurchaseP) / 2.1) * 0.1);
           ...
           function initinstall() {
               ...
               var idate, iiamt, inoi, ibalamt, fiiamt;
    ...
    if (dropval == "Points") {
       ...
       // alert(dealstat);
        if (dealstat == "Top Drawer") {
            ...
            if (paym == "Crown Finance") {
             //   alert('under deal stat crown finance');
             //   alert(text13 + '\n' + text14);
                document.getElementById('TextBalanceDueDatesPATP').value = text13;
                document.getElementById('TextBalanceDueDatesSATP').value = text14;
               ...
               // alert(reSASA(glob, 'CF'));

            }
            else {
               // alert('into into kanta');
                document.getElementById('TextBalanceDueDatesPATP').value = text13;
                document.getElementById('TextBalanceDueDatesSATP').value = text14;
           ...
           // alert(document.getElementById('TextBalanceDueDatesPATP2').value);    
           // alert(document.getElementById('TextBalanceDueDatesSATP2').value);
            }
            ...
            <tr>
              ...
              <div class="points_col" style="margin:10px 0px;padding-top:10px;">
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                        <td width="210px"><asp:Label ID="Label81TD" runat="server" Text="Label">Balance Due PA(Top Drawer)</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextPBalaceDPATOPD" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                    </tr>
                    </table>
                       <table  cellpadding="5px" cellspacing="5px">
                    <tr>
              ...
              <div id="myModal2" class="modal2">
                  <div class="modal-content2">
                      ...
                      <p>Change Installment Amount</p>
                        <br />
                        <br />
                        <asp:Label ID="Label61" runat="server" Text="Label">Initial Deposit</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label82" runat="server" Text="Label">No Of Instalment</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp
