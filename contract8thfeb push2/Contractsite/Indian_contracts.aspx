...
<meta charset="utf-8">
  ...
  <script>
      ...
      $(function () {
          $("#primarydobdatepicker,#secondarydobdatepicker,#sp1dobdatepicker,#sp2dobdatepicker,#sp3dobdatepicker,#sp4dobdatepicker,#arrivaldatedatepicker,#departuredatedatepicker,#tourdatedatepicker ,#baladepamtdateTextBox").datepicker({
              changeMonth: true,
              changeYear: true,
              yearRange: "-100:+0",
              dateFormat: 'yy-mm-dd'
...
<script type="text/javascript">
            ...
            if (percent < 10) {
             ...
             //   document.getElementById("fractionalbalanceTextBox").value = totalbalpayable;
                ...
                if (ocontract_type == "Weeks") {
                    ...
                    // alert("old:" + oldloanamt);
                    //  var balaftertotal = parseInt(bal) + parseInt(oldloanamt);
                    var totalbalpayable = (parseInt(totalpurchase) - parseInt(depositamt)) + parseInt(oldloanamt);
                    // alert("baL:" + totalbalpayable);
                    // document.getElementById("fractionalbalanceTextBox").value = balaftertotal;
                    document.getElementById("fractionalbalanceTextBox").value = totalbalpayable;
                }
    ...
    function PointsPurchase1() {
        ...
        else
        {
            if (currency == "INR") {
                ...
                //var currentfee = "30000";
                //document.getElementById("adminamtfeesTextBox").value = currentfee;
    ...
    function re(noofInstall, remark) {
        // alert('hi');
           ...
           <div id="contract-container">
            ...
            <tr>
                ...
                <td width="100px"><asp:TextBox ID="regcollamtTextBox"   Font-Size="Small" style="width:200px; height:20px" runat="server"></asp:TextBox></td>
                  ...
                  <tr>
                <td width="100px"><asp:Label ID="lbladminamtfees" runat="server" Font-Size="Small"  Width="100px" Text="Label">ADMIN FEE</asp:Label></td>
       ...
       <div id="tabs-4" style="background-color:#e9e9e9;">
          <div id="finance-container1" style="margin-top:10px;padding-top:10px; ">
            ...
            <asp:Button ID="CreateButton" runat="server" Text="Create Contract" OnClick="CreateButton_Click"></asp:Button> <!--OnClick="CreateButton_Click " -->
             <asp:Button ID="btnfinance" runat="server" OnClick="btnfinance_Click" Text="Button" />
   </div>
