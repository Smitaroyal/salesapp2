        ...
        else
        {
            ...
            else if (SORDropDownList.SelectedItem.Text == "SOR Name")
            {
                for (ik = 1; ik <= Convert.ToInt32(num); ik++)
                {
                    ...
                    int insertrow = Queries.InsertContractNo_Othernames(id, contractnoTextBox.Text, ContractdetailsIDTextBox.Text, SORDropDownList.SelectedItem.Text, name, add, state, country, pincode, "Active", "", DateTime.Now.ToString());
                     string log5in = "SOR Details:" + "ContractdetailsID: " + ContractdetailsIDTextBox.Text + "," + "Contractno: " + contractnoTextBox.Text + "," + "Type:" + SORDropDownList.SelectedItem.Text + "," + "Name:" + iname + "," + "address:" + iadd + "," + "state:" + istate+"," + "country:" + icountry + "," + "postcode:" + ipincode;
                     int insertlogin = Queries.InsertContractLogs_India(profileidTextBox.Text , contractdetailsID, log5in, user, DateTime.Now.ToString());
            ...
            else if (SORDropDownList.SelectedItem.Text == "Additional Name")
            {
                for (ik = 1; ik <= Convert.ToInt32(num); ik++)
                {
                    ...
                    int insertrow = Queries.InsertContractNo_Othernames(id, contractnoTextBox.Text, ContractdetailsIDTextBox.Text, SORDropDownList.SelectedItem.Text, name, add, state, country, pincode, "Active", "", DateTime.Now.ToString());
                    string log5in = "Additional Name Details:" + "ContractdetailsID: " + ContractdetailsIDTextBox.Text + "," + "Contractno: " + contractnoTextBox.Text + "," + "Type:" + SORDropDownList.SelectedItem.Text + "," + "Name:" + iname + "," + "address:" + iadd + "," + "state:" + istate + "," + "country:" + icountry + "," + "postcode:" + ipincode;
                    int insertlogin = Queries.InsertContractLogs_India(profileidTextBox.Text, contractdetailsID, log5in, user, DateTime.Now.ToString());
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
         ...
         /* DataSet dsc = Queries.LoadPointsClub(office,Queries.GetVenueCode(VenueDropDownList.SelectedItem.Text,Queries.GetVenueCountryCode(VenueCountryDropDownList.SelectedItem.Text)));
            ...
            if (PrimarynationalityDropDownList.SelectedItem.Text== "INDIAN"|| PrimarynationalityDropDownList.SelectedItem.Text == "Indian")
            {
                //load alt or full
        ...
        else
        {
            ...
            if (mcRadioButtonList.Checked == true)
                ...
                if (mcwaiver=="Yes")
                {
                    ...
                    DataSet ds21 = Queries.LoadPrintPDFFiles_IndianMC(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, resortDropDownList.SelectedItem.Text, currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
                ...
                {
                    PrintPdfDropDownList.Items.Clear();
                    DataSet ds21 = Queries.LoadPrintPDFFiles_IndianNOMC(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, resortDropDownList.SelectedItem.Text, currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
                    PrintPdfDropDownList.DataSource = ds21;
                    PrintPdfDropDownList.DataTextField = "printname";
                    PrintPdfDropDownList.DataValueField = "printname";
                    PrintPdfDropDownList.AppendDataBoundItems = true;
              ...
              //  DataSet dsmc = Queries.LoadMCChart(pointsclubDropDownList.SelectedItem.Text, firstyrTextBox.Text, currencyDropDownList.SelectedItem.Text);
                ...
                else if (contracttype == "Trade-In-Fractionals")
                {
                    ...
                    {
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_IndianMC(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, Request.Form[fwresortDropDownList.UniqueID], currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
                    ...
                    {
                        PrintPdfDropDownList.Items.Clear();
                        DataSet ds21 = Queries.LoadPrintPDFFiles_IndianNOMC(contracttypeDropDownList.SelectedItem.Text, officeTextBox.Text, Request.Form[fwresortDropDownList.UniqueID], currencyDropDownList.SelectedItem.Text, financeradiobuttonlist.SelectedItem.Text, Affiliate_Type, mcwaiver);
                        PrintPdfDropDownList.DataSource = ds21;
                        PrintPdfDropDownList.DataTextField = "printname";
                        PrintPdfDropDownList.DataValueField = "printname";
                        PrintPdfDropDownList.AppendDataBoundItems = true;
...
public static string LoadClubNameonContractType(string contracttype)
{
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = Queries.LoadContractDetails_ID(ContractdetailsIDTextBox.Text);
        ...
        else
        {
            ...
            else if (SORDropDownList.SelectedItem.Text == "SOR Name")
            {
                for (ik = 1; ik <= Convert.ToInt32(num); ik++)
                {
                    ...
                    iadd = "textBox_" + ik + "2";
                    add = Request.Form[iadd];
                    istate = "textBox_" + ik + "3";
                    state = Request.Form[istate];
                    icountry = "textBox_" + ik + "4";
                    country = Request.Form[icountry];
                    ipincode = "textBox_" + ik + "5";
                    pincode = Request.Form[ipincode];
    ...
    {
        int emi = Convert.ToInt32(noemiTextBox.Text);
        double principalamt = Convert.ToDouble(balamtpayableTextBox.Text);
        double emiamt =Convert.ToDouble(emiamtTextBox.Text);
        int months = 12;
        int i;
        string month;

        if (contracttypeDropDownList.SelectedItem.Text == "Fractional" || contracttypeDropDownList.SelectedItem.Text =="Trade - In - Fractionals")
        {
        ...
        else
        {
            ...
            for(i=1; i<=emi;i++)
            {
                ...
                //if contractdetails id doesnt exists then
                int exists = Queries.CheckIDExistsInFinance_Breakup(ContractdetailsIDTextBox.Text);
                if(exists==1)
                {
                    //get min principalamt
                    double pa = Convert.ToDouble(Queries.GetMinPrinicipalAmt(ContractdetailsIDTextBox.Text));
                    double Yearly_interest = Math.Round((pa * interest) / 100);
                    double Monthly_Instalment = emiamt;
                    double Installments = i;
                    double Monthly_Interest = Math.Round(Yearly_interest / months);
                    double Monthly_Principal = Math.Round(Monthly_Instalment - Monthly_Interest);

                    month = Queries. FinanceInstallmentMonthStartdate(ContractdetailsIDTextBox.Text);
                   // int insert = Queries.InsertFinance_Breakup(ContractdetailsIDTextBox.Text, contractnoTextBox.Text, pa.ToString(), Yearly_interest.ToString(), Monthly_Principal.ToString(), Monthly_Interest.ToString(), Monthly_Instalment.ToString(), Installments.ToString(), month);
                }
                else
                {
                    double Yearly_interest = Math.Round((principalamt * interest) / 100);
                    ...
                    double Monthly_Principal = Math.Round(Monthly_Instalment - Monthly_Interest);
                    //get max month from installment table
                    month = Queries.FinanceInstallmentMonthStartdateNew(ContractdetailsIDTextBox.Text);
                  //  int insert = Queries.InsertFinance_Breakup(ContractdetailsIDTextBox.Text, contractnoTextBox.Text, principalamt.ToString(), Yearly_interest.ToString(), Monthly_Principal.ToString(), Monthly_Interest.ToString(), Monthly_Instalment.ToString(), Installments.ToString(), month);
