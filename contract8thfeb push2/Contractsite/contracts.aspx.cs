...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string script = "<script> $(function() { $('#tabs').tabs({ disabled: [] }); $( '#tabs' ).tabs({ active: 4 }); }); document.getElementById('myBtnNext').style.display = 'none';</script> ";
            //  this.Page.ClientScript.RegisterStartupScript(typeof(Page), "alert", script);
            ScriptManager.RegisterStartupScript(this, typeof(Page), "alert", script, false);
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                weekno = Queries2.GetWkNumber(Convert.ToDateTime(ttourdate));
            }
            //if (tourdate == "")
            //{
            //    ttourdate = "1900-01-01";
            ...
            if (giftoptionDropDownList.SelectedItem.Text != "")
            {
                if (ogiftoptionDropDownList == "" || ogiftoptionDropDownList == null)
                {
                    ...
                    int insert = Queries.InsertGiftOption(giftid, gifto1, voucher1, chargeback, ProfileIDo, "");
                    int update1 = Queries.UpdateGiftValue(officeo, DateTime.Now.Year);
                }
                else
                {
                    int gift = Queries2.UpdateGiftValue(ogiftoptionDropDownList, gifto1, voucher1, ProfileIDo, chargeback);
                }
            }
            if (giftoptionDropDownList2.SelectedItem.Text != "")
            {
                if (ogiftoptionDropDownList2 == "" || ogiftoptionDropDownList2 == null)
                {
                    ...
                    int insert = Queries.InsertGiftOption(giftid, gifto2, voucher2, "", ProfileIDo, "");
                    int update1 = Queries.UpdateGiftValue(officeo, DateTime.Now.Year);
                }
                else
                {
            ...
            if (giftoptionDropDownList3.SelectedItem.Text != "")
            {
                if (ogiftoptionDropDownList3 == "" || ogiftoptionDropDownList3 == null)
                {
                    ...
                    int insert = Queries.InsertGiftOption(giftid, gifto3, voucher3, "", ProfileIDo, "");
                    int update1 = Queries.UpdateGiftValue(officeo, DateTime.Now.Year);
                }
                else
                {
