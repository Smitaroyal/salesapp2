...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  $(function () {
      $("#datepicker1,#datepicker2,#datepicker3,#datepicker4,#datepicker9,#datepicker12").datepicker({
          changeMonth: true,
          changeYear: true,
          yearRange: "1950:2050",
          dateFormat: 'yy-mm-dd'
...
function gendetails()
{
    ...
    if (drop == "Fractional")
    {
        ...
        var pp = document.getElementById("AmountCreditTextBoxFFC").value;
    ...
    else if (drop == "Points")
    {
        ...
        var pp = document.getElementById("AmountCreditTextBoxPFC").value;
    ...
    else if (drop == "Trade Into Points")
    {
        ...
        var pp = document.getElementById("AmountCreditTextBoxTPFC").value;
    ...
    else if (drop == "Trade Into Fractional")
    {
        ...
        var pp = document.getElementById("AmountCreditTextBoxTFFC").value;
  ...
  background-color: #555;
   ...
   #cleft {
     ...
     #ffractional1,#tfractional,#tpoints,#TextFDepo2,#TextFBala2,#TextFDepo1,#TextFBala1,#TextFFina1,#TextFFina2,#TextBox96,#TextICE,#TextHP,#texttest,#texte,#remarkP,#Button3,#PointsAdd,#TPAdd,#remarkTP,#hiddentconttype,#hiddentconttype2{
      ...
      #tPurchase,#QDepo,#AmtCre,#CreCurr,#NoOfMonth,#RateOfInt,#MonthlyRepay,#Textcheckchs4,#Button9,#Button13,#Button7,#Button12,#Button10,#tButton1,#Button11,#Button14
      {
    display:none;
      }
