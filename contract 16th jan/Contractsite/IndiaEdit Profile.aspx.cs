    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
      ...
      if (String.Compare(oSub_Profile2_DOB, sp2dob) != 0)
       ...
       if (String.Compare(oSubprofile2_Alternate, sp2alternate) != 0)
        ...
        //update profile
        int updateprofile = Queries.UpdateProfile(profile, venuecountry, venue, venuegroup,  mktg,  agents,  agentcode, membertype1, memno1,  membertype2, memno2,  employmentstatus, maritalstatus, livingyrs,mgr,photoidentity,card,ProfileComments,"","",regTerms);
