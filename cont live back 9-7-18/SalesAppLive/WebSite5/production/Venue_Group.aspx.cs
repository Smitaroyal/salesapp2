...
public partial class WebSite5_production_Venue_Group : System.Web.UI.Page
{
    ...
    static string Venue_Group_Name1;
    static string Venue_Group_Status1;
    static string Venue_ID1;
    static string Venue_group_Code1;
    ...
    public static void insertVenueGroup(string venueGroupName, string venue,string venueGroupCode)
    {
      ...
      cmd1.ExecuteNonQuery();
        ...
        string details = "Venue Group Created : Venue_Group_Name: " + venueGroupName + ", venue: " + venue+ ",Venue_Group_Code: "+ venueGroupCode;
    ...
    public static void updateVenueGroup(string venueGroupID, string venueGroupName,string venueGroupCode, string status, string venueID)
    {
        ...
        while (reader.Read())
        {
            Venue_Group_Name1 = reader.GetString(0);
            Venue_Group_Status1 = reader.GetString(1);

            Venue_ID1 = reader.GetString(2);
            Venue_group_Code1 = reader.GetString(3);
        }

        if (Venue_Group_Name1.Equals(venueGroupName))
        { }
        else
        {
            string pageName = "Venue Group";
            string details = "Venue Group Name changed from: " + Venue_Group_Name1 + "To: " + venueGroupName;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }


        if (Venue_Group_Status1.Equals(status))
        { }
        else
        {
            string pageName = "Venue Group";
            string details = "Status changed from: " + Venue_Group_Status1 + "To: " + status;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }

        if (Venue_group_Code1.Equals(venueGroupCode))
        { }
        else
        {
            string pageName = "Venue Group";
            string details = "Venue Group Code  changed from: " + Venue_group_Code1 + "To: " + venueGroupCode;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }
        ...
        {
            string pageName = "Venue Group";
            string details = "Venue changed from: " + Venue_ID1 + "To: " + venueID;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }
