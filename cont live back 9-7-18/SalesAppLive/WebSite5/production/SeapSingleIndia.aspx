<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SeapSingleIndia.aspx.cs" Inherits="WebSite5_production_SeapSingleIndia" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h5 class="text-center">SEAP SINGLE INDIA</h5>
                            </div>
                        </div>
                    </div>
                    <br />
            ...
            $("#country").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapSingleIndia.aspx/getVenue',
            ...
            $("#venue").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapSingleIndia.aspx/getVenueGroup',
                    contentType: "application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "'}",
                    async: false,
                    success: function (data) {
