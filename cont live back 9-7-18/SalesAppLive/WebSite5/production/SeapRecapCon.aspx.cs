...
public partial class WebSite5_production_SeapRecapCon : System.Web.UI.Page
{
    ...
    private void show_report(string country,string venueGroup)
    {
        ReportViewer2.Reset();


        DataTable dt = Queries2.SeapCold(TextBox4.Text, country, TextBox1.Text, venueGroup);
        ...
        ReportViewer2.LocalReport.ReportPath = "reports/SeapCold.rdlc";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       // string subVenue= Request.Form["subVenue"];
        ...
        show_report(country, venueGroup);
