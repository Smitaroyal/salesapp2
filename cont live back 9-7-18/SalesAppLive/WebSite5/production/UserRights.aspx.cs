...
public partial class WebSite5_production_UserRights : System.Web.UI.Page
{
    ...
    public string getAllPageUrl()
    {
        ...
        while (reader.Read())
        {
            ...
            htmlstr += "<option value='" + pageurl + "'>" + pageName + "</option>";
        }
    ...
    public string getAllPageName()
    {
        ...
        String conn = ConfigurationManager.ConnectionStrings["DBConnectionString"].ConnectionString;
        SqlConnection sqlcon = new SqlConnection(conn);
        string query = "select PageName from PageUrl where Office='" + office1 + "'";
        sqlcon.Open();
        SqlCommand cmd = new SqlCommand(query, sqlcon);
        SqlDataReader reader = cmd.ExecuteReader();
        ...
        while (reader.Read())
        {
            ...
            htmlstr += "<option value='" + pageName + "'>" + pageName + "</option>";
        }
