...
public partial class Contractsite_ContractView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (conttype == "Points")
            {
                globContClub = ds4.Tables[0].Rows[0]["CT_Points_Club"].ToString(); 
            }
            else if (conttype == "Trade into Points")
            {
                globContClub = ds4.Tables[0].Rows[0]["TP_New_CLub"].ToString();
            }
           ...
           // string ContType1 = DropDownList40.SelectedItem.Text;
            DataSet ds21 = Queries2.LoadPrintFiles(conttype, office,globContClub);
