...
public class Queries2
{
   ...
   /* public static DataSet LoadProfileOnCreation(string profileid)
    ...
    public static SqlDataReader getgiftoption(string ProfileID)
    {
        ...
        SqlCommand SqlCmd = new SqlCommand("select Gift_ID_Option,Gift_Voucher_numb,Gift_Comment from Gift where Profile_ID=@ProfileID", cs1);
        SqlCmd.Parameters.Add("@ProfileID", SqlDbType.VarChar).Value = ProfileID;
    ...
    public static int UpdateGiftValue(string OGiftOption, string GiftOption, string Voucher, string ProfileID, string comment)
    {
        int rows = 0;
       // int id = 0;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand sqlcmd = new SqlCommand("update gift set Gift_ID_Option = @GiftOption,Gift_Voucher_numb = @Voucher,Gift_Comment=@comment where Profile_ID = @ProfileID and Gift_ID = @giftid", cs1);
