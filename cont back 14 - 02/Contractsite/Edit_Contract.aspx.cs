...
public partial class Contractsite_Edit_Contract : System.Web.UI.Page
{
    ...
    static string ovouchernoTextBox, ovouchernoTextBox2, ovouchernoTextBox3, regTerms;


    static string text11,desc,text12,amot1,text13,date,text14,curr, GenContNumbglob, DealRegDate;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
           ...
           // contsalesrepDropDownList.Items.Add(ds5.Tables[0].Rows[0]["Contract_Finance_Sales_Rep"].ToString());
            ...
            contsalesrepDropDownList.Items.Insert(0, new ListItem(ds5.Tables[0].Rows[0]["Tour_Details_Guest_Sales_Rep"].ToString(), ""));
