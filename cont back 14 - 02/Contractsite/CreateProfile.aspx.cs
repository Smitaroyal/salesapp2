...
public partial class _Default : System.Web.UI.Page
{
            ...
            if (VenueCountryDropDownList.SelectedIndex == 0 || VenueDropDownList.SelectedIndex == 0)
                ...
                if (sp2fname != "")
                {
                    ...
                    if (giftoptionDropDownList.SelectedIndex != 0)
                    {
                        ...
                        int insert = Queries.InsertGiftOption(giftid, giftoptionDropDownList.SelectedItem.Text, vouchernoTextBox.Text, chargeback, PID, "");
                    ...
                    if (giftoptionDropDownList2.SelectedIndex != 0)
                    {
                        ...
                        int insert = Queries.InsertGiftOption(giftid, giftoptionDropDownList2.SelectedItem.Text, vouchernoTextBox2.Text, "", PID, "");
                        int update1 = Queries.UpdateGiftValue(office, DateTime.Now.Year);
                    }
                    ...
                    if (giftoptionDropDownList3.SelectedIndex != 0)
                    {
                        ...
                        int insert = Queries.InsertGiftOption(giftid, giftoptionDropDownList3.SelectedItem.Text, vouchernoTextBox3.Text, "", PID, "");
                        int update1 = Queries.UpdateGiftValue(office, DateTime.Now.Year);
                    }
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string salesrep = salesrepDropDownList.SelectedItem.Text;//Request.Form[salesrepDropDownList.UniqueID];
            string timeIn = deckcheckintimeTextBox.Text;
            string timeOut = deckcheckouttimeTextBox.Text;
            string tourdate = tourdatedatepicker.Text;
            string ttourdate;
