...
//                      $(".hide").switchClass('hide',

//                 'show');
//                  } else {
//                      $(".show").switchClass("show",
//                 "hide");
//                  }
//              }
//          });
       ...
       <script>
           ...
           $(document).ready(function () {
               $("#DealDrawerDropDownList").change(function () {
                   ...
                   var ugdg = document.getElementById("TextBoxUPDW").value;
                  ...
                  // alert(ugdg);
                   ...
                   if (ugdg == 'UPDW')
                   {
                      // alert('in');
                       ...
                       if (dealstat == 'Deal' || dealstat == 'Top Drawer') {
                           ...
                           document.getElementById("TextContractNumb").value = document.getElementById("TextBoxUPDWNumber").value = document.getElementById("input2").value;
                           document.getElementById("TextBoxUPDWNewContNumb").value = document.getElementById("input1").value;
                           
                           if (conttype == 'Points') {

                               document.getElementById("ContractNoPointsTextBox").value = document.getElementById("input2").value;
                           }
                           else if (conttype == 'Fractional') {

                               document.getElementById("ContractNoFractTextBox").value = document.getElementById("input2").value;
                           }
                           else if (conttype == 'Trade Into Points') {

                               document.getElementById("ContractNoTPTextBox").value = document.getElementById("input2").value;
                               document.getElementById("TextOldAgreeNoTP1").value = document.getElementById("input1").value;
                               document.getElementById("TextOldAgreeNoTP2").value = document.getElementById("input1").value;
                               

                           }
                           else if (conttype == 'Trade Into Fractional') {
                               
                               document.getElementById("ContractNoTFTextBox").value = document.getElementById("input2").value;
                               document.getElementById("TextOldAgreeNoTF3").value = document.getElementById("input1").value;
                               document.getElementById("TextOldAgreeNoTF1").value = document.getElementById("input1").value;
                               document.getElementById("TextOldAgreeNoTF2").value = document.getElementById("input1").value;
                           ...
                           if (dealstat == 'Top Drawer') {
                               if (conttype == 'Points') {
                                   ...
                                   document.getElementById("pbalaTD").style.display = 'block';
                               }
                               else if (conttype == 'Fractional') {
                   ...
                   else
                   {
                       ...
                       if (dealstat == 'Deal' || dealstat == 'Top Drawer'){
                           ...
                           var v6 = document.getElementById("MarketingPrgmDropDownList");
                           var markp = v6.options[v6.selectedIndex].text;
                         ...
                         //  alert('kkk');
                           $.ajax({
                               ...
                               data: "{'name': '" + ven + "','venue': '" + venue + "','club': '" + club + "','mark': '" + mark + "','conttype': '" + conttype + "','markp': '" + markp + "'}",
                               dataType: "json",
                               //called on jquery ajax call success
                               success: function (data) {
                                   // alert(data.d);
           ...
           $(document).ready(function () {
               ...
               $("#LanguageDropDown").change(function () {
                   ...
                   $.ajax({
                       ...
                       contentType: "application/json; charset=utf-8",
                       //url is the path of our web method (Page name/function name)
                       url: "contracts.aspx/PrintPdfTypeDropDownList",
                       data: "{'Lang': '" + id2 + "'}",
                       dataType: "json",
                       //called on jquery ajax call success
                       success: function (data) {
           ...
           function pele(kk) {
               ...
               $(function () {
                  ...
                  // window.location.reload();
                   $('#tabs').tabs({ disabled: [2, 3, 4] }); $('#tabs').tabs({ active: 1 });
               });
               return false;
           }
          ...
          /* function othercurrency()
           ...
           function adminfee()
           {
               ...
               if (conttype == "Points")
               {
                  ...
                  // var res;
                   ...
                   if (id == "Top Drawer") {
                       ...
                       document.getElementById("TextBalanceDueFTD").value = parseInt(document.getElementById("TextTotalPurchasePriceF").value) - parseInt(document.getElementById("TextInitDepoF").value);
              ...
              else if (conttype == "Trade Into Points")
              {
                 ...
                 // document.getElementById("TextAppliFeesTP").value = result;
                  ...
                  if (id == "Top Drawer") {
                      // res = Math.round(parseInt(document.getElementById("TextGrandTotalTP").value) - parseInt(document.getElementById("TextInitDepoTP").value));
                     
                      res2 = Math.round(parseInt(document.getElementById("TextGrandTotalTP").value) - parseInt(document.getElementById("TextInitDepoTP").value));
                      
                  }
                  else {
                      //res = Math.round(parseInt(document.getElementById("TextGrandTotalTP").value) - parseInt(document.getElementById("TextDepositPATP").value));
                      res2 = '0';
                  }
                  res = Math.round(parseInt(document.getElementById("TextGrandTotalTP").value) - parseInt(document.getElementById("TextDepositPATP").value));
                  ...
                  if (res < 0) {
                      ...
                      document.getElementById("TextBalanceDuePATPTD").value = 0;
                      
                  }
                  else {
                      document.getElementById("TextBalanceDuePATP").value = res;
                      document.getElementById("TextBalanceDuePATPTD").value = res2;
                  }
                  ...
                  document.getElementById("TextCountryTaxTF").value = '0';
                  ...
                  if (id == "Top Drawer") {
                      ...
                      //document.getElementById("TextBalanceDuePATF").value = parseInt(document.getElementById("TextPurchasePriceTF").value) - parseInt(document.getElementById("TextInitDepoTF").value);
                      ...
                      document.getElementById("TextBalanceDuePATFTD").value = parseInt(document.getElementById("TextPurchasePriceTF").value) - parseInt(document.getElementById("TextInitDepoTF").value);
                      
                  }
                  else
                  {
                      document.getElementById("TextBalanceDuePATF").value = parseInt(document.getElementById("TextPurchasePriceTF").value) - parseInt(document.getElementById("TextDepositTF").value);
                      document.getElementById("TextBalanceDuePATFTD").value = '0';
                  }
           ...
           function initinstall()
           {
               ...
               if (conttypeinit == "Points")
               {
                   ...
                   document.getElementById("TextIniInstAmtP").value = Math.floor(parseInt(document.getElementById("TextBalDepo").value) / parseInt(document.getElementById("TextIniInstP").value));
                   iiamt = document.getElementById("TextIniInstAmtP").value;
                   fiiamt = parseInt(document.getElementById("TextBalDepo").value) - (parseInt(document.getElementById("TextIniInstAmtP").value) * (parseInt(document.getElementById("TextIniInstP").value) - 1));
    ...
    function CCpurpose(checkID, TextID) {
       ...
       // alert(dt2 + " " + mon2 + " " + yr2);
        ...
        if (checkbox2.checked) {
            ...
            if(checkID == 'FDepo1')
            {
                if(document.getElementById("DealDrawerDropDownList").value == 'Deal')
                {
                    if(document.getElementById("DropDownList40").value=='Points')
                    {
                    ...
                    else if(document.getElementById("DropDownList40").value=='Fractional')
                    {
                    ...
                    else if (document.getElementById("DropDownList40").value == 'Trade Into Points')
                    {
                    ...
                    else if (document.getElementById("DropDownList40").value == 'Trade Into Fractional')
                    {
                ...
                else if (document.getElementById("DealDrawerDropDownList").value == 'Top Drawer')
                {
                    if (document.getElementById("DropDownList40").value == 'Points')
                    {
...
function sum2(numi, bamt) {
    ...
    for (pe = 1; pe <= numi; pe++) {
        sum = sum + parseInt(document.getElementById("textBoxm_" + pe + "2").value);
        //t23 += parseInt(document.getElementById("textBox_"+pe+"2").value);
    }
    // alert(sum);
       ...
       // if (payn == "Points") {
        ...
        if (payn == "Points") {
           ...
           // alert('text13');
            ...
            // var p = "Balance Deposit USD " +document.getElementById("textBox_14").value + " on " + document.getElementById("TextBoxNBDP").value + "; ";//+ text13;
            document.getElementById('TextCPADepoComment').value = nnnn + ' ' + document.getElementById('TextInitDepo').value + ' on ' + pap + ';';
            // alert(p + " " + text13);
        }
           ...
           // texttp13 += reT(glob2);
            ...
            document.getElementById('TextCPADepoComment').value = nnnn + ' ' + document.getElementById('TextInitDepoTF').value + ' on ' + pap + ';';
           ...
           // document.getElementById('TextRemarksTF2').value = /*"Balance Deposit " +*/ document.getElementById("textBox_14").value + " " + document.getElementById("TextBalDepoTF").value + " on " + document.getElementById("TextBoxNBDTF").value + "; " + text14;
            ...
            document.getElementById('TextCPADepoComment').value = nnnn + ' ' + document.getElementById('TextInitDepoTP').value + ' on ' + pap + ';';
        }
    ...
    //"Balance Deposit " + document.getElementById("textBox_" + e + "4").value + " " + document.getElementById("TextBalDepo").value + " on " + document.getElementById("TextBoxNBDP").value + " " +
        ...
        if (dropval == "Points") {
            ...
            if (dealstat == "Top Drawer") {
                ...
                if (paym == "Crown Finance") {
                    document.getElementById('TextBalanceDueDatesPATP').value = texttp13 + " " + text13;
                    document.getElementById('TextBalanceDueDatesPATP2').value = reT(glob2) + ' ' + reSAPA(glob, 'CF');//texttp14 + " " + text15;
                    document.getElementById('TextBalanceDueDatesSATP').value = text14;
                    document.getElementById('TextBalanceDueDatesSATP2').value = reSASA(glob, 'CF');
                }
                else {

                    document.getElementById('TextBalanceDueDatesPATP').value = texttp13 + " " + text13;
                    document.getElementById('TextBalanceDueDatesPATP2').value = reT(glob2) + ' ' + reSAPA(glob, '');//texttp14 + " " + text15;
                    document.getElementById('TextBalanceDueDatesSATP').value = text14;
                    document.getElementById('TextBalanceDueDatesSATP2').value = reSASA(glob, '');
                }
                ...
                if (paym == "Crown Finance") {
                    ...
                    document.getElementById('TextBalanceDueDatesSATP').value = text14;
                    document.getElementById('TextBalanceDueDatesPATP2').value = reSAPA(glob, 'CF'); //text15;
                    document.getElementById('TextBalanceDueDatesSATP2').value = reSASA(glob, 'CF'); //text16;
                }
                else {

                    document.getElementById('TextBalanceDueDatesPATP').value = text13;
                    document.getElementById('TextBalanceDueDatesSATP').value = text14;
                    document.getElementById('TextBalanceDueDatesPATP2').value = reSAPA(glob, '');//text15;
                    document.getElementById('TextBalanceDueDatesSATP2').value = reSASA(glob, '');//text16;
            ...
            if (dealstat == "Top Drawer") {
                ...
                if (paym == "Crown Finance") {
                    document.getElementById('TextBalanceDueDatesPATF').value = texttp13 + " " + text13;
                    document.getElementById('TextBalanceDueDatesPATF2').value = reT(glob2) + ' ' + reSAPA(glob, 'CF');//texttp14 + " " + text15;
                }
                else
                {
                    document.getElementById('TextBalanceDueDatesPATF').value = texttp13 + " " + text13;
                    document.getElementById('TextBalanceDueDatesPATF2').value = reT(glob2) + ' ' + reSAPA(glob, '');//texttp14 + " " + text15;
                }
                ...
                if (paym == "Crown Finance") {
                    ...
                    document.getElementById('TextBalanceDueDatesPATF2').value = reSAPA(glob, 'CF');
                }
                else
                {
                    document.getElementById('TextBalanceDueDatesPATF').value = text13;
                    document.getElementById('TextBalanceDueDatesPATF2').value = reSAPA(glob, '');
                }
...
function TotalPointsCalc()
{
  ...
  function hi3()
    ...
    function val2()
    {
        ...
        document.getElementById('<%= DealDrawerDropDownList.ClientID %>').style.backgroundColor = '#ffffff';

        document.getElementById('<%= DPMFractDropDownList.ClientID %>').style.backgroundColor = '#ffffff';

        document.getElementById('<%= PayMethodDropDownList.ClientID %>').style.backgroundColor = '#ffffff';

        document.getElementById('<%= CrownFinanceCurrDropDownList.ClientID %>').style.backgroundColor = '#ffffff';

        document.getElementById('<%= YearOfIntDropDownList.ClientID %>').style.backgroundColor = '#ffffff';
       ...
       // alert(id2);
        ...
        //for Deal Drawer
         if (document.getElementById('<%= DealDrawerDropDownList.ClientID %>').value == '')
        {
             ...
             var v1 = document.getElementById("DealDrawerDropDownList");
               ...
               // alert('FractionalIDropDownListF');
                ...
                {
                    //alert('id');
                     document.getElementById('<%= DealDrawerDropDownList.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                }
        ...
        //for Deposit payment method
         if (document.getElementById('<%= DPMFractDropDownList.ClientID %>').value == '')
        {

             var v1 = document.getElementById("DPMFractDropDownList");
                var id = v1.options[v1.selectedIndex].text;
               // alert('FractionalIDropDownListF');
                //alert(id);
                if (id != '')
                ...
                {
                    //alert('id');
                     document.getElementById('<%= DPMFractDropDownList.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                }
         ...
         //for Balance payment method
         if (document.getElementById('<%= PayMethodDropDownList.ClientID %>').value == '')
        {

           document.getElementById('<%= PayMethodDropDownList.ClientID %>').style.backgroundColor = '#fcccd2';
           rem = false;
             ...
             if (id == 'Crown Finance')
                {
                    ...
                    var v3 = document.getElementById("YearOfIntDropDownList");
                    var id3 = v3.options[v3.selectedIndex].text;


                    if(id2=='')
                    {
                        document.getElementById('<%= CrownFinanceCurrDropDownList.ClientID %>').style.backgroundColor = '#fcccd2';
                       
                        rem = false;
                    }
                    if(id3=='')
                    {
                        document.getElementById('<%= YearOfIntDropDownList.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                    }
       ...
       // alert('2');
           ...
           function val3()
           {
              // alert('enter val3')
               ...
               document.getElementById('<%= TextPBalanceDDates.ClientID %>').style.backgroundColor = '#ffffff';
               document.getElementById('<%= TextBalanceDDatesSAP.ClientID %>').style.backgroundColor = '#ffffff';
               document.getElementById('<%= TextDueDatesPAF.ClientID %>').style.backgroundColor = '#ffffff';
               document.getElementById('<%= TextBalanceDueDatesPATF.ClientID %>').style.backgroundColor = '#ffffff';
               document.getElementById('<%= TextBalanceDueDatesPATP.ClientID %>').style.backgroundColor = '#ffffff';
               document.getElementById('<%= TextBalanceDueDatesSATP.ClientID %>').style.backgroundColor = '#ffffff';
               ...
               if (id == 'Points')
               {
                    if (document.getElementById('TextPBalanceDDates').value == '')
                    {
                       // alert('1.1');
            
                    document.getElementById('<%= TextPBalanceDDates.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                    }

                    if (document.getElementById('TextBalanceDDatesSAP').value == '')
                    {
                        //alert('1.2');
            
                    document.getElementById('<%= TextBalanceDDatesSAP.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                     } 
               ...
               {
                    if (document.getElementById('TextDueDatesPAF').value == '')
                     {
                       // alert('1.3');
                    document.getElementById('<%= TextDueDatesPAF.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                     } 
               ...
               {
                    if (document.getElementById('TextBalanceDueDatesPATP').value == '')
                     {
                        //alert('1.4');
                    document.getElementById('<%= TextBalanceDueDatesPATP.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                    }

                    if (document.getElementById('TextBalanceDueDatesSATP').value == '')
                     {
                       // alert('1.5');
                    document.getElementById('<%= TextBalanceDueDatesSATP.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                     } 
               ...
               {
                    if (document.getElementById('TextBalanceDueDatesPATF').value == '')
                     {
                        //alert('1.6');
                    document.getElementById('<%= TextBalanceDueDatesPATF.ClientID %>').style.backgroundColor = '#fcccd2';
                        rem = false;
                     } 
        ...
        if (id == 'Points')
        {
          ...
          function cardremark(card, comment)
           {
              //alert('hi');
              var depomet = document.getElementById("PayMethodDropDownList").value;
              var dropval = document.getElementById("DropDownList40").value;
          ...
          function reSAPA(noofInstall,cf) {
                  ...
                  for (k = 1; k <= noofInstall ; k++) {
                      ...
                      if (document.getElementById("textBoxN_" + k + "2").value != 0) {
                          ...
                          if (temp2 != 1) {
                              ...
                              if (p > 1) {
                                  //alert('p>1');
                                  re += document.getElementById("textBoxN_" + k + "4").value + " " + document.getElementById("textBoxN_" + k + "2").value + " X " + p + " on " + da + " ";
                                  // alert('p>1   '+re);
                              }
                              else {
                                  // alert(' else p>1');
                                  re += document.getElementById("textBoxN_" + k + "4").value + " " + document.getElementById("textBoxN_" + k + "2").value + " " + "on " + da + " ";//document.getElementById("t" + l + "2").value+",";
                                  // alert(' else p>1 '+re);
                              }
              ...
              else if (cf == "CF")
              {
                  ...
                  if (document.getElementById("textBoxN_" + glob + "2").value != 0) {
                      re = re +', '+ document.getElementById("textBox_" + glob + "4").value + " " + document.getElementById("textBoxN_" + glob + "2").value + " on " + document.getElementById("textBox_" + glob + "3").value + " By Crown Finance LTD. " + document.getElementById("TextContractNumb").value + "/" + document.getElementById("TextPnumb").value + ";";
                  }
                  else
                  {
                      re = re + ';';
          ...
          function reSASA(noofInstall, cf) {
              ...
              if (cf == "") {
                  ...
                  for (k = 1; k <= noofInstall ; k++) {
                      ...
                      if (document.getElementById("textBoxN_" + k + "3").value != 0) {
                          ...
                          if (temp2 != 1) {
                              ...
                              if (p > 1) {
                                  //alert('p>1');
                                  re += document.getElementById("textBoxN_" + k + "4").value + " " + document.getElementById("textBoxN_" + k + "3").value + " X " + p + " on " + da + " ";
                                  // alert('p>1   '+re);
                              }
                              else {
                                  // alert(' else p>1');
                                  re += document.getElementById("textBoxN_" + k + "4").value + " " + document.getElementById("textBoxN_" + k + "3").value + " " + "on " + da + " ";//document.getElementById("t" + l + "2").value+",";
                                  // alert(' else p>1 '+re);
                              }
                  ...
                  if (document.getElementById("textBoxN_" + glob + "3").value != 0) {
                      re = re +', '+ document.getElementById("textBox_" + glob + "4").value + " " + document.getElementById("textBoxN_" + glob + "3").value + " on " + document.getElementById("textBox_" + glob + "3").value + " By Crown Finance LTD. " + document.getElementById("TextContractNumb").value + "/" + document.getElementById("TextPnumb").value + ";";
                  }
                  else {
                      re = re + ';';
                  }
          ...
          function valueChanged() {
              ...
              if (document.getElementById("cup").checked == true) {
                  document.getElementById("cup").value = 1;
                  document.getElementById("cdown").value = 0;
                  //document.getElementById("cdown").checked =false;
                  kglob = "UG";
                  // alert('pqai');
              }
              else if (document.getElementById("cdown").checked == true) {
                  document.getElementById("cup").value = 0;
                  document.getElementById("cdown").value = 1;
                  kglob = "DG";
                  //document.getElementById("cup").checked =false;
              }
              document.getElementById("TextBoxUPoDW").value = kglob;
              document.getElementById("TextBoxUPDGvalue").value = kglob;
          ...
          function sp() {
           ...
           //   alert(inp);
            ...
            //  alert(arr[0]);
              ...
              document.getElementById('input2').value = k;
             ...
             // alert(da);
              ...
              var pap = caldaysUG(dt2, mon2, yr2);

              //alert("pap" + pap);


              document.getElementById('input2').value = arr[0] + "/" + pap + "/" + arr[2] + "" + kglob;
              document.getElementById('TextBoxUPDW').value = "UPDW";
              //var yr1 = parseInt(date.substring(6, 10));
              //var mon1 = parseInt(date.substring(3, 5));
              //var dt1 = parseInt(date.substring(0, 2));
          }
          ...
          function btnclickUG() {
              //alert("bcl");
              var modalUG2 = document.getElementById('myModal4');

              //alert(modalUG2);
              modalUG2.style.display = "block";
              /*var span = document.getElementsById('class1');
              span.onclick = function () {
                  modal.style.display = "none";
               }*/
              var label2 = document.getElementById('close4');
              label2.onclick = function () {
                  //alert("label");
                  modalUG2.style.display = "none";
              }

              window.onclick = function (event) {
                  //alert("out");
                  if (event.target == modalUG2) {
                      modalUG2.style.display = "none";
                  }
              }
          ...
          function btnclickUG2() {
            //  alert("bcl");
              ...
              var label3 = document.getElementById('close3');
...
#myBtnBack:hover {
  background-color: #555;
   ...
   #cleft {
     ...
     #ffractional1,#tfractional,#tpoints,#TextFDepo2,#TextFBala2,#TextFDepo1,#TextFBala1,#TextFFina1,#TextFFina2,#TextBox96,#TextICE,#TextHP,#texttest,#texte,#remarkP,#Button3,#PointsAdd,#TPAdd,#remarkTP,#hiddentconttype,#hiddentconttype2,#TextBoxUPDW,#TextBoxUPDWNumber,#TextBoxUPoDW,#TextBoxUPDWNewContNumb{
         /*float:left;*/
         display:none;
     }
      ...
      #tPurchase,#QDepo,#AmtCre,#CreCurr,#NoOfMonth,#RateOfInt,#MonthlyRepay,#pbala,#pbalaTD,#fbala,#FbalaTD,#tpbala,#TpbalaTD,#tfbala,#TFbalaTD,#F50,#P50,#TF50,#TP50,#cpacom,#Button9,#Button13,#Button7,#Button12,#Button10,#tButton1,#Button11,#Button14
      {
    display:none;
      }
      ...
      #pcurr1MP,#pcurr2MP,#pcurr3MP,#pcurr4MP,#keke,#PrintPdfTextBox2,#TextBoxUPDGvalue
      {
        display:none;
      }
...
/* modal content for upgrade and downgrade contract*/
...
/*upgrade down grade pop up*/
.itemUDU {
   grid-area: itemUDU;
}

.itemUDVenue {
   grid-area: itemUDVenue;
}
...
.itemUDDepo {
   grid-area: itemUDDepo;
}


.itemUDCreate {
   grid-area: itemUDCreate;
   margin: 0px 10px 0px auto;
}

.itemUDCancel {
   grid-area: itemUDCancel;
...
<div id="tabs">
 ...
 <p class="help_text_style">Email2</p>
        ...
        <asp:TextBox ID="OfficeNumTextBox" runat="server" Enabled="True" Width="200px"></asp:TextBox>
          ...
          <br />
           <input id="Primchs" type="checkbox" onclick="shows('Primchs', 'Prihidden');"/> <asp:Label ID="Label83" runat="server" Text="Label">ID Card?</asp:Label>
        <br />
        <div id ="Prihidden">
        ...
        <asp:DropDownList ID="secondaryalternateDropDownList" runat="server" Width="100px" style="height: 25px"></asp:DropDownList>
         ...
         <br />
             ...
             <input id="Secochs" type="checkbox" onclick="shows('Secochs', 'Sechidden');"/> <asp:Label ID="Label84" runat="server" Text="Label">ID Card?</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp <asp:CheckBox ID="CheckBoxDeleSecondProfile" runat="server" /><asp:Label ID="Label81delte" runat="server" Text="Label">DELETE</asp:Label>
        <br />
        <div id ="Sechidden">
...
<input id="chs2" type="checkbox" onclick="shows2();"/>
 <label for="chs2">SUB PROFILE 1</label>      
        ...
        <input id="SP1chs" type="checkbox" onclick="shows('SP1chs', 'SP1hidden');"/> <asp:Label ID="Label87" runat="server" Text="Label">ID Card?</asp:Label>
        <br />
        <div id ="SP1hidden">
...
<input id="chs3" type="checkbox" onclick="shows3();"/>
 <label for="chs3">SUB PROFILE 2</label>      
        ...
        <input id="SP2chs" type="checkbox" onclick="shows('SP2chs', 'SP2hidden');"/> <asp:Label ID="Label88" runat="server" Text="Label">ID Card?</asp:Label>
        <br />
        <div id ="SP2hidden">
...
<input id="chsp4" type="checkbox" onclick="shows4();"/>
 <label for="chsp4">SUB PROFILE 3</label>      
        ...
        <input id="SP3chs" type="checkbox" onclick="shows('SP3chs', 'SP3hidden');"/> <asp:Label ID="Label89" runat="server" Text="Label">ID Card?</asp:Label>
        <br />
        <div id ="SP3hidden">
...
<input id="chsp5" type="checkbox" onclick="shows5();"/>
 <label for="chsp5">SUB PROFILE 4</label>      
        ...
        <input id="SP4chs" type="checkbox" onclick="shows('SP4chs', 'SP4hidden');"/> <asp:Label ID="Label90" runat="server" Text="Label">ID Card?</asp:Label>
        <br />
        <div id ="SP4hidden">
          ...
          <asp:DropDownList ID="ButtonUpDropDownList" runat="server" style="height: 25px" Width="200px"></asp:DropDownList>
           ...
           <asp:DropDownList ID="FinanceCurrencyDropDownList" onchange="CurrencyFees();" style="height: 25px" runat="server" Width="200px"></asp:DropDownList>
               ...
               <div class="item97">
                   ...
                   <p> </p>
                   <input type="button" name="UPDOButton" id="UPDOButton" value="Upgrade/Downgrade" onclick="btnclickUG();">
           ...
           <asp:TextBox ID="TextBoxUPDW" runat="server" Enabled="True" ></asp:TextBox>
           <asp:TextBox ID="TextBoxUPDWNumber" runat="server" Enabled="True" ></asp:TextBox>
           <asp:TextBox ID="TextBoxUPoDW" runat="server" Enabled="True" ></asp:TextBox>
           <asp:TextBox ID="TextBoxUPDWNewContNumb" runat="server" Enabled="True" ></asp:TextBox>
          <br />
            ...
            <div id="cright" style=" width:605px;">
                <div class="grid-container20">
                   <div class="item2016">
                    ...
                    <div class="itemCCom1">
                        <asp:Label ID="Label82" runat="server" Text="Label">Comments</asp:Label>
                        </div>
                        <div class="itemCCom2">
 ...
 <div class="modal-content3">
 	<label id="close3">Close[X]</label>
 	<br/>
     <br/>
     <div class="grid-UPDG">
         <div class="itemUDVenue">
              <p>Choose Venue:</p>
          <asp:DropDownList ID="UGDGVenueDropDownList" runat="server"  Width="200px" style="height: 25px" >
              <asp:ListItem>Choose Venue</asp:ListItem>
              <asp:ListItem>Member Relations</asp:ListItem>
        ...
        <div class="itemUDU">
            <label>Upgrade</label>
 	<input type="radio" name="p" id="cup" onchange="valueChanged();" />
            </div>
         <div class="itemUDD">
             <label>Downgrade</label>
<input type="radio" name="p" id="cdown" onchange="valueChanged();"/>
             </div>
         <div class="itemUDOCN">
       <p>Old Contract Number</p> 
            <input type="text" name="input1" id="input1" />
            </div>
         <div class="itemUDNCN">
           <p>New Contract Number</p>
             <input type="text" name="input2" id="input2" />
            </div>

         <div class="itemUDPP">
           <p>Purchase Price</p>
             <asp:TextBox ID="TextBoxUDPurcahsePrice" runat="server" Enabled="True"></asp:TextBox>
            </div>

         <div class="itemUDAP">
           <p>Admin price</p>
             <asp:TextBox ID="TextBoxAdminPrice" runat="server" Enabled="True"></asp:TextBox>
            </div>

         <div class="itemUDT">
           <p>Tax</p>
             <asp:TextBox ID="TextBoxUDTax" runat="server" Enabled="True"></asp:TextBox>
            </div>

         <div class="itemUDDepo">
           <p>Deposit</p>
            <asp:TextBox ID="TextBoxUDDeposit" runat="server" Enabled="True"></asp:TextBox>
            </div>
         <div class="itemUDCreate">
           <input type="button" name="create" id="create" value="create" onclick="sp();"  style="display: inline-block; width:80px;" />
            </div>
         <div class="itemUDCancel">
           <input type="button" name="clear" id="UDclear" value="clear" onclick=""  style="display: inline-block; width:80px;" />
            </div>
 ...
 <asp:TextBox ID="TextBoxUPDGvalue" runat="server" Enabled="True"></asp:TextBox>
...
<label id="close4">Close[X]</label>
<br />
                      <p>are you sure??</p>

                      <br/>
                      <br/>
     <input type="button" name="yes3" id="yes3" value="Yes" onclick="ansyes();"  style="display: inline-block;" />
<input type="button" name="cancel" id="cancel" value="Cancel" onclick="can();"  style="display: inline-block;" />
       ...
       <div id="tabs-3" style="background-color:#e9e9e9;">
          <div id="finance-container1" style="margin-top:10px;padding-top:10px; ">
              ...
              <table>
                ...
                <td width="300px"><asp:TextBox ID="TextPurchasePrice" runat="server" Enabled="True" onchange="fullcash();" ></asp:TextBox></td>
            </tr>
                 <tr></tr>
                  <tr></tr>
            <tr>
                ...
                <table cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                       ...
                       <table id="fbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextInitDepoF" runat="server" Enabled="True" Width="328px" onchange="check_load_Ibalance();load_Ibalance();adminfee();"></asp:TextBox></td>
                           </tr>
                           <tr>
                        ...
                        <td width="400px"><asp:TextBox ID="TextBoxNBDF" runat="server" Enabled="True" Width="328px" onchange="initinstall();"></asp:TextBox></td>
                           </tr>
                             <tr>
                     ...
                     <table cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td width="180px"><asp:Label ID="Labtotalbalance" runat="server" Text="Label">Total Balance</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextTotalBalanceF" runat="server" Enabled="True" Width="328px" ></asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <table id="FbalaTD"  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td width="180px"><asp:Label ID="Label81FTD" runat="server" Text="Label">Balance Due PA(Top Drawer)</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextBalanceDueFTD" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                    </tr>
                    </table>
                    <table  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td width="180px"><asp:Label ID="Label137" runat="server" Text="Label">No of Installments</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextNoOfInstallF" runat="server" Enabled="True" Width="328px" onchange="clearinvoicedetails();changeInstallNo('Button9','Button13');"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><asp:CheckBox ID="CheckBoxBalloonF" runat="server" Text="Balloon Payment" /></td>
                    </tr>
                    <tr>
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                       ...
                       <table id="pbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextInitDepo" runat="server" Enabled="True" Width="328px" onchange="check_load_Ibalance();load_Ibalance();adminfee();"></asp:TextBox></td>
                           </tr>
                           <tr>
                        ...
                        <td width="400px"><asp:TextBox ID="TextBoxNBDP" runat="server" Enabled="True" Width="328px" onchange="initinstall();"></asp:TextBox></td>
                           </tr>
                           <tr>
                    ...
                    <table id="pbalaTD"  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td><asp:Label ID="Label81TD" runat="server" Text="Label">Balance Due PA(Top Drawer)</asp:Label></td>
                        <td><asp:TextBox ID="TextPBalaceDPATOPD" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                    </tr>
                    </table>
                       <table  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td width="210px"><asp:Label ID="Label166" runat="server" Text="Label">No of Installments</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextPPANoInstall" runat="server" Enabled="True" Width="328px" onchange="clearinvoicedetails();changeInstallNo('Button7','Button12');"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><asp:CheckBox ID="CheckBoxBalloonP" runat="server" Text="Balloon Payment" /></td>
                    </tr>
                    
                    <tr>
                        <td><asp:Label ID="Label167" runat="server" Text="Label">First Payment Date</asp:Label></td>
                        <td><asp:TextBox ID="datepicker8" runat="server" Enabled="True" Width="328px" onkeypress="return false;"></asp:TextBox></td>
                    </tr>
                     <tr>
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                     ...
                     <table id="tfbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextInitDepoTF" runat="server" Enabled="True" Width="328px" onchange="check_load_Ibalance();load_Ibalance();adminfee();"></asp:TextBox></td>
                           </tr>
                           <tr>
                        ...
                        <td width="400px"><asp:TextBox ID="TextBoxNBDTF" runat="server" Enabled="True" Width="328px" onchange="initinstall();"></asp:TextBox></td>
                           </tr>
                         <tr>
                      ...
                      <table  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td width="180px"><asp:Label ID="Label30" runat="server" Text="Label">Total Balance</asp:Label></td>
                    ...
                    <table id="TFbalaTD"  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td width="180px"><asp:Label ID="Label81TF" runat="server" Text="Label">Balance Due PA(Top Drawer)</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextBalanceDuePATFTD" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                    </tr>
                    </table>
                    <table  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td  width="180px"><asp:Label ID="Label176" runat="server" Text="Label">No of Installments</asp:Label></td>
                        <td  width="400px"><asp:TextBox ID="TextNoOfInstallTF" runat="server" Enabled="True" Width="328px" onchange="clearinvoicedetails();changeInstallNo('Button11','Button14');"></asp:TextBox></td>
                    </tr>
                    

                    <tr>
                        <td></td>
                        <td><asp:CheckBox ID="CheckBoxBalloonTF" runat="server" Text="Balloon Payment" /></td>
                    </tr>
                    <tr>
                ...
                <table  cellpadding="5px" cellspacing="5px">
                    ...
                    <tr>
                       ...
                       <table id="tpbala"  cellpadding="5px" cellspacing="5px">
                        ...
                        <td width="400px"><asp:TextBox ID="TextInitDepoTP" runat="server" Enabled="True" Width="328px" onchange="check_load_Ibalance();load_Ibalance();adminfee();"></asp:TextBox></td>
                           </tr>
                           <tr>
                        ...
                        <td width="400px"><asp:TextBox ID="TextBoxNBDTP" runat="server" Enabled="True" Width="328px" onchange="initinstall();"></asp:TextBox></td>
                           </tr>
                           <tr>
                    ...
                    <tr>
                        <td width="210px"><asp:Label ID="Label182" runat="server" Text="Label">Deposit Purchase Agreement</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextDepositPATP" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <table id="TpbalaTD"  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td width="210px"><asp:Label ID="Label81TP" runat="server" Text="Label">Balance Due PA(Top Drawer)</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextBalanceDuePATPTD" runat="server" Enabled="True" Width="328px"></asp:TextBox></td>
                    </tr>
                    </table>
                       <table  cellpadding="5px" cellspacing="5px">
                    <tr>
                        <td width="210px"><asp:Label ID="Label189" runat="server" Text="Label">No of Installments</asp:Label></td>
                        <td width="400px"><asp:TextBox ID="TextNoOfInstallPATP" runat="server" Enabled="True" Width="328px" onchange="clearinvoicedetails();changeInstallNo('Button10','tButton1');"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><asp:CheckBox ID="CheckBoxBalloonTP" runat="server" Text="Balloon Payment" /></td>
                    </tr>
                    <tr>
  ...
  <!-- Modal content -->
      ...
      <div id="tabs-4" style="background-color:#e9e9e9;">
       ...
       <div id="tabs-5" style="background-color:#e9e9e9;">
          <div class="Tab5cont">
              <div class="TLang">
              <p>Language</p><asp:DropDownList ID="LanguageDropDown" runat="server" >
              ...
              <div class="Tbutt">
              <asp:Button ID="Button5" runat="server" Text="Print" OnClick="Button4_Click"  /><asp:TextBox ID="PrintPdfTextBox2" runat="server" Enabled="True" Width="110px"></asp:TextBox>
                </div>
          </div>
      </div>
