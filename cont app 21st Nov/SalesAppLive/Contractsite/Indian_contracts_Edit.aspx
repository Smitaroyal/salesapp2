         ...
         <div id="divref" >
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td width="50px"><asp:TextBox ID="PrgmsrcTextBox" runat="server" Width="276px"></asp:TextBox></td>
                     
                        <td class="auto-style3"><asp:Label ID="Label163" runat="server" Font-Size="Medium" Text="Label">Referred By</asp:Label></td>
                       <td width="50px"><asp:TextBox ID="RefByTextBox" runat="server" Width="334px" TextMode="MultiLine" Height="60px"></asp:TextBox></td>
                    </tr> 
           ...
           <div id="contract-container">
            ...
            <tr>
               ...
               <tr>
                ...
                <tr> 
                 <td width="100px" ><asp:Label ID="lblinvoiceno" runat="server" Font-Size="Small" Text="Label">INVOICE#</asp:Label></td>
                <td width="100px"><asp:TextBox ID="invoicenoTextBox" Font-Size="Small"  style="width:200px; height:20px" runat="server" Enabled="True"></asp:TextBox></td>  
                </tr>                     
                  ...
                  <tr>
                       <td><asp:Label ID="Label115" runat="server" Text="Label">Enter No</asp:Label></td>
                        <td><asp:TextBox ID="asornoTextBox" type="number" runat="server" onchange="SORAdditionalNames();" Enabled="True" Width="328px"></asp:TextBox></td>
                           ...
                           <table>
                          <tr>
                              <td width="170px" align="center"><asp:Label ID="Label116" runat="server" Text="Label">Name</asp:Label> </td>
                              <td width="170px" align="center"><asp:Label ID="Label117" runat="server" Text="Label">Address</asp:Label> </td>
