        ...
        else if (contract_type == "Points")
        {
          //  alert("points");
           // alert(venuegroup);
            ...
            if (venuegroup == "Inhouse" || venuegroup == "INHOUSE" || venuegroup == "Collections" || venuegroup == "Odyssey" || venuegroup == "COLLECTIONS" || venuegroup == "MC" || venuegroup == "ODYSSEY")
            {
                //if (mktg == "OWNER" || mktg == "OWNER DOWNGRADE" || mktg == "Owner Downgrade" || mktg == "Owner" || mktg == "Member" || mktg == "MEMBER") {
                // if (mktg == "OWNER" || mktg == "RCIOWN" || mktg == "RCIOwn"||mktg=="Member"||mktg=="MEMBER"||mktg=="RCIMBR"||mktg=="RCIMbr")
                if (mktg == "FRACTIONAL OWNER" || mktg == "FRACTIONAL OWNER RCI" || mktg == "T/S MEMBER" || mktg == "T/S MEMBER RCI" || mktg == "OWNER" || mktg == "RCIOWN" || mktg == "RCIOwn" || mktg == "Member" || mktg == "MEMBER" || mktg == "RCIMBR" || mktg == "RCIMbr")
                    {
           ...
           <div id="contract-container">
            ...
            <div id="cdiv3">
               ...
               <table style="width:100%;">
                ...
                <td width="100px"><asp:TextBox ID="foldloanagreementnoTextBox" Font-Size="Small"  style="width:200px; height:20px" runat="server" Enabled="True" Text="0"></asp:TextBox></td>  
                </tr>
                 <tr>
                <td width="100px" ><asp:Label ID="lblfoldloanamount" runat="server" Font-Size="Small" Text="Label">Old Loan Amount</asp:Label></td>
                <td width="100px"><asp:TextBox ID="foldloanamountTextBox" Font-Size="Small"  style="width:200px; height:20px" runat="server" Enabled="True" Text="0"></asp:TextBox></td>  
                </tr>
                    <tr>
               ...
               <table style="width:100%;">
                ...
                <td width="100px"><asp:TextBox ID="ffoldloanagreementnoTextBox" Font-Size="Small"  style="width:200px; height:20px" runat="server" Enabled="True" Text="0"></asp:TextBox></td>  
                </tr>
                 <tr>
                <td width="100px" ><asp:Label ID="lblffoldloanamount" runat="server" Font-Size="Small" Text="Label">Old Loan Amount</asp:Label></td>
                <td width="100px"><asp:TextBox ID="ffoldloanamountTextBox" Font-Size="Small"  style="width:200px; height:20px" runat="server" Enabled="True" Text="0"></asp:TextBox></td>  
                </tr>
                    <tr>
                        <td><h5>TRADE INTO FRACTIONAL</h5></td>
                    </tr>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="fffirstyrTextBox" runat="server" style="width:200px; height:20px" onchange="GetFractionaltoFractionalLastYr();" Enabled="True"></asp:TextBox></td>
                    </tr>
                     <tr>
               ...
               <table style="width:100%;">
                ...
                <td width="100px"><asp:TextBox ID="oldLoanAgreementTextBox" Font-Size="Small"  style="width:200px;   height:20px" runat="server" Enabled="True" Text="0" ></asp:TextBox></td>  
                </tr>
                         <tr>
                <td width="100px" ><asp:Label ID="lbloldloanamount" runat="server" Font-Size="Small" Text="Label">Old Loan Amount</asp:Label></td>
                <td width="100px"><asp:TextBox ID="oldloanamountTextBox" Font-Size="Small"  style="width:200px; height:20px" runat="server" Enabled="True" Text="0" ></asp:TextBox></td>  
                </tr>
                    <tr>
                        <td><h5>TRADE INTO FRACTIONAL</h5></td>
                    </tr>
            ...
            $("#contracttypeDropDownList").change(function () {
                ...
                if (value == "Fractional") {
                  ...
                  $("#incrTextBox").hide();
                    ...
                    if (marketprogram == "FRACTIONAL OWNER" || marketprogram == "FRACTIONAL OWNER RCI" || marketprogram == "T/S MEMBER" || marketprogram == "T/S MEMBER RCI" || marketprogram == "OWNER" || marketprogram == "RCIOWN" || marketprogram == "RCIOwn" || marketprogram == "Member" || marketprogram == "MEMBER" || marketprogram == "RCIMBR" || marketprogram == "RCIMbr")
