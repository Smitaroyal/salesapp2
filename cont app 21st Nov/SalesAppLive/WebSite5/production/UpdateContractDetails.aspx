    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #salesMarketingSource,#profileID,#ReferralBy,#Comment,#contractNo,#dealDate,#dealStatus1,#SubVenue,#LeadOffice,
      ...
      <div class="main_container">
        ...
        <div class="container-fluid">
          ...
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="dealDate">
                  <div class="form-group">
                      <label for="sel1">Deal Date:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="" runat="server" ReadOnly></asp:TextBox>
                  </div>
              </div>
               ...
               <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="oldDeposit">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="LeadOffice">
                  <div class="form-group">
