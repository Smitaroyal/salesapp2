<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receptionist.aspx.cs" Inherits="WebSite5_production_Receptionist" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#ID,#head,#recepName,#recepDesig,#fullName,#directory,#insert,#Status{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD RECEPTIONIST</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="ID">
                  <div class="form-group">
                      <label for="sel1">Receptionist ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right" runat="server"></asp:TextBox>
                     
                  </div>
              </div>

              <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="recepName">
                  <div class="form-group">
                      <label for="sel1">Receptionist Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Receptionist" runat="server"></asp:TextBox>
                  </div>
              </div>
              <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="recepDesig">
                  <div class="form-group">
                      <label for="sel1">Designation:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="Enter Designation" runat="server"></asp:TextBox>
                  </div>
              </div>
              <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="fullName">
                  <div class="form-group">
                      <label for="sel1">Full Name:</label>
                      <asp:TextBox ID="TextBox4" class="form-control pull-right" placeholder="Enter Full Name" runat="server"></asp:TextBox>
                  </div>
              </div>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h3 class="text-center"> RECEPTIONIST DIRECTORY</h3>
                               </div>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Receptionist.aspx/insertReceptionist',
                    contentType:"application/json; charset=utf-8",
                    data: "{'name':'" + name + "','designation':'" + designation + "','fullName':'" + fullName + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var design = row.find("td:eq(2)").text();
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Receptionist.aspx/getAllReceptionist',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var ID = row.find("td:eq(0)").text();
                    var recepName = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + recepName + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Receptionist.aspx/deleteReceptionist',
                            contentType: "application/json; charset=utf-8",
                            data: "{'ID':'" + ID + "','recepName':'" + recepName + "'}",
                            async: false,
                            success: function (data) {
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
                                    $("#success-alert").slideUp(500);
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Receptionist.aspx/updateReceptionist',
                        contentType: "application/json; charset=utf-8",
                        data: "{'ID':'" + ID + "','name':'" + name + "','designation':'" + designation + "','fullName':'" + fullName + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Receptionist.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Receptionist.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
