<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reciept.aspx.cs" Inherits="WebSite5_Reciept" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#receiptCode,#head,#Venue,#directory,#insert,#receiptStart,#Status,#receiptID,#stateCode,#state,#supplyPlace{
             display:none;
         }
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h3 class="text-center">ADD RECEIPT INITIALS</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="receiptID">
               ...
               <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="stateCode">
                  <div class="form-group">
                      <label for="sel1">State Code:</label>
            ...
            <div class="row">
                  ...
                  <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="receiptStart">
                  <div class="form-group">
                      <label for="sel1">Receipt Initial:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="" runat="server"  ></asp:TextBox>
                  </div>
              </div>

                 <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="receiptCode">
                  <div class="form-group">
                      <label for="sel1">Receipt Code:</label>
            ...
            <div class="row">
                  <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="supplyPlace">
                  <div class="form-group">
                      <label for="sel1">Supply Place:</label>
                      <asp:TextBox ID="TextBox6" class="form-control pull-right" placeholder="" runat="server"></asp:TextBox>
                  </div>
              </div>
            
             
                  <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="state">
                  <div class="form-group">
                ...
                <button type="button"  runat="server" id="insert" class="btn btn-primary pull-right btn-block" >Insert</button>
                 ...
                 <button type="button"  runat="server" id="update" class="btn btn-primary pull-right btn-block">Update</button>
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h5 class="text-center"> RECEIPT INITIALS DIRECTORY</h5>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var receiptStart = $("#TextBox3").val();
                if (receiptStart == "" || receiptStart == null) {
                    receiptStart = "";
                } else {
                    receiptStart = $("#TextBox3").val();
                }

                var receiptCode = $("#TextBox2").val();
                if (receiptCode == "" || receiptCode == null) {
                    receiptCode = "";
                } else {
                    receiptCode = $("#TextBox2").val();
                }

                var stateCode = $("#TextBox4").val();
                if (stateCode == "" || stateCode == null) {
                    stateCode = "";
                } else {
                    stateCode = $("#TextBox4").val();
                }


                var supplyPlace = $("#TextBox6").val();
                if (supplyPlace == "" || supplyPlace == null) {
                    supplyPlace = "";
                } else {
                    supplyPlace = $("#TextBox6").val();
                }
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Reciept.aspx/insertReceiptDetails',
                    contentType:"application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "','receiptStart':'" + receiptStart + "','receiptCode':'" + receiptCode + "','stateCode':'" + stateCode + "','supplyPlace':'" + supplyPlace + "','state':'" + state + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var receiptStart = row.find("td:eq(3)").text();
                    var receipCode = row.find("td:eq(4)").text();
                    var status = row.find("td:eq(6)").text();
                    var statecode = row.find("td:eq(2)").text();
                    var supplyplace = row.find("td:eq(5)").text();
                    var state = row.find("td:eq(7)").text();
                    $("#TextBox1").val(ID);
                    $("#venue option[value='" + venue + "']").prop('selected', true);
                    $("#TextBox3").val(receiptStart);
                    $("#TextBox2").val(receipCode);
                    $("#status option[value='" + status + "']").prop('selected', true);
                    $("#TextBox4").val(statecode);
                    $("#TextBox6").val(supplyplace);
            ...
            $(document).ready(function () {
                ...
                $("#TextBox5").keyup(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Reciept.aspx/ReceiptInitials',
                        contentType: "application/json; charset=utf-8",
                        data: "{'value':'"+value+"'}",
                        async: false,
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    if (value1[0] == "") {
                                        ...
                                        $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td>" + value1[7] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td></tr>");
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Reciept.aspx/updateReceiptInitials',
                        contentType: "application/json; charset=utf-8",
                        data: "{'receiptID':'" + receiptID + "','venue':'" + venue + "','receiptStart':'" + receiptStart + "','receiptCode':'" + receiptCode + "','status':'" + status + "','stateCode':'" + stateCode + "','supplyPlace':'" + supplyPlace + "','state':'" + state + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox2").val("");
                            $("#TextBox3").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Reciept.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Reciept.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
