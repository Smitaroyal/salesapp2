<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contract_Initials.aspx.cs" Inherits="WebSite5_production_Country" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#contractID,#head,#Type,#Venue,#directory,#insert,#Club,#Nationality,#Initial,#Value,#Status{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD CONTRACT INITIALS</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="contractID">
                  <div class="form-group">
                      <label for="sel1">Contract Initial ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>
          
                    <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="Type">
                  <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="Club">
                  <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="Nationality">
                  <div class="form-group">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="Initial">
                  <div class="form-group">
                      <label for="sel1">Contract Code:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="" runat="server"  ></asp:TextBox>
                  </div>
              </div>
                 
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="Value">
                  <div class="form-group">
                      <label for="sel1">Increment Value:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="" runat="server"  ></asp:TextBox>
                  </div>
              </div>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h5 class="text-center"> CONTRACT DETAILS DIRECTORY</h5>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var venueName = $("#venue option:selected").text();
                if (venueName == "" || venueName == null) {
                    venueName = "";
                } else {
                    venueName = $("#venue option:selected").text();
                }
                var club = $("#club").val();
                if (club == "" || club == null) {
                    club = "";
                ...
                var initial = $("#TextBox3").val();
                if (initial == "" || initial == null) {
                    initial = "";
                } else {
                    initial = $("#TextBox3").val();
                }

                var inc = $("#TextBox2").val();
                if (inc == "" || inc == null) {
                    inc = "";
                } else {
                    inc = $("#TextBox2").val();
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Contract_Initials.aspx/insertContractInitials',
                    contentType:"application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "','club':'" + club + "','nationality':'" + nationality + "','initial':'" + initial + "','inc':'" + inc + "','type':'" + type + "','venueName':'" + venueName + "'}",
                    async: false,
            ...
            $(document).ready(function () {
                $("#type").change(function () {
                 ...
                 //   alert(value);
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Contract_Initials.aspx/getClub',
                        contentType: "application/json; charset=utf-8",
                        data: "{'value':'" + value + "'}",
                        async: false,
                        success: function (data) {
            ...
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                   ...
                   $("#Type").show();
                    ...
                    var club = row.find("td:eq(1)").text();
                    if (club == "Royal India Holiday Club" || club == "Royalty Gold Club") {
                        $("#type option[value='TimeShare']").prop('selected', true);
                        ...
                        $("#type option[value='Fractional']").prop('selected', true);
                    ...
                    var venueID = row.find("td:eq(3)").text();
                    var code = row.find("td:eq(5)").text();
                    var inc = row.find("td:eq(6)").text();
                    var nationality = row.find("td:eq(7)").text();
                    $("#TextBox1").val(ID);
                    $("#club option[value='" + club + "']").prop('selected', true);
            ...
            $(document).ready(function () {
                ...
                $("#TextBox5").keyup(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Contract_Initials.aspx/getContractInitials',
                        contentType: "application/json; charset=utf-8",
                        data: "{'value':'" + value + "'}",
                        async: false,
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td style='display:none'>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td>" + value1[7] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td></tr>");
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Contract_Initials.aspx/updateInitials',
                        contentType: "application/json; charset=utf-8",
                        data: "{'contractID':'" + contractID + "','venue':'" + venue + "','club':'" + club + "','nationality':'" + nationality + "','initial':'" + initial + "','inc':'" + inc + "','status':'" + status + "','type':'" + type + "','venueName':'" + venueName + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox2").val("");
                            $("#TextBox3").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Contract_Initials.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Contract_Initials.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Contract_Initials.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
