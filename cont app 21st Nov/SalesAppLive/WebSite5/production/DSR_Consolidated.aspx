...
.has-search .form-control {
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #success-alert,#danger-alert,#hell1,#menu_toggle,#profileDetails{
            display:none;
        }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h4 class="text-center">DSR CONSOLIDATED</h4>
              </div>
              </div>
            </div>
              <br /><br />
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_Consolidated.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_Consolidated.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
