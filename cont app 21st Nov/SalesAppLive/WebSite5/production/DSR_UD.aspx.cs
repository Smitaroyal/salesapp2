...
public partial class WebSite5_production_DSR_UD : System.Web.UI.Page
{
    ...
    private void show_report(string country,string venue,string ud)
    {
        ...
        ReportViewer1.Reset();
        DataTable dt1 = Queries2.loadDSR_UPDG(date, venue, country, ud);
        DataTable dt2 = Queries2.loadDSR_UPDG_1_1(date, venue, country, ud);
        DataTable dt3 = Queries2.loadDSR_UPDG_DT(date, venue, country, ud);
        DataTable dt4 = Queries2.loadDSR_UPDG_WT(date, venue, country, ud);
        DataTable dt5 = Queries2.loadDSR_UPDG_MT(date, venue, country, ud);
        ...
        ReportDataSource rds5 = new ReportDataSource("DataSet5", dt5);
        ...
        ReportViewer1.LocalReport.ReportPath = "reports/DSR_UPDG.rdlc";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string ud = Request.Form["ud"];
        show_report(country,venue, ud);
