<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaxiDetails.aspx.cs" Inherits="WebSite5_production_TaxiDetails" %>
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h5 class="text-center">ADD TAXI DETAILS</h5>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="countryID">
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h5 class="text-center">TAXI DETAILS</h5>
                               </div>
    ...
    (function (document) {
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#TextBox1").change(function () {
                    $("#update").show();
                    $("#TextBox5").val("");
                    var date = $("#TextBox1").val();
                  
                    $.ajax({

                        type: 'Post',
                        url: 'TaxiDetails.aspx/getAllTaxiDetails',
                        ...
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#myTable").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td style='display:none'><input type'text' id='hidden' value='"+value1[0]+"'></td><td><input type='text' id='taxiInPrice'></td><td><input type='text' id='taxiOutPrice'></td></tr>");
                                });
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#update").click(function () {
                    ...
                    var taxiPriceOut = "";
                    var profileID = "";
                    $.each($('[id^=taxiInPrice]'), function (i, item) {
                       var taxiIn = $(this).val();
                       taxiPriceIn += taxiIn + ",";
                    ...
                    $.each($('[id^=taxiOutPrice]'), function (i, item) {
                        var taxiOut = $(this).val();
                        taxiPriceOut += taxiOut + ",";
                       // alert(taxiPriceOut);
                    });

                    $.each($('[id^=hidden]'), function (i, item) {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'TaxiDetails.aspx/insertTaxiDetails',
                        contentType: "application/json; charset=utf-8",
                        data: "{'taxiPriceIn':'" + taxiPriceIn + "','taxiPriceOut':'" + taxiPriceOut + "','profileID':'" + profileID + "'}",
                        async: false,
                        success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'TaxiDetails.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'TaxiDetails.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
