<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditProfile1.aspx.cs" EnableEventValidation="false" Inherits="WebSite5_production_EditProfile1" %>
...
.has-search .form-control-feedback {
    ...
    color: #ccc;
        ...
        .item10, .item11, .item12,#Button1,
        .item9b, .item9a1, .item9a2, .item9a3, .item9a4, .itemFly,.item47b,.item53b,.item88d3,.item88d2,.item88d7,.item4b,.item4bb,
        #sub1, #subPro1, #sub2, #subPro2, #sub3, #subPro3, #sub4, #subPro4, #stay,#item577,.item88d6,.item88d5,.item88d4,
	...
	.modal form label {
        ...
        #TextBoxSP3IDType, #SubP3AMobileTextBox, #SubP3CCDropDownList2, #SubP3MobileTextBox, #SubP3CCDropDownList, #TextSP3Age, #SubP3CountryDropDownList,#subGroup,#leadOffice,
    ...
    <script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js"></script>
      ...
      <script>
        ...
        $(document).ready(function () {
            var id = $("#VenueCountryDropDownList option:selected").text();
         ...
         //   alert(venueGroup);
            ...
            if (id == "India" || id == "INDIA") {
                ...
                $('.item5a').css({ 'display': 'none' });
                $('.item8').css({ 'display': 'none' });
                $('.item9').css({ 'display': 'none' });
                $('.item9b').css({ 'display': 'none' });
                $('.item10').css({ 'display': 'block' });

                $('.item11').css({ 'display': 'block' });
                $('.item12').css({ 'display': 'block' });
                   
                $('.item3a').css({ 'display': 'none' });
                $('.item9a1').css({ 'display': 'none' });

                $('.item9a2').css({ 'display': 'none' });
                $('.item9a3').css({ 'display': 'none' });

                $('.item9a4').css({ 'display': 'none' });
                $('.itemFly').css({ 'display': 'none' });

                $('.Primchs').css({ 'display': 'none' });
                $('.Prihidden').css({ 'display': 'none' });

                $('.item313').css({ 'display': 'block' });
                $('.item312').css({ 'display': 'block' });
                $('.itemHome313').css({ 'display': 'block' });
                $('.itemHome312').css({ 'display': 'block' });
                 
                $('.item37a').css({ 'display': 'block' });
                $('.item377').css({ 'display': 'block' });
                $('.item47b').css({ 'display': 'block' });
                $('.item47a').css({ 'display': 'block' });
                    ...
                    var marketingValuepro = $("#MarketingPrgmDropDownList option:selected").text();
                //alert(marketingValue);
                    if (marketingValuepro == "OWNER" || marketingValuepro == "Owner" || marketingValuepro == "owner") {
     ...
     <script>
            ...
            $("#VenueCountryDropDownList").change(function () {
             ...
             //   alert(id);
                $.ajax({
                    ...
                    url: "EditProfile1.aspx/PopulateVenueDropDownList",
                    data: "{'id': '" + id + "'}",
                    dataType: "json",
                ...
                $.ajax({
                    ...
                    type: 'post',
                    contentType: "application/json; charset=utf-8",
                    url: 'EditProfile1.aspx/PopulatePriTitleDropDownList',
                    data: "{'countryName':'" + id + "'}",
                    async: false,
                    success: function (data) {
                        //  alert(data.d);
                ...
                $.ajax({
                    ...
                    type: 'post',
                    contentType: "application/json; charset=utf-8",
                    url: 'EditProfile1.aspx/PopulateNationalityDropDownList',
                    data: "{'countryName':'" + id + "'}",
                    async: false,
                    success: function (data) {
                        //  alert(data.d);
                ...
                $.ajax({
                    ...
                    type: 'post',
                    contentType: "application/json; charset=utf-8",
                    url: 'EditProfile1.aspx/PopulateAddressCountryDropDownList',
                    data: "{'countryName':'" + id + "'}",
                    async: false,
                    success: function (data) {
                        //  alert(data.d);
                ...
                $.ajax({
                    ...
                    type: 'post',
                    contentType: "application/json; charset=utf-8",
                    url: 'EditProfile1.aspx/PopulateGiftOptionDropDownList',
                    data: "{'countryName':'" + id + "'}",
                    async: false,
                    success: function (data) {
                        //  alert(data.d);
        ...
        $(document).ready(function () {
            $("#VenueDropDownList").change(function () {
                var id = $("#VenueDropDownList option:selected").text();

                var id2 = $("#VenueCountryDropDownList option:selected").text();

                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    //url is the path of our web method (Page name/function name)
                    url: "EditProfile1.aspx/PopulateVenueGroupDropDownList",
                ...
                $.ajax({
                    ...
                    type: 'post',
                    contentType: "application/json; charset=utf-8",
                    url: 'EditProfile1.aspx/LoadManagersOnVenue',
             ...
             //   alert(id2);
              ...
              document.getElementById("QStatusDropDownList1").selectedIndex = "0";
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    //url is the path of our web method (Page name/function name)
                    url: "EditProfile1.aspx/PopulateSubVenueGroupDropDownList",
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    //url is the path of our web method (Page name/function name)
                    url: "EditProfile1.aspx/PopulateMrktProgDropDownList",
                ...
                if (id2 == "India" || id2=="INDIA") {
                    $.ajax({
                        ...
                        type: 'post',
                        contentType: "application/json; charset=utf-8",
                        url: 'EditProfile1.aspx/LoadAgentsOnVenuegrp',
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        contentType: "application/json; charset=utf-8",
                        url: 'EditProfile1.aspx/LoadTOOnVenueNVGrp',
                        data: "{'venueCountry':'" + id2 + "','vgrp':'" + id + "','venue':'" + id3 + "'}",
                        async: false,
                        success: function (data) {
                            // alert(data.d);
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    //url is the path of our web method (Page name/function name)
                    url: "EditProfile1.aspx/SalesRepTypeList",
                    data: "{'venueid': '" + id + "','countid' : '" + id2 + "','venue' : '" + id3 + "'}",
                    dataType: "json",
                    //called on jquery ajax call success
                    success: function (data) {
        ...
        $(document).ready(function () {
            $("#MarketingPrgmDropDownList").change(function () {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    //url is the path of our web method (Page name/function name)
                    url: "EditProfile1.aspx/PopulateAgentDropDownList",
        ...
        $(document).ready(function () {
            $("#AgentsDropDownList").change(function () {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    //url is the path of our web method (Page name/function name)
                    url: "EditProfile1.aspx/PopulateAgentCodeDropDownList",
            ...
            $("#primarynationalityDropDownList").change(function () {
                ...
                var countryID = $("#VenueCountryDropDownList option:selected").text();
                // alert("hi");
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    //url is the path of our web method (Page name/function name)
                    url: "EditProfile1.aspx/PopulateCountryCodeDropDownList",
                ...
                var groupVenue = $("#GroupVenueDropDownList option:selected").text();
                var venue = $("#VenueDropDownList option:selected").text();
                var SubVenue = $("#VenueDropDownList2 option:selected").text();
               // alert(groupVenue);
              //  alert(venue);
              //  alert(SubVenue);
                if (venue == "Jimbaran Sales Deck" && groupVenue == "Coldline" && SubVenue != "KCV1" || venue == "JIMBARAN SALES DECK" && groupVenue == "COLDLINE" && SubVenue != "KCV1") {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        //url is the path of our web method (Page name/function name)
                        url: "EditProfile1.aspx/PopulateSubVenueOnNationality",
                        data: "{'id1': '" + id1 + "'}",
                        dataType: "json",
                        //called on jquery ajax call success
                        success: function (data) {
            ...
            $("#secondarynationalityDropDownList").change(function () {
                ...
                var countryID = $("#VenueCountryDropDownList option:selected").text();
                var id = $("#secondarynationalityDropDownList option:selected").text();
            ...
            $("#subprofile1nationalityDropDownList").change(function () {
                ...
                var countryID = $("#VenueCountryDropDownList option:selected").text();
                var id = $("#subprofile1nationalityDropDownList option:selected").text();
            ...
            $("#subprofile2nationalityDropDownList").change(function () {
                ...
                var countryID = $("#VenueCountryDropDownList option:selected").text();
                var id = $("#subprofile2nationalityDropDownList option:selected").text();
            ...
            $("#SubP3NationalityDropDownList").change(function () {
                ...
                var countryID = $("#VenueCountryDropDownList option:selected").text();
                var id = $("#SubP3NationalityDropDownList option:selected").text();
            ...
            $("#SubP4NationalityDropDownList").change(function () {
                ...
                var countryID = $("#VenueCountryDropDownList option:selected").text();
                var id = $("#SubP4NationalityDropDownList option:selected").text();
        ...
        $(document).ready(function () {
            $("#PrimaryCountryDropDownList").change(function () {
                var value = $("#PrimaryCountryDropDownList option:selected").text();

                $.ajax({

                    type: 'post',
                    contentType: "application/json; charset=utf-8",
                    url: 'EditProfile1.aspx/LoadCountryCode',
                    data: "{'country':'" + value + "'}",
                    async: false,
                    success: function (data) {
            ...
            $("#SecondaryCountryDropDownList").change(function () {
                var value = $("#SecondaryCountryDropDownList option:selected").text();
            ...
            $("#SubProfile1CountryDropDownList").change(function () {
                var value = $("#SubProfile1CountryDropDownList option:selected").text();
            ...
            $("#SubProfile2CountryDropDownList").change(function () {
                var value = $("#SubProfile2CountryDropDownList option:selected").text();
            ...
            $("#SubP3CountryDropDownList").change(function () {
                var value = $("#SubP3CountryDropDownList option:selected").text();
            ...
            $("#SubP4CountryDropDownList").change(function () {
                var value = $("#SubP4CountryDropDownList option:selected").text();
            ...
            $("#AddCountryDropDownList").change(function () {
                ...
                var value = $("#AddCountryDropDownList option:selected").text();
                $.ajax({

                    type: 'post',
                    contentType: "application/json; charset=utf-8",
                    url: 'EditProfile1.aspx/LoadStates',
                    data: "{'country':'" + value + "'}",
                    async: false,
                    success: function (data) {
                        //alert(data.d);
            ...
            $("#MarketingPrgmDropDownList").change(function () {
                ...
                var marketingValue = $("#MarketingPrgmDropDownList option:selected").text();
                //alert(marketingValue);
                ...
                $.ajax({
                    ...
                    type: 'post',
                    contentType: "application/json; charset=utf-8",
                    url: 'EditProfile1.aspx/LoadTypes',
                    data: "{}",
                    async: false,
                    success: function (data) {
                        //alert(data.d);
                                          ...
                                          <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2 item34">
                                            <label for="sel1">Date Of Birth:</label>
                                              <div class="input-group date" id="pdobdatepicker1"  data-provide="datepicker">
                                                  <asp:TextBox ID="pdobdatepicker" class="form-control pull-right" style="pointer-events:none;" runat="server"></asp:TextBox>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2 item44">
                                              ...
                                              <div class="input-group date" id="sdobdatepicker1" data-provide="datepicker">
                                                  <asp:TextBox ID="sdobdatepicker" class="form-control pull-right" Style="pointer-events: none;" runat="server"></asp:TextBox>
                                                  <div class="input-group-addon">
                                                      <%--  <span class="glyphicon glyphicon-th" ></span>--%>
                                                  </div>
                                              </div>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2 item64">
                                                  ...
                                                  <div class="input-group date" id="sp1dobdatepicker1" data-provide="datepicker">
                                                      <asp:TextBox ID="sp1dobdatepicker" class="form-control pull-right" style="pointer-events:none;" runat="server"></asp:TextBox>
                                                      <div class="input-group-addon">
                                                          <%--  <span class="glyphicon glyphicon-th" ></span>--%>
                                                      </div>
                                                  </div>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2 item74">
                                                  ...
                                                  <div class="input-group date" id="sp2dobdatepicker1" data-provide="datepicker">
                                                      <asp:TextBox ID="sp2dobdatepicker" class="form-control pull-right" Style="pointer-events: none;" runat="server" ></asp:TextBox>
                                                      <div class="input-group-addon">
                                                          <%--  <span class="glyphicon glyphicon-th" ></span>--%>
                                                      </div>
                                                  </div>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2 item9s34">
                                                  ...
                                                  <div class="input-group date" id="SubP3DOB1" data-provide="datepicker">
                                                      <asp:TextBox ID="SubP3DOB" class="form-control pull-right" style="pointer-events:none;" runat="server" ></asp:TextBox>
                                                      <div class="input-group-addon">
                                                          <%--  <span class="glyphicon glyphicon-th" ></span>--%>
                                                      </div>
                                                  </div>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2 item9s4s4">
                                                  ...
                                                  <div class="input-group date" id="SubP4DOB1" data-provide="datepicker">
                                                      <asp:TextBox ID="SubP4DOB" class="form-control pull-right" Style="pointer-events: none;" runat="server"></asp:TextBox>
                                                      <div class="input-group-addon">
                                                          <%--  <span class="glyphicon glyphicon-th" ></span>--%>
                                                      </div>
                                                  </div>
                                   ...
                                   <div class="container-fluid">
                                      <div class="row">
                                          ...
                                          <div class="col-md-3 col-xs-12 col-sm-8 col-lg-3">
                                           ...
                                           <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2">
                                              <div class="form-group">
                                                    <asp:Button ID="Button1" class="btn btn-success" runat="server" OnClick="Button1_Click" Text="Update Profile" />
...
<%--     <script>
      ...
      <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'EditProfile1.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'EditProfile1.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
          ...
          //  alert("hiee");
           ...
           // alert(prid);
            $.ajax({
                ...
                type: 'post',
                contentType: "application/json; charset=utf-8",
                url: 'EditProfile1.aspx/primaryl',
                data: "{'prid':'"+prid+"'}",
                async: false,
                success: function (data) {
                     //alert(data.d);
            ...
            $.ajax({
                ...
                type: 'post',
                contentType: "application/json; charset=utf-8",
                url: 'EditProfile1.aspx/Secondarylang',
                data: "{'prid':'" + prid + "'}",
                async: false,
                success: function (data) {
                    //alert(data.d);
            ...
            $.ajax({
                ...
                type: 'post',
                contentType: "application/json; charset=utf-8",
                url: 'EditProfile1.aspx/PhotoIdentity',
                data: "{'prid':'" + prid + "'}",
                async: false,
                success: function (data) {
                    //alert(data.d);
            ...
            $.ajax({
                ...
                type: 'post',
                contentType: "application/json; charset=utf-8",
                url: 'EditProfile1.aspx/CardType',
                data: "{'prid':'" + prid + "'}",
                async: false,
                success: function (data) {
                    //alert(data.d);
            ...
            $.ajax({
                ...
                type: 'post',
                contentType: "application/json; charset=utf-8",
                url: 'EditProfile1.aspx/loadsubVenueGroup',
                data: "{'prid':'" + prid + "'}",
                async: false,
                success: function (data) {
                    //alert(data.d);
                    ...
                    $.each(subJson, function (key, value) {
                        $.each(value, function (index1, value1) {
                            ...
                            $("#subGroup option[value='" + value1[0] + "']").prop('selected', true);
                        });
                    });
                },
                error: function () {
    ...
    <script>
        ...
        function showflybuys() {
           ...
           if(id2=="Indonesia" || id2=="INDONESIA"){
      ...
      <script>
           ...
           $(window).on("load", function () {
               ...
               $.ajax({
                   ...
                   contentType: "application/json; charset=utf-8",
                   //url is the path of our web method (Page name/function name)
                   url: "EditProfile1.aspx/totalgift",
                   data: "{}",
                   dataType: "json",
                   //called on jquery ajax call success
                   success: function (data) {
