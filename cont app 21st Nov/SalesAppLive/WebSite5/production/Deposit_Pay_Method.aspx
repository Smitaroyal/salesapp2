<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Deposit_Pay_Method.aspx.cs" Inherits="WebSite5_production_Deposit_Pay_Method" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#ID,#head,#payMethod,#Office,#directory,#insert,#Status{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD DEPOSIT PAY METHOD</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="payMethod">
                  <div class="form-group">
                      <label for="sel1">Pay Method:</label>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h3 class="text-center">DEPOSIT PAY METHOD DIRECTORY</h3>
                               </div>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Deposit_Pay_Method.aspx/insertPayMethod',
                    contentType:"application/json; charset=utf-8",
                    data: "{'payMethod':'" + payMethod + "','office':'" + office + "'}",
                    async: false,
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Deposit_Pay_Method.aspx/getAllDepositPayMethod',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    var payMethod = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + payMethod + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Deposit_Pay_Method.aspx/deletePayMethod',
                            contentType: "application/json; charset=utf-8",
                            data: "{'ID':'" + ID + "','payMethod':'" + payMethod + "'}",
                            async: false,
                            success: function (data) {
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
                                    $("#success-alert").slideUp(500);
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Deposit_Pay_Method.aspx/updatePayMethod',
                        contentType: "application/json; charset=utf-8",
                        data: "{'ID':'" + ID + "','payMethod':'" + payMethod + "','status':'" + status + "','office':'" + office + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
