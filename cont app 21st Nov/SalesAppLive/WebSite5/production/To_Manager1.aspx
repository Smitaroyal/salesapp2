...
.has-search .form-control {
    ...
    padding-left: 34px;
     ...
     .title{
      ...
      #update,#toManagerID,#head,#toManagerName,#Office,#managerstatus,#directory,#insert,#Venue,#vCountry,#description,#Manager{
          display:none;
      }
      #TextBox5{
          text-align:center;
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h3 class="text-center">ADD TO MANAGER</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="toManagerID">
               ...
               <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="toManagerName">
                  <div class="form-group">
                      <label for="sel1">TO Manager:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter To Manager" runat="server"></asp:TextBox>
                  </div>
              </div>
               ...
               <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="managerstatus">
                  <div class="form-group">
               ...
               <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="vCountry">
                  <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                if (toManagerName == "" || toManagerName == null) {
                    toManagerName = "";
                } else {
                    toManagerName = $("#TextBox2").val();
                }
                ...
                if (toManagerOffice == "" || toManagerOffice == null) {
                    toManagerOffice = "";
                } else {
                    toManagerOffice = $("#office").val();
                }
              //  var status = $("#status").val();

                var venueCountryID = $("#venuecountry").val();
                if (venueCountryID == "" || venueCountryID == null) {
                    venueCountryID = "";
                } else {
                    venueCountryID = $("#venuecountry").val();
                }

                var venueCountryName = $("#venuecountry option:selected").text();
                if (venueCountryName == "" || venueCountryName == null) {
                    venueCountryName = "";
                } else {
                    venueCountryName = $("#venuecountry option:selected").text();
                }
                ...
                $.ajax({
                    ...
                    data: "{'tomanagername':'" + toManagerName + "','tomanageroffice':'" + toManagerOffice + "','venueCountryID':'" + venueCountryID + "','venue':'" + venue + "','description':'" + description + "','venueCountryName':'" + venueCountryName + "','manager':'" + manager + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var venuecountryID = row.find("td:eq(6)").text();
                           ...
                           // alert(data.d);
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[7] + "</td><td>" + value1[9] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td style='display:none;'>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td>" + value1[8] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
                ...
                $(document).on('click','.delete-btn',function () {
                    ...
                    if (confirmation) {
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            data: "{'toManagerID':'" + ToManagerID + "','ToManagerName':'" + ToManagerName + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    if (toManagerStatus == "" || toManagerStatus == null) {
                        toManagerStatus = "";
                    } else {
                        toManagerStatus = $("#status").val();
                    }
                    var venuecountry = $("#venuecountry").val();
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'toManagerID':'" + toManagerID + "','toManagername':'" + toManagerName + "','office':'" + office + "','toManagerstatus':'" + toManagerStatus + "','venue':'" + venue + "','venuecountry':'" + venuecountry + "','description':'" + description + "','manager':'" + manager + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'To_Manager1.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'To_Manager1.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
