                                                    ...
                                                    <table class="table table-hover" id="task-table8">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="TextBox7" class="form-control pull-right" Style="height: 26px;" runat="server"></asp:TextBox></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="TextBox32" class="form-control pull-right" Style="height: 26px;" runat="server"></asp:TextBox></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="TextBox34" class="form-control pull-right" Style="height: 26px;" runat="server"></asp:TextBox></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                <td>
                                                                    <h6 id="staff">STAFF</h6>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="TextBox37" class="form-control pull-right" Style="height: 26px;" runat="server"></asp:TextBox></td>
                                                                <td>
                                                                    <asp:TextBox ID="TextBox38" class="form-control pull-right" Style="height: 26px;" runat="server"></asp:TextBox></td>
                                                                <td>
                                                                    <asp:TextBox ID="TextBox39" class="form-control pull-right" Style="height: 26px;" runat="server"></asp:TextBox></td>
                                                                <td>
                                                                    <asp:TextBox ID="TextBox40" class="form-control pull-right" Style="height: 26px;" runat="server"></asp:TextBox></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var staffOccu = $("#TextBox37").val();
                var staffUniq = $("#TextBox38").val();
                var staffTour = $("#TextBox39").val();
                var staffDeal = $("#TextBox40").val();


                var val = ody + "," + exc + "," + fly + "," + wd2 + "," + markt + "," + hotel + "," + other + "," + kcv1+","+Staff;
                var val1 = odyOccu + "," + excOccu + "," + flyOccu + "," + wd2Occu + "," + marktOccu + "," + hotelOccu + "," + otherOccu + "," + kcv1Occu+","+staffOccu;
                var val4 = odyUniq + "," + excUniq + "," + flyUniq + "," + wd2Uniq + "," + marktUniq + "," + hotelUniq + "," + otherUniq + "," + kcv1Uniq+","+staffUniq;
                var val2 = odyTour + "," + excTour + "," + flyTour + "," + wd2Tour + "," + marktTour + "," + hotelTour + "," + otherTour + "," + kcv1Tour+","+staffTour;
                var val3 = odyDeal + "," + excDeal + "," + flyDeal + "," + wd2Deal + "," + marktDeal + "," + hotelDeal + "," + otherDeal + "," + kcv1Deal+","+staffDeal;
                ...
                $.ajax({
                    ...
                    contentType:"application/json; charset=utf-8",
                    data: "{'groupvenue':'" + groupvenue + "','date':'" + date + "','val':'" + val + "','val1':'" + val1 + "','val2':'" + val2 + "','val3':'" + val3 + "','val4':'" + val4 + "'}",
                    async: false,
                    success: function (data) {
                       // alert(data.d);
                        $("#venue").val('');
     ...
     <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var valID = vall0 + "," + vall1 + "," + vall2 + "," + vall3 + "," + vall4 + "," + vall5 + "," + vall6 + "," + vall7+","+vall8;
                    ...
                    var vallOcc8 = $("#occup8").val();

                    var valOccupied = vallOcc0 + "," + vallOcc1 + "," + vallOcc2 + "," + vallOcc3 + "," + vallOcc4 + "," + vallOcc5 + "," + vallOcc6 + "," + vallOcc7 + "," + vallOcc8;
                    ...
                    var vallUniq5 = $("#uniq5").val();
                    var vallUniq6 = $("#uniq6").val();
                    var vallUniq7 = $("#uniq7").val();
                    var vallUniq8 = $("#uniq8").val();

                    var valUnique = vallUniq0 + "," + vallUniq1 + "," + vallUniq2 + "," + vallUniq3 + "," + vallUniq4 + "," + vallUniq5 + "," + vallUniq6 + "," + vallUniq7+","+vallUniq8;
                    ...
                    var vallNtour8 = $("#ntours8").val();

                    var valNTours = vallNtour0 + "," + vallNtour1 + "," + vallNtour2 + "," + vallNtour3 + "," + vallNtour4 + "," + vallNtour5 + "," + vallNtour6 + "," + vallNtour7 + "," + vallNtour8;
                    ...
                    var vallNDeal8 = $("#ndeals8").val();

                    var valNDeals = vallNDeal0 + "," + vallNDeal1 + "," + vallNDeal2 + "," + vallNDeal3 + "," + vallNDeal4 + "," + vallNDeal5 + "," + vallNDeal6 + "," + vallNDeal7 + "," + vallNDeal8;
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'valID':'" + valID + "','valOccupied':'" + valOccupied + "','valNTours':'" + valNTours + "','valNDeals':'" + valNDeals + "','valUnique':'" + valUnique + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $('#datepicker2').datepicker('setDate', null);
