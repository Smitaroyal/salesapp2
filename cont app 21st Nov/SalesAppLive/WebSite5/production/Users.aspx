...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="container-fluid">
          <div class="row"> 
              <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="userName">
              ...
              <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="Password">
                  <div class="form-group">
                 ...
                 <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="Name">
                  <div class="form-group">
          ...
          <div class="container-fluid">
            <div class="row">
                 <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="Email">
                  <div class="form-group">
               ...
               <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="userStatus">
                  <div class="form-group">
              ...
              <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="Department">
                  <div class="form-group">
