<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Flybuy_Agent.aspx.cs" Inherits="WebSite5_production_Flybuy_Agent" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#fly_Agent_Name,#head,#fly_Agent_ID,#Status,#directory,#insert{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD TELEMARKETING AGENT</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="fly_Agent_ID">
                  <div class="form-group">
                      <label for="sel1">Telemarketing Agent ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="fly_Agent_Name">
                  <div class="form-group">
                      <label for="sel1">Telemarketing Agent :</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Agent" runat="server"></asp:TextBox>
                  </div>
              </div>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center"> TELEMARKETING AGENT DIRECTORY</h4>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var isValid = true;
                var flyAgentName = $("#TextBox2").val();
                if (flyAgentName == "" || flyAgentName == "") {
                    flyAgentName = "";
                    isValid = false;
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Flybuy_Agent.aspx/insertFlybuy_Agent',
                    contentType:"application/json; charset=utf-8",
                    data: "{'flyAgentName':'" + flyAgentName + "','flyAgentName':'" + flyAgentName + "'}",
                    async: false,
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Flybuy_Agent.aspx/getAllFlybuy_Agent',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var flyAgentID = row.find("td:eq(0)").text();
                    var flyAgentName = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + flyAgentName + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Flybuy_Agent.aspx/deleteFlybuy_Agent',
                            contentType: "application/json; charset=utf-8",
                            data: "{'flyAgentID':'" + flyAgentID + "','flyAgentName':'" + flyAgentName + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var flyAgentID = $("#TextBox1").val();
                    var flyAgentName = $("#TextBox2").val();
                
                    var status = $("#status").val();

                    if (flyAgentName == "" || flyAgentName == null) {
                        flyAgentName = "";
                    } else {
                        var flyAgentName = $("#TextBox2").val();
                    }
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Flybuy_Agent.aspx/updateFlybuy_Agent',
                        contentType: "application/json; charset=utf-8",
                        data: "{'flyAgentID':'" + flyAgentID + "','flyAgentName':'" + flyAgentName + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Flybuy_Agent.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Flybuy_Agent.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
