<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DSR_INDIA_Accounts.aspx.cs" Inherits="WebSite5_production_DSR_INDIA" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h5 class="text-center">DAILY SUMMARY</h5>
                            </div>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-xs-12 col-sm-12 col-lg-8" id="">
                                <div class="row">
                                    <div class="col-md-4 col-xs-12 col-sm-12 col-md-4" id="">
   ...
   <script>
            ...
            $("#country").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA_Accounts.aspx/getVenue',
                    ...
                    success: function (data) {
                        ...
                        $("#venue").empty();
                        $("#venue").append("<option value=''>--Select an Option--</option>");
            ...
            $("#venue").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA_Accounts.aspx/getVenueGroup',
                    contentType: "application/json; charset=utf-8",
                    data: "{'Venue':'" + Venue + "'}",
                    async: false,
                    success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'DSR_INDIA_Accounts.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA_Accounts.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA_Accounts.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
