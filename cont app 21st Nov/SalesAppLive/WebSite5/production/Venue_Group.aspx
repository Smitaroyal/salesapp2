...
.has-search .form-control {
    ...
    .title{
      ...
      #update,#venueGroupID,#venueGroupCode,#Venue,#head,#venueGroupName,#venueGroupStatus,#directory,#insert{
          display:none;
      }
      #TextBox5{
          text-align:center;
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="venueGroupID">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3 " id="venueGroupName">
                  <div class="form-group">
                      <label for="sel1">Venue Group Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Venue Group" runat="server"></asp:TextBox>
                  </div>
              </div>
                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3 " id="venueGroupCode">
                  <div class="form-group">
                      <label for="sel1">Venue Group Code:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="Enter Venue Group Code" runat="server"></asp:TextBox>
                  </div>
              </div>

               <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="venueGroupStatus">
                  <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                if (venueGroupName == "" || venueGroupName == null) {
                    venueGroupName = "";
                } else {
                    venueGroupName = $("#TextBox2").val();
                }
                var venueGroupCode = $("#TextBox3").val();
                if (venueGroupCode == "" || venueGroupCode == null) {
                    venueGroupCode = "";
                } else {
                    venueGroupCode = $("#TextBox3").val();
                }
                ...
                $.ajax({
                    ...
                    data: "{'venueGroupName':'" + venueGroupName + "','venue':'" + Venue + "','venueGroupCode':'" + venueGroupCode + "'}",
                    async: false,
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    if (confirmation) {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            data: "{'venueGroupID':'" + venueGroupID + "','venueGroupName':'" + venueGroupName + "'}",
                            async: false,
                            success: function (data) {
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Venue_Group.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Venue_Group.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
