<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Flybuy_Verification.aspx.cs" Inherits="WebSite5_production_Flybuy_Verification" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#fly_Verification,#head,#fly_Verification_ID,#Status,#directory,#insert{
             display:none;
         }
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h3 class="text-center">ADD VERIFICATION</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="fly_Verification_ID">
                  <div class="form-group">
                      <label for="sel1">Verification ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>
             
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="fly_Verification">
                  <div class="form-group">
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center">VERIFICATION DIRECTORY</h4>
                               </div>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Flybuy_Verification.aspx/insertFlybuy_Verification',
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Flybuy_Verification.aspx/getAllFlybuy_Verification',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var flyVerificationID = row.find("td:eq(0)").text();
                    var flyVerification = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + flyVerification + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Flybuy_Verification.aspx/deleteFlybuy_Verification',
                            contentType: "application/json; charset=utf-8",
                            data: "{'flyVerificationID':'" + flyVerificationID + "','flyVerification':'" + flyVerification + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var fly_Verification_ID = $("#TextBox1").val();
                    var fly_Verification = $("#TextBox2").val();
                
                    var status = $("#status").val();

                    if (fly_Verification == "" || fly_Verification == null) {
                        fly_Verification = "";
                    } else {
                        var fly_Verification = $("#TextBox2").val();
                    }
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Flybuy_Verification.aspx/updateFlybuy_Verification',
                        contentType: "application/json; charset=utf-8",
                        data: "{'fly_Verification_ID':'" + fly_Verification_ID + "','fly_Verification':'" + fly_Verification + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
       ...
       <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Flybuy_Verification.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Flybuy_Verification.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Flybuy_Verification.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
