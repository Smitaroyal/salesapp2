<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DealsAdminReport.aspx.cs" Inherits="WebSite5_production_Reports" %>
...
.has-search .form-control {
    ...
    .title{
      ...
      font-style:oblique;
        ...
        #success-alert,#danger-alert,#menu_toggle,#profileDetails{
            display:none;
        }
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h3 class="text-center">DEALS GONE THROUGH REPORT</h3>
          </div>
          </div>
                </div>
                       <br />
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-4 col-xs-12 col-sm-12 col-lg-4" id="">
                                ...
                                <div class="col-md-8 col-xs-12 col-sm-12 col-lg-8" id="">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4" id="date">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4" id="edate">
                                            <label for="sel1">Select Date:</label>
                                            <div class="input-group date" id="datepicker2" data-provide="datepicker">
                                                <asp:TextBox ID="TextBox1" placeholder="Select Date" class="form-control" runat="server"></asp:TextBox>
                                                <div class="input-group-addon">
                                                    <span class="glyphicon glyphicon-th"></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2 col-xs-9 col-lg-2">
                                            ...
                                            <asp:Button ID="Button2" runat="server" OnClick="Button1_Click" class="btn btn-primary pull-right btn-block" Text="Preview" />

                                            <%-- <button type="button" runat="server" id="insert" class="btn btn-primary pull-right btn-block">Generate</button>--%>
                                        </div>
                                         <div class="col-md-2 col-sm-2 col-xs-9 col-lg-2">
                                            <label for="sel1">&nbsp;</label>
                                            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" class="btn btn-primary pull-right btn-block" Text="Export" />
                                    ...
                                    <br />
                                            ...
                                            <div class="row">
                                        <div class="col-md-8 col-sm-12 col-xs-12 col-lg-8" id="">
                                      <asp:Panel ID="Panel2" runat="server" Height="302px" ScrollBars="Both" 
                    Width="967px">
                    <asp:GridView ID="GridView2" runat="server" Font-Names="Times New Roman" 
                        Font-Size="Small" Width="168px">
                    </asp:GridView>
                </asp:Panel>
                                             </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'DealsAdminReport.aspx/getAdminRights',
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DealsAdminReport.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DealsAdminReport.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
