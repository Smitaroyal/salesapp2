...
public partial class WebSite5_production_SeapConsoVenueIndia : System.Web.UI.Page
{
    ...
    private void show_report(string country,string venue)
    {
        ...
        DataTable dt1 = Queries.SeapConsovenueindia(TextBox1.Text, country, venue);
        DataTable dt2 = Queries.seapdateindia(TextBox1.Text);
        ...
        ReportViewer1.LocalReport.ReportPath = "reports/seapConsoOnVenueIndia.rdlc";
