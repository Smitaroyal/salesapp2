...
public partial class WebSite5_production_BaliConsolidated : System.Web.UI.Page
{
    ...
    private void show_report(string country)
    {
        ...
        DateTime dt = DateTime.ParseExact(TextBox4.Text, "dd-MM-yyyy", CultureInfo.InvariantCulture);
        string date = dt.ToString("yyyy-MM-dd");
        ReportViewer1.Reset();

        DataTable dt1 = Queries2.Seapconsolcountry(date, country);
	...
	ReportViewer1.LocalReport.DisplayName = "SEAP. BALI. CONSOLIDATED RECAP." + dt.ToString("dd-MMM-yyyy");
