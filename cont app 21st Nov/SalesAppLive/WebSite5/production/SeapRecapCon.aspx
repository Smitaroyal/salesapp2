<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SeapRecapCon.aspx.cs" Inherits="WebSite5_production_SeapRecapCon" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h5 class="text-center">SEAP. RECAP COLDLINE</h5>
                            </div>
                        </div>
                    </div>
                    <br />
   ...
   <script>
        ...
        $(document).ready(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapRecapCon.aspx/getVenueGroup',
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'SeapRecapCon.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'SeapRecapCon.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
