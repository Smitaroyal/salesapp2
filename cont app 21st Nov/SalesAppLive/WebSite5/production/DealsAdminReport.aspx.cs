...
public partial class WebSite5_production_Reports : System.Web.UI.Page
{
    ...
    public void gridviewdisplay(DataSet ds)
    {
    ...
    private void show_report(string date,string edate, string office,string venue)
    {

        //  DataTable ds = Queries.DealsGoneThroughReport(date, "HML", venue);
        DataTable ds = Queries.DealsGoneThroughDateRangeReport(date, edate, "HML", venue);
       ...
       // string part = currdt.Day.ToString() + currdt.Month.ToString() + currdt.Year.ToString();
        string fn = "DealsGoneThrough_" + date + ".xls";

           Response.AddHeader("content-disposition", "attachment;filename=" + fn + "");
      //  Response.AddHeader("content-disposition", "attachment;filename=DealsGoneThrough_.xls");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string edate = Request.Form["TextBox1"];
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        string venue = Request.Form["venue"];
        string office = Request.Form["office"];
        show_report(date, edate, office, venue);
    ...
    public string getvenue()
    {
        string htmlstr = "";
        string conn = ConfigurationManager.ConnectionStrings["DBConnectionString"].ConnectionString;
        string query = "select Venue_Name from venue where Venue_Country_ID='VC4' and Venue_Status='Active'";
        SqlConnection sqlcon = new SqlConnection(conn);
        sqlcon.Open();
        SqlCommand cmd = new SqlCommand(query, sqlcon);
        SqlDataReader reader = cmd.ExecuteReader();
