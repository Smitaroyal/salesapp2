    ...
    .title{
      ...
      font-style:oblique;
        ...
        #success-alert,#danger-alert,#danger-alert1,#Office,#menu_toggle,#profileDetails{
          ...
          #update,#venueCountryID,#head,#venueCountryName,#venueCountryStatus,#directory,#insert{
             display:none;
         }
          #TextBox5{
          text-align:center;
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3"  id="venueCountryID">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="venueCountryName">
                  <div class="form-group">
                      <label for="sel1">Venue Country Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Venue Country" runat="server"></asp:TextBox>
                  </div>
              </div>

               <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="venueCountryStatus">
                  <div class="form-group">
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    data: "{'venuecountryname':'" + venueCountryName + "','office':'" + office + "'}",
                    async: false,
                ...
                $(document).on('click', '.delete-btn', function () {
                    ...
                    if (confirmation) {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            data: "{'venueCountryID':'" + venueCountryID + "','venueCountryName':'" + venueCountryName + "'}",
                            async: false,
                            success: function (data) {
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
                                    $("#success-alert").slideUp(500);
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'venuecountryID':'" + venueCountryID + "','venuecountryName':'" + venueCountryName + "','status':'" + status + "','office':'" + office + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'VenueCountry.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'VenueCountry.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
