...
public partial class WebSite5_production_Property_Fee : System.Web.UI.Page
{
    ...
    public static void insertPropertyFee( string propertyPerYear ,string memberFee,string ChargeYear)
    {
        ...
        string query = "insert into Property_fee_charge([charge_ID],[charge_No_Of_Points],[charge_Property_fee_per_year],[charge_Property_fee],[charge_member_fee],[charge_total_charge],[charge_year],[charge_status],[charge_Insert_Date],[charge_Expiry_Date]) values('" + propertyFeeID + "','0','"+ propertyPerYear + "','0','" + memberFee + "','0','" + ChargeYear + "','Active','"+time.ToString(format)+"','');";
