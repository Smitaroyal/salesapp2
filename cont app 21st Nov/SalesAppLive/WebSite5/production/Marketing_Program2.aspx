<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Marketing_Program2.aspx.cs" Inherits="WebSite5_production_Marketing_Program2" %>
...
.has-search .form-control {
    ...
    #success-alert,#danger-alert,#danger-alert1,#menu_toggle,#profileDetails{
      ...
      #update,#head,#marktID,#marktName,#marktStatus,#Venue2,#directory,#insert,#Type1,#MarktGroup,#MarktMainGroup,#Venue{
          display:none;
      }
      #TextBox5{
          text-align:center;
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="marktID">
              ...
              <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="marktName">
                  <div class="form-group">
                      <label for="sel1">Marketing Program Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Marketing Program" runat="server"></asp:TextBox>
                  </div>
              </div>
            ...
            <div class="row">
                 ...
                 <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="MarktGroup">
                  <div class="form-group">
                      <label for="sel1">Marketing Group:</label>
                      <select class="form-control"  id="marktGroups">
                          <option disabled selected value>Select an Option</option>
                          <option value="FBA">FBA</option>
                          <option value="FBI">FBI</option>
                            <option value="KCV1">KCV1</option>
                          <option value="KE Australia">KE Australia</option>
                            <option value="KE Indonesia">KE Indonesia</option>
                          <option value="Member Marketing">Member Marketing</option>
                            <option value="Odyssey">Odyssey</option>
                          <option value="OPC Booth">OPC Booth</option>
                            <option value="OPC Kuta">OPC Kuta</option>
                          <option value="OPC Seminyak">OPC Seminyak</option>
                      </select>
                  </div>
              </div>

                <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="MarktMainGroup">
                    <div class="form-group">
                        <label for="sel1">Marketing Group:</label>
                        <select class="form-control" id="marktmainGroups">
                            <option disabled selected value>Select an Option</option>
                            <option value="Coldline">Coldline</option>
                            <option value="Flybuy">Flybuy</option>
                   ...
                   <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="marktStatus">
                  <div class="form-group">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12  col-lg-12 " ">
              <h3 class="text-center">MARKETING PROGRAM DIRECTORY</h3>
          </div>
                        </div>
                        <div class="row">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var marktName = $("#TextBox2").val();
                if (marktName == "" || marktName == null) {
                    marktName = "";
                } else {
                    marktName = $("#TextBox2").val();
                }

                var venue2 = $("#venue2").val();
                if (venue2 == "" || venue2 == null) {
                    venue2 = "";
                } else {
                    venue2 = $("#venue2").val();
                }

                var marktGroup = $("#marktGroups").val();
                if (marktGroup == "" || marktGroup == null) {
                    marktGroup = "";
                } else {
                    marktGroup = $("#marktGroups").val();
                }

                var marktMainGroup = $("#marktmainGroups").val();
                if (marktMainGroup == "" || marktMainGroup == null) {
                    marktMainGroup = "";
                } else {
                    marktMainGroup = $("#marktmainGroups").val();
                }
                
                $.ajax({

                    type:'Post',
                    url: 'Marketing_Program2.aspx/insertMarkt',
                    contentType:"application/json; charset=utf-8",
                    data: "{'marktName':'" + marktName + "','venue2':'" + venue2 + "','marktGroup':'" + marktGroup + "','marktMainGroup':'" + marktMainGroup + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click', '.edit-btn', function () {
                    ...
                    var venue2_ID = row.find("td:eq(3)").text();
                    var marketing_group = row.find("td:eq(5)").text();
                    var marketing_main_group = row.find("td:eq(6)").text();
                    var venue = row.find("td:eq(7)").text();

                    $("#TextBox1").val(marktID);
                    $("#TextBox2").val(marktName);
                    $("#status option[value='" + status + "']").prop('selected', true);
                    $("#venue option[value='" + venue + "']").prop('selected', true);
                    $("#marktGroups option[value='" + marketing_group + "']").prop('selected', true);
                    $("#marktmainGroups option[value='" + marketing_main_group + "']").prop('selected', true);


                    $.ajax({
                        type: 'POST',
                        url: 'Marketing_Program2.aspx/getAllVenue2',
                        contentType: "application/json; charset=utf-8",
                        data: "{'venue':'" + venue + "'}",
                        async: false,
                        success: function (data) {
                    ...
                    $("#venue2 option[value='" + venue2_ID + "']").prop('selected', true);
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Marketing_Program2.aspx/getAllMarketing_Program',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td style='display:none;'>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td style='display:none;'>" + value1[7] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    if (confirmation) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'Marketing_Program2.aspx/deleteMarkt',
                            contentType: "application/json; charset=utf-8",
                            data: "{'marktID':'" + marktID + "','marktName':'" + marktName + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Marketing_Program2.aspx/updateMarkt',
                        contentType: "application/json; charset=utf-8",
                        data: "{'marktID':'" + marktID + "','marktName':'" + marktName + "','status':'" + status + "','venue2':'" + venue2 + "','marktGroup':'" + marktGroup + "','marktMainGroup':'" + marktMainGroup + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Marketing_Program2.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Marketing_Program2.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Marketing_Program2.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
