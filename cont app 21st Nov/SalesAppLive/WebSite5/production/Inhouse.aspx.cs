...
public partial class WebSite5_production_Inhouse : System.Web.UI.Page
{
    ...
    private void show_report(string country,string venue,string venueGroup)
    {
        if (country=="India" || country=="INDIA")
        {
            ...
            DataTable dt = Queries2.inhousegoa(date, venue, venueGroup);
            DataTable dt2 = Queries2.inhousesumdate(date);
            ReportDataSource rds = new ReportDataSource("DataSet1", dt);
            ReportDataSource rds2 = new ReportDataSource("DataSet2", dt2);

            ReportViewer2.LocalReport.DataSources.Add(rds);
            ReportViewer2.LocalReport.DataSources.Add(rds2);
            ReportViewer2.LocalReport.ReportPath = "reports/Inhousegoa.rdlc";

            ReportParameter[] rptParam = new ReportParameter[]
            {
              new ReportParameter("input",date),
        ...
        else
        {
            ...
            DataTable dt = Queries2.inhouse(date, country, venue, venueGroup);
            DataTable dt2 = Queries2.inhousedate(date);
            ReportDataSource rds = new ReportDataSource("DataSet1", dt);
            ReportDataSource rds2 = new ReportDataSource("DataSet2", dt2);
            ...
            ReportViewer2.LocalReport.ReportPath = "reports/Inhouse.rdlc";
		...
		ReportViewer2.LocalReport.DisplayName = "SEAP. BALI. INHOUSE RECAP " + venueGroup;
            ReportViewer2.LocalReport.Refresh();
            // ReportViewer2.LocalReport.Refresh();
