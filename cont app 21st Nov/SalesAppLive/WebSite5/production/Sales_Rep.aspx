        ...
        $(document).ready(function () {
           ...
           //     var status = $("#status").val();
                ...
                $.ajax({
                    ...
                    data: "{'saleRepName':'" + saleRepName + "','office':'" + office + "','venueCountry':'" + venueCountry + "','venue':'" + venue + "','description':'" + description + "','manager':'" + manager + "'}",
                    async: false,
                        ...
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[7] + "</td><td>" + value1[9] + "</td><td>" + value1[2] + "</td><td style='display:none'>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td>" + value1[8] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'salesRepID':'" + salesRepID + "','salesRepName':'" + salesRepName + "','status':'" + status + "','office':'" + office + "','venueCountryID':'" + venueCountryID + "','venue':'" + venue + "','description':'" + description + "','manager':'" + manager + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
