<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DSR_UD.aspx.cs" Inherits="WebSite5_production_DSR_UD" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h5 class="text-center">DSR UPGRADE / DOWNGRADE</h5>
                            </div>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-xs-12 col-sm-12 col-lg-8" id="">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4" id="UD">
                                        <div class="form-group">
                                            <label for="sel1">UD Venue:</label>
                                            <select class="form-control" name="ud" id="ud">
                                                   <option disabled selected value>--Select an Option--</option>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12" id="">
                                        <div class="form-group">
                                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="500px" Width="600px">
                                            </rsweb:ReportViewer>
                                        </div>
                                    </div>
                                </div>
