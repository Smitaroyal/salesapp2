...
public partial class WebSite5_production_Sales_Rep : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static void insertSalesRep(string saleRepName, string office, string venueCountry, string venue,string description,string manager)
    {
        ...
        if (venue== "Jimbaran Sales Deck")
        {
            ...
            string query = "insert into Sales_Rep ([Sales_Rep_ID],[Sales_Rep_Name],[Sales_Rep_Status],[Sales_Rep_Created_Date],[Venue_Country_ID],[Office],[Venue],[Description],[Group_Venue],Manager) values('" + salesRepID + "','" + saleRepName.ToUpper() + "','Active','" + time.ToString(format) + "','" + venueCountry + "','" + office + "','" + venue + "','" + description.ToUpper() + "','Coldline','"+manager.ToUpper()+"');";
            ...
            string details = "Sales Rep Created : Sales_Rep_Name: " + saleRepName + ", office: " + office + ", venueCountry: " + venueCountry + ", venue: " + venue + ", description: " + description+", Manager: "+manager.ToUpper();
        ...
        else
        {
            ...
            string query = "insert into Sales_Rep ([Sales_Rep_ID],[Sales_Rep_Name],[Sales_Rep_Status],[Sales_Rep_Created_Date],[Venue_Country_ID],[Office],[Venue],[Description],[Group_Venue],Manager) values('" + salesRepID + "','" + saleRepName.ToUpper() + "','Active','" + time.ToString(format) + "','" + venueCountry + "','" + office + "','" + venue + "','" + description.ToUpper() + "','','"+manager.ToUpper()+"');";
            SqlCommand cmd1 = new SqlCommand(query, sqlcon);
            cmd1.ExecuteNonQuery();
            ...
            string pageName = "Sales Rep";
            string details = "Sales Rep Created : Sales_Rep_Name: " + saleRepName.ToUpper() + ", office: " + office + ", venueCountry: " + venueCountry + ", venue: " + venue + ", description: " + description.ToUpper()+", Manager: "+manager.ToUpper();
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
    ...
    public static string getAllSalesRep()
    {
        ...
        while (reader.Read())
        {
            ...
            JSON += "[\"" + salesRepID + "\" , \"" + salesRepName + "\",\"" + status + "\",\"" + venueCountryID + "\",\"" + venueCountryName + "\",\"" + office + "\",\"" + venueName + "\",\"" + description + "\",\"" + Group_Venue + "\",\"" + manager + "\"],";
    ...
    [WebMethod]
    public static void updateSalesRep(string salesRepID, string salesRepName, string status, string office,string venueCountryID,string venue,string description,string manager)
    {
        ...
        if (status == "Active")
        {
            ...
            string query = "update Sales_Rep set [Sales_Rep_Name]='" + salesRepName.ToUpper() + "',[Sales_Rep_Status]='" + status + "',[Venue_Country_ID]='" + venueCountryID + "',[Office]='"+office+"',[Venue]='"+venue+"',[Description]='"+ description.ToUpper() + "',Manager='"+manager.ToUpper()+"' where [Sales_Rep_ID]='" + salesRepID + "';";
            SqlCommand cmd2 = new SqlCommand(query, sqlcon);
            cmd2.ExecuteNonQuery();
        }
        else
        {
            DateTime time = DateTime.Now;
            string format = "yyyy-MM-dd HH:mm:ss:sss";
            string query = "update Sales_Rep set [Sales_Rep_Name]='" + salesRepName.ToUpper()+ "',[Sales_Rep_Status]='" + status + "',[Sales_Rep_Expiry_Date]='"+time.ToString(format)+"',[Venue_Country_ID]='" + venueCountryID + "',[Office]='" + office + "',[Venue]='" + venue+ "',[Description]='" + description.ToUpper() + "',Manager='"+manager.ToUpper()+"' where [Sales_Rep_ID]='" + salesRepID + "';";
            SqlCommand cmd2 = new SqlCommand(query, sqlcon);
            cmd2.ExecuteNonQuery();
        }
