<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_Rep_Coldline.aspx.cs" Inherits="WebSite5_production_Sales_Rep_Coldline" %>
...
.has-search .form-control {
    ...
    padding-left: 34px;
     ...
     .title{
      ...
      #update,#head,#salesRepID,#salesRepName,#salesRepStatus,#Office,#Venue,#directory,#insert,#vCountry,#description{
          display:none;
      }
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h3 class="text-center">ADD AGENT COLDLINE</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="salesRepID">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="salesRepName">
                  <div class="form-group">
                      <label for="sel1">Agent Coldline:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" runat="server" placeholder="Enter Agent" ></asp:TextBox>
                     
                  </div>
              </div>
            
               <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="salesRepStatus">
                  <div class="form-group">
          ...
          <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " ">
              <h3 class="text-center">AGENT COLDLINE DIRECTORY</h3>
          </div>
          </div>
                         <div class="row">
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#insert").click(function () {
                ...
                var salesRep = $("#TextBox2").val();
                if (salesRep == "" || salesRep == null) {
                    salesRep = "";
                } else {
                    salesRep = $("#TextBox2").val();
                }
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Sales_Rep_Coldline.aspx/insertSalesRep',
                    contentType:"application/json; charset=utf-8",
                    data: "{'salesRep':'" + salesRep + "','venue':'" + venue + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var vgroup = row.find("td:eq(3)").text();
                    var venue = row.find("td:eq(4)").text();
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Sales_Rep_Coldline.aspx/getAllSalesRep',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    if (confirmation) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'Sales_Rep_Coldline.aspx/deleteSalesRep',
                            contentType: "application/json; charset=utf-8",
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    if (salesRepName == "" || salesRepName == null) {
                        salesRepName = "";
                    } else {
                        salesRepName = $("#TextBox2").val();
                    }
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Sales_Rep_Coldline.aspx/updateSalesRep',
                        contentType: "application/json; charset=utf-8",
                        data: "{'salesRepID':'" + salesRepID + "','salesRepName':'" + salesRepName + "','status':'" + status + "','venueName':'" + venueName + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
        ...
        <script>
            ...
            $(document).ready(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Sales_Rep_Coldline.aspx/getAllVenue1',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
       ...
       <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Sales_Rep_Coldline.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Sales_Rep_Coldline.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Sales_Rep_Coldline.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
