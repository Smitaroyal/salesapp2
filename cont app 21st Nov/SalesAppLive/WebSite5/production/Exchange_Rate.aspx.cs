...
public partial class WebSite5_production_Exchange_Rate : System.Web.UI.Page
{
    ...
    public static void insertExchangeRate(string eRatesIDR, string eRatesINR, string eRatesAUD, string eRatesEUR, string eRatesGBP)
    {
        ...
        string query1 = "select ERates_ID from Exchange_Rate where ERates_Status='Active' and Office='"+office+"'";
        ...
        string query = "insert into Exchange_Rate ([ERates_ID],[ERates_USD],[ERates_IDR],[ERates_INR],[ERates_AUD],[ERates_EUR],[ERates_Create_Date],[ERates_Expiry_Date],[ERates_Status],[ERates_GBP],Office) values('" + exchangeRateID+ "','1','"+ eRatesIDR + "','"+ eRatesINR + "','"+ eRatesAUD + "','"+ eRatesEUR + "','" + time.ToString(format)+"','','Active','"+ eRatesGBP + "','"+office+"');";
        ...
        {
            string query2 = "update Exchange_Rate set ERates_Expiry_Date='" + time.ToString(format) + "', ERates_Status='Inactive' where ERates_ID='" + HttpContext.Current.Session["exchangeRate"].ToString() + "' and office='"+office+"'";
    ...
    public static string getAllExchangeRate()
    {
       string office = HttpContext.Current.Session["office"].ToString();
        ...
        SqlConnection sqlcon = new SqlConnection(conn);
        String JSON = "{\n \"names\":[";
        string query = "select ERates_ID,ERates_IDR,ERates_INR,ERates_AUD,ERates_EUR,ERates_GBP,ERates_Status from Exchange_Rate where Office='"+office+"' ORDER BY ERates_Status asc;";
        sqlcon.Open();
        SqlCommand cmd = new SqlCommand(query, sqlcon);
        SqlDataReader reader = cmd.ExecuteReader();
        while (reader.Read())
