...
public partial class WebSite5_production_VenueCountry : System.Web.UI.Page
{
    ...
    public static void insertVenueCountry(string venuecountryname,string office)
    {
        ...
        string details = "Venue Country Created : Venue Country: " + venuecountryname.ToUpper() + ", office: " + office;
...

    {
        ...
        HttpContext.Current.Session["Venue_Country_Name1"] = "";
        HttpContext.Current.Session["Venue_Country_Status1"] = "";
        HttpContext.Current.Session["Venue_Country_Office1"] = "";
        ...
        while (reader.Read())
        {
            HttpContext.Current.Session["Venue_Country_Name1"] = reader.GetString(0);
            HttpContext.Current.Session["Venue_Country_Status1"] = reader.GetString(1);
            HttpContext.Current.Session["Venue_Country_Office1"] = reader.GetString(2);
           
        }

        if (HttpContext.Current.Session["Venue_Country_Name1"].ToString().Equals(venuecountryName))
        { }
        else
        {
            string pageName = "Venue Country";
            string details = "Venue Country changed from: " + HttpContext.Current.Session["Venue_Country_Name1"].ToString() + " To: " + venuecountryName.ToUpper();
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }


        if (HttpContext.Current.Session["Venue_Country_Status1"].ToString().Equals(status))
        { }
        else
        {
            string pageName = "Venue Country";
            string details = "Status changed from: " + HttpContext.Current.Session["Venue_Country_Status1"].ToString() + " To: " + status;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }

        if (HttpContext.Current.Session["Venue_Country_Office1"].ToString().Equals(office))
        { }
        else
        {
            string pageName = "Venue Country";
            string details = "Venue Country Office changed from: " + HttpContext.Current.Session["Venue_Country_Office1"].ToString()+ " To: " + office;
            int insertlog1 = Queries.admin_Log(pageName, details, user, DateTime.Now.ToString());
        }
