<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Managers.aspx.cs" Inherits="WebSite5_Marketing_Program" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#managerID,#head,#Venue,#directory,#insert,#managerName,#Status,#Venue,#VenueGroup{
             display:none;
         }
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        ...
        <h3 class="text-center">ADD MANAGERS</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="managerID">
                  <div class="form-group">
                      <label for="sel1">Manager ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

                 <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="managerName">
                  <div class="form-group">
                      <label for="sel1">Manager Name:</label>
                ...
                <button type="button"  runat="server" id="insert" class="btn btn-primary pull-right btn-block" >Insert</button>
                 ...
                 <button type="button"  runat="server" id="update" class="btn btn-primary pull-right btn-block">Update</button>
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h5 class="text-center">MANAGER DIRECTORY</h5>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var managerName = $("#TextBox3").val();
                if (managerName == "" || managerName == null) {
                    managerName = "";
                } else {
                    managerName = $("#TextBox3").val();
                }
                ...
                if (venue == "" || venue == null) {
                    ...
                    venue = $("#venue option:selected").text();
                }
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Managers.aspx/insertManagers',
                    contentType:"application/json; charset=utf-8",
                    data: "{'managerName':'" + managerName + "','venue':'"+venue+"','venueGroup':'" + venueGroup + "'}",
                    async: false,
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var managerID = row.find("td:eq(0)").text();
                    var managerName = row.find("td:eq(1)").text();
                    var managerStatus = row.find("td:eq(2)").text();
                 
                   
                  
                    $("#TextBox1").val(managerID);
                    $("#TextBox3").val(managerName);
                    $("#status option[value='" + managerStatus + "']").prop('selected', true);
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Managers.aspx/getVenueGroup',
                        contentType: "application/json; charset=utf-8",
                        data: "{'venue':'" + venue + "'}",
                        async: false,
                        success: function (data) {
                    ...
                    var venueGroupName = row.find("td:eq(5)").text();
                    $("#venueGroup option[value='" + venueGroupName + "']").prop('selected', true);
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Managers.aspx/updateManagers',
                        contentType: "application/json; charset=utf-8",
                        data: "{'managerID':'" + managerID + "','managerName':'" + managerName + "','venue':'" + venue + "','venueGroup':'" + venueGroup + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox2").val("");
                            $("#TextBox3").val("");
    ...
    (function (document) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    var confirmation = confirm("are you sure you want to delete " + managerName + " ?");

                    if (confirmation) {

                        $.ajax({
                            type: 'POST',
                            url: 'Managers.aspx/deleteManager',
                            contentType: "application/json; charset=utf-8",
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Managers.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Managers.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
