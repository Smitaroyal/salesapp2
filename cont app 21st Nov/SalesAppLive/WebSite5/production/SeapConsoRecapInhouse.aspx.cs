...
public partial class WebSite5_production_SeapConsoRecapInhouse: System.Web.UI.Page
{
    ...
    private void show_report(string country,string venue)
    {
        ...
        DataTable dt1 = Queries2.SeapConsoRecapInhouse(date, country,venue);
        ...
        ReportViewer1.LocalReport.ReportPath = "reports/Seapconsoinhouse2.rdlc";
	...
	ReportViewer1.LocalReport.DisplayName = "SEAP. BALI. RECAP INH CONSOLIDATED" ;
