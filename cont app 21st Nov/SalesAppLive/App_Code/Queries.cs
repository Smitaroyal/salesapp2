   ...
   public static int UpdateFinanceNo(string venue, string finance, string contracttype)
     ...
     public static int InsertContract_Fractional_PA_Indian(string Contract_Fractional_PA_Id, string ProfileID, string ContractNo, string Admission_fees, string administration_fees, string Cgst, string Sgst, string Total_Purchase_Price, string Total_Price_Including_Tax, string Deposit, string Balance, string Balance_Due_Dates, string Remarks, string TradeIn_value, string Total_value, string ContractDetails_ID,string FoldVolume , string Foldadminfee, string FoldTotalTax, string FoldDeposit, string Fusdoldvolume,string Fusdoldadminfee,string Fusdoldtax,string Fusdolddeposit,string USDConvertedFVolume, string USDConvertedFAdminfee, string USDConvertedFTax, string USDConvertedFdeposit)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Contract_Fractional_PA_Indian values(@Contract_Fractional_PA_Id,	@ProfileID,	@ContractNo,	@Admission_fees,	@administration_fees ,	@Cgst,	@Sgst,	@Total_Purchase_Price ,	@Total_Price_Including_Tax,@Deposit,@Balance,@Balance_Due_Dates,@Remarks,@TradeIn_value,@Total_value,@ContractDetails_ID,@FoldVolume,	@Foldadminfee,	@FoldTotalTax,	@FoldDeposit,@Fusdoldvolume,@Fusdoldadminfee,@Fusdoldtax,@Fusdolddeposit,@USDConvertedFVolume,@USDConvertedFAdminfee,@USDConvertedFTax,@USDConvertedFdeposit)", cs1);
...
SqlCommand SqlCmd = new SqlCommand(" select  Code+'/'+ REPLACE(CONVERT(CHAR(8), GETDATE(), 3), '/', '')+'/'+Increment_Value+case when venue like '%roadshow%' then (case when Contract_Resort_Name ='Karma Hathi Mahal' then 'RSHM' else '' end) else (case when Contract_Resort_Name ='Karma Hathi Mahal' then 'HM' else '' end) end as t  from Contract_ResortCode_Generation where Contract_Resort_Name=@club and Contract_Resort_Status = 'active' and venue = @venue and Nationality != 'Indian'", cs1);
    ...
    public static int InsertContract_Trade_In_Fractional_Indian(string ContractTrade_InFractional_ID, string ProfileID, string ContractNo, string Oldcontracttype, string RESORT, string APT_TYPE,  string SEASON, string NO_WEEKS, string NO_POINTS, string POINTS_VALUE, string oldContract_No, string ContractDetails_ID)
    {
        int rowsAffected = 0;
        SqlDataAdapter da = new SqlDataAdapter();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Contract_Trade_In_Fractional_Indian values(@ContractTrade_InFractional_ID ,	@ProfileID ,	@ContractNo ,	@Oldcontracttype ,	@RESORT ,	@APT_TYPE ,		@SEASON, @NO_WEEKS ,	@NO_POINTS,	@POINTS_VALUE ,	@oldContract_No,@ContractDetails_ID)", cs1);
...
string Receipt_Status ="Active";
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Contract_Indian_Deposit_Receipt values(@Deposit_Receipt_Id,@ContractDetails_ID ,	 @ContractNo ,	@Receipt_No ,	 @Receipt_Date  ,	@place_supply ,	@state ,	@state_code ,	@Product_Name,	@SAC ,	@Amount,@taxable_value,@cgstrate,@cgstamt,@sgstrate,@sgstamt,@totalamt,@Payment_Mode,@actual_currency,@converted_currency,@Converted_rate,@ExchangedValue_date,@Actual_Amt,@Receipt_Status,@receipttype,@payment_date)", cs1);
...
public static DataSet onLoadSubVenue(string venue , string groupVenue ,string profileID)
 ...
 public static int InsertCRM_details(string Profile_ID, string contractdetails_id, string program_source, string Referred_By, string comment1,string created_date, string updated_date, string createdby, string updatedby,string status)
  ...
  public static int UpdateContract_PA_IndianUSDConversion(string  USDConvertedVolume,string  USDConvertedAdminfee,string USDConvertedTax, string USDConverteddeposit,  string contractno, string ContractDetails_ID)
    {
        int rows = 0;
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand scd = new SqlCommand("update Contract_PA_Indian  SET USDConvertedVolume = '" + USDConvertedVolume + "', USDConvertedAdminfee = '" + USDConvertedAdminfee + "',USDConvertedTax = '" + USDConvertedTax + "',USDConverteddeposit = '" + USDConverteddeposit + "', contractno='" + contractno + "' where ContractDetails_ID = '" + ContractDetails_ID + "'", cs1);
                scd.Parameters.Add("@ContractDetails_ID", SqlDbType.VarChar).Value = ContractDetails_ID;
                rows = scd.ExecuteNonQuery();
            }
            catch (Exception ex)
   ...
   public static string  LoadIndian_FinReceiptGeneration(string venue)
    ...
    public static int InsertContract_Indian_Deposit_Receipt_Deleted(string Deposit_Receipt_Id, string ContractDetails_ID, string ContractNo, string Receipt_No, string Receipt_Date, string place_supply, string state, string state_code, string Product_Name, string SAC, string Amount, string taxable_value, string cgstrate, string cgstamt, string sgstrate, string sgstamt, string totalamt, string Payment_Mode, string actual_currency, string converted_currency, string Converted_rate, string ExchangedValue_date, string Actual_Amt, string receipttype, string Receipt_Status,string payment_date)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Contract_Indian_Deposit_Receipt_Deleted values(@Deposit_Receipt_Id,@ContractDetails_ID ,	 @ContractNo ,	@Receipt_No ,	 @Receipt_Date  ,	@place_supply ,	@state ,	@state_code ,	@Product_Name,	@SAC ,	@Amount,@taxable_value,@cgstrate,@cgstamt,@sgstrate,@sgstamt,@totalamt,@Payment_Mode,@actual_currency,@converted_currency,@Converted_rate,@ExchangedValue_date,@Actual_Amt,@Receipt_Status,@receipttype,@payment_date )", cs1);
                da.InsertCommand.Parameters.Add("@Deposit_Receipt_Id", SqlDbType.VarChar).Value = Deposit_Receipt_Id;
                da.InsertCommand.Parameters.Add("@ContractDetails_ID", SqlDbType.VarChar).Value = ContractDetails_ID;
                da.InsertCommand.Parameters.Add("@ContractNo", SqlDbType.VarChar).Value = ContractNo;
                da.InsertCommand.Parameters.Add("@Receipt_No", SqlDbType.VarChar).Value = Receipt_No;
    ...
    public static int UpdateContract_Fractional_PA_IndianUSDConversion(string USDConvertedFVolume, string USDConvertedFAdminfee, string USDConvertedFTax, string USDConvertedFdeposit, string contractno, string ContractDetails_ID)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand scd = new SqlCommand("update Contract_Fractional_PA_Indian  SET USDConvertedFVolume = '" + USDConvertedFVolume + "', USDConvertedFAdminfee = '" + USDConvertedFAdminfee + "',USDConvertedFTax = '" + USDConvertedFTax + "',USDConvertedFdeposit = '" + USDConvertedFdeposit + "', contractno='" + contractno + "' where ContractDetails_ID = '" + ContractDetails_ID + "'", cs1);
                scd.Parameters.Add("@ContractDetails_ID", SqlDbType.VarChar).Value = ContractDetails_ID;
                rows = scd.ExecuteNonQuery();
            }
            catch (Exception ex)
