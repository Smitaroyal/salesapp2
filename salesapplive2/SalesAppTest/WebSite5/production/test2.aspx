<%@ Page Language="C#" AutoEventWireup="true" CodeFile="test2.aspx.cs" Inherits="WebSite5_production_test2" %>
                  ...
                  <li class="">
                      ...
                      <div class="main">
                          ...
                          <div class="form-group has-feedback has-search">
                              ...
                              <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Search for Profile.."></asp:TextBox>
                          </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#TextBox1").keyup(function () {
                ...
                var profileID = $("#TextBox1").val();

                $.ajax({

                    type: 'Post',
                    url: 'test2.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
                        ...
                        $.each(subJson, function (key, value) {
                            ...
                            $.each(value, function (index1, value1) {
                                ...
                                if (value1[0] == "") {
                                    ...
                                    $("#task-table2 tbody").append("<tr><td><a href='" + value1[0] + "' id='profileclick'>" + value1[0] + "</a></td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td><a href=GuestCard.aspx?name=" + value1[0] + ">Guest Card</a></td></tr>");
                                }
                            });
