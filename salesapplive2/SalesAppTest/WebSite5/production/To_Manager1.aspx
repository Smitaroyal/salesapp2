...
.has-search .form-control {
    ...
    padding-left: 34px;
     ...
     .title{
      ...
      #update,#toManagerID,#head,#toManagerName,#Office,#managerstatus,#directory,#insert,#Venue,#vCountry,#description{
          display:none;
      }
      #TextBox5{
          text-align:center;
            ...
            $("#insert").click(function () {
              ...
              //  var status = $("#status").val();
                ...
                $.ajax({
                    ...
                    data: "{'tomanagername':'" + toManagerName + "','tomanageroffice':'" + toManagerOffice + "','venueCountryID':'" + venueCountryID + "','venue':'" + venue + "','description':'" + description + "','venueCountryName':'" + venueCountryName + "'}",
                    async: false,
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'toManagerID':'" + toManagerID + "','toManagername':'" + toManagerName + "','office':'" + office + "','toManagerstatus':'" + toManagerStatus + "','venue':'" + venue + "','venuecountry':'" + venuecountry + "','description':'" + description + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
