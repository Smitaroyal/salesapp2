<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateContractTeamDetails.aspx.cs" Inherits="WebSite5_production_UpdateContractDetails" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #countryID,#head,#countryName,#countryCode,#directory,#insert,#contractID{
             display:none;
         }
        ...
        <div class="container-fluid">
          ...
          <div class="row"> 
            ...
            <div class="row">
                  ...
                  <div class="form-group">
                       <label><input type="checkbox" id="repReport" value=""/>&nbsp;Rep Report</label>
                  </div>
              </div>
               ...
               <div class="row">
                  <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="">
                  <div class="form-group">
                       <label><input type="checkbox" id="toReport" value=""/>&nbsp;To Report</label>
                  </div>
              </div>
             ...
             <div class="row">
                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="">
                     <div class="form-group">
                         <label>
                             <input type="checkbox" id="sms" value="" />&nbsp;SMS</label>
                     </div>
                 </div>
            ...
            <div class="row">
                   <div class="col-md-5 col-xs-12 col-sm-3 col-lg-5" id="">
                <div class="form-group">
    ...
    <script src="../build/js/custom.min.js"></script>
                ...
                $("#TextBox2").blur(function () {
                   ...
                   // alert(contractNo);
                    if (contractNo == "" || contractNo == null) {
                        ...
                        $("#repReport").prop('checked', false);
                        $("#toReport").prop('checked', false)
                        
                    } else {
                        $.ajax({

                            type: 'Post',
                            url: 'UpdateContractTeamDetails.aspx/getContractIDOnContractNo',
                        ...
                        $.ajax({
                            ...
                            type: 'Post',
                            url: 'UpdateContractTeamDetails.aspx/getContractTeamDetails',
                            contentType: "application/json; charset=utf-8",
                            data: "{'contractNo':'" + contractNo + "'}",
                            async: false,
                            success: function (data) {
                                ...
                                $.each(subJson, function (key, value) {
                                    ...
                                    $.each(value, function (index1, value1) {
                                        ...
                                        if (value1[1] == "Yes") {
                                            $("#repReport").prop('checked', true);
                                        } else {
                                            $("#repReport").prop('checked', false);
                                        }

                                        if (value1[2] == "Yes") {
                                            $("#toReport").prop('checked', true);
                                        } else {
                                            $("#toReport").prop('checked', false);
                                        }
                                        if (value1[3] == "Yes") {
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                   ...
                   // alert(contractID);
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'UpdateContractTeamDetails.aspx/updatedetails',
                        contentType: "application/json; charset=utf-8",
                        data: "{'contractID':'" + contractID + "','contractNo':'" + contractNo + "','repReport':'" + repReport + "','toReport':'" + toReport + "','sms':'" + sms + "','Comment':'" + Comment + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'UpdateContractTeamDetails.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'UpdateContractTeamDetails.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'UpdateContractTeamDetails.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
