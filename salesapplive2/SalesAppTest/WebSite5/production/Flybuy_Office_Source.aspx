<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Flybuy_Office_Source.aspx.cs" Inherits="WebSite5_production_Flybuy_Office_Source" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#fly_off_ID,#head,#fly_off_Name,#Status,#directory,#insert{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD PROMOTION SOURCE</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="fly_off_ID">
                  <div class="form-group">
                      <label for="sel1">Promotion Source ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="fly_off_Name">
                  <div class="form-group">
                      <label for="sel1">Promotion Source:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Promotion Source" runat="server"></asp:TextBox>
                  </div>
              </div>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h4 class="text-center"> PROMOTION SOURCE DIRECTORY</h4>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                var isValid = true;
                var flyOffName = $("#TextBox2").val();
                if (flyOffName == "" || flyOffName == "") {
                    flyOffName = "";
                    isValid = false;
                    $("#danger-alert1").fadeTo(1500, 500).slideUp(500, function () {
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Flybuy_Office_Source.aspx/insertFlybuy_Office_Source',
                    contentType:"application/json; charset=utf-8",
                    data: "{'flyOffName':'" + flyOffName + "','flyOffName':'" + flyOffName + "'}",
                    async: false,
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Flybuy_Office_Source.aspx/getAllFlybuy_Office_Source',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    var row = $(this).closest("tr");
                    var flyOffID = row.find("td:eq(0)").text();
                    var flyOffName = row.find("td:eq(1)").text();
                    //alert(countryID);
                    var confirmation = confirm("are you sure you want to delete " + flyOffName + " ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Flybuy_Office_Source.aspx/deleteFlybuy_Office_Source',
                            contentType: "application/json; charset=utf-8",
                            data: "{'flyOffID':'" + flyOffID + "','flyOffName':'" + flyOffName + "'}",
                            async: false,
                            success: function (data) {
                                $("#TextBox5").val("");
                                $("#success-alert").fadeTo(1500, 500).slideUp(500, function () {
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    var flyOffID = $("#TextBox1").val();
                    var flyOffName = $("#TextBox2").val();
                
                    var status = $("#status").val();

                    if (flyOffName == "" || flyOffName == null) {
                        flyOffName = "";
                    } else {
                        var flyOffName = $("#TextBox2").val();
                    }
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Flybuy_Office_Source.aspx/updateFlybuy_Office_Source',
                        contentType: "application/json; charset=utf-8",
                        data: "{'flyOffID':'" + flyOffID + "','flyOffName':'" + flyOffName + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Flybuy_Office_Source.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Flybuy_Office_Source.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Flybuy_Office_Source.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
