...
.has-search .form-control {
    ...
    .title{
     ...
     #success-alert,#danger-alert,#danger-alert1,#gstin,#g_id,#address,#phoneNo{
            display:none;
        }
   
      #update,#venueID,#venueCountry,#head,#venueName,#venueStatus,#directory,#insert,#menu_toggle,#profileDetails{
          display:none;
      }
      #TextBox5{
          text-align:center;
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="container-fluid">
          <div class="row"> 
                <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="g_id">
                  <div class="form-group">
                      <label for="sel1">ID:</label>
                      <asp:TextBox ID="TextBox4" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="venueID">
                  <div class="form-group">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="venueName">
                  <div class="form-group">
                      <label for="sel1">Venue Name:</label>
                      <asp:TextBox ID="TextBox2" class="form-control pull-right" placeholder="Enter Venue" runat="server"></asp:TextBox>
                  </div>
              </div>

                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="gstin">
                  <div class="form-group">
                      <label for="sel1">Gstin No:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right" placeholder="Enter Gstin No" runat="server"></asp:TextBox>
                  </div>
              </div>

              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="address">
                  <div class="form-group">
                      <label for="sel1">Address:</label>
                      <asp:TextBox ID="TextBox6" class="form-control pull-right" placeholder="Enter Gstin No" runat="server"></asp:TextBox>
                  </div>
              </div>

              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="phoneNo">
                  <div class="form-group">
                      <label for="sel1">Phone No:</label>
                      <asp:TextBox ID="TextBox7" class="form-control pull-right" placeholder="Enter Gstin No" runat="server"></asp:TextBox>
                  </div>
              </div>

               <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="venueStatus">
                  <div class="form-group">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="venueCountry">
                  <div class="form-group">
    ...
    <script>
            ...
            $("#insert").click(function () {
                ...
                if(venueName=="" || venueName==null){
                    venueName = "";
                     ...
                     venueName = $("#TextBox2").val();
                }

                var gstin = $("#TextBox3").val();
                if (gstin == "" || gstin == null) {
                    gstin = "";
                } else {
                    gstin = $("#TextBox3").val();
                ...
                var Address = $("#TextBox6").val();
                if (Address == "" || Address == null) {
                    Address = "";
                } else {
                    Address = $("#TextBox6").val();
                }

                var phone = $("#TextBox7").val();
                if (phone == "" || phone == null) {
                    phone = "";
                } else {
                    phone = $("#TextBox7").val();
               ...
               // var status = $("#status").val();
                ...
                $.ajax({
                    ...
                    data: "{'venuename':'" + venueName + "','venuecountry':'" + venueCountry + "','gstin':'" + gstin + "','Address':'" + Address + "','phone':'" + phone + "'}",
                    async: false,
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var gstin = row.find("td:eq(2)").text();
                    var address = row.find("td:eq(3)").text();
                    var phone = row.find("td:eq(4)").text();
                    var status = row.find("td:eq(5)").text();
                    var venueCountryID = row.find("td:eq(7)").text();
                 
                    var g_ID = row.find("td:eq(8)").text();
                        ...
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>"+value1[3]+"</td><td>"+value1[4]+"</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td style='display:none;'>" + value1[7] + "</td><td style='display:none;'>" + value1[8] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'venueID':'" + venueID + "','venueName':'" + venueName + "','status':'" + status + "','venueCountryID':'" + venueCountryID + "','gstin':'" + gstin + "','g_ID':'" + g_ID + "','Address':'" + Address + "','phone':'" + phone + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Venue1.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
