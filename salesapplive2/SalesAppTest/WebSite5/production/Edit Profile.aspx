                                      ...
                                      <div id="staydetails">
                                          ...
                                          <div class="row">
                                               ...
                                               <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2 item8827">
                                                  <div class="form-group">
                                                      <label for="sel1">Taxi in Reference/From:</label>
                                              ...
                                              <div class="col-md-3 col-xs-12 col-sm-8 col-lg-3 item8829">
                                                  <div class="form-group">
                                                      <label for="sel1">Taxi out Reference/To:</label>
                                                      <asp:TextBox ID="TaxiRefOutTextBox" Enabled="True" class="form-control" runat="server" ></asp:TextBox>
                                                  </div>
                                              </div>
