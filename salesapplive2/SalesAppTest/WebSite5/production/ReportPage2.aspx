<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportPage2.aspx.cs" Inherits="WebSite5_production_ReportPage2" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'ReportPage2.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'ReportPage2.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
