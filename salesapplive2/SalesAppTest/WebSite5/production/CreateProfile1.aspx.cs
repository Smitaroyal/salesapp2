        ...
        try
        {
            ...
            else
            {
                ...
                if (Request.Form[giftoptionDropDownList.UniqueID] != "")
                {
                    ...
                    string item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList.UniqueID]);
                    if (item == "" || item == null)
                    {
                        item = "";
                    }
                    ...
                    {
                        item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList.UniqueID]);
                    }

                    int insert = Queries2.InsertGiftOption(giftid, Request.Form[giftoptionDropDownList.UniqueID], vouchernoTextBox.Text, TextBoxChargeBack.Text.ToUpper(), Session["ProfileID"].ToString(), item, tg1);
                ...
                if (Request.Form[giftoptionDropDownList2.UniqueID] != "")
                {
                    ...
                    string item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList2.UniqueID]);
                    if (item == "" || item == null)
                    {
                        item = "";
                    }
                    ...
                    {
                        item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList2.UniqueID]);
                    }

                    int insert = Queries2.InsertGiftOption(giftid, Request.Form[giftoptionDropDownList2.UniqueID], vouchernoTextBox2.Text, "", Session["ProfileID"].ToString(), item, tg2);
                    int update1 = Queries.UpdateGiftValue(office, DateTime.Now.Year);
                }
                ...
                if (Request.Form[giftoptionDropDownList3.UniqueID] != "")
                {
                    ...
                    string item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList3.UniqueID]);
                    if (item == "" || item == null)
                    {
                        item = "";
                    }
                    ...
                    {
                        item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList3.UniqueID]);
                    }

                    int insert = Queries2.InsertGiftOption(giftid, Request.Form[giftoptionDropDownList3.UniqueID], vouchernoTextBox3.Text, "", Session["ProfileID"].ToString(), item, tg3);
                    int update1 = Queries.UpdateGiftValue(office, DateTime.Now.Year);
                }
                ...
                if (Request.Form[giftoptionDropDownList4.UniqueID] != "")
                {
                    ...
                    string item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList4.UniqueID]);
                    if (item == "" || item == null)
                    {
                        item = "";
                    }
                    ...
                    {
                        item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList4.UniqueID]);
                    }

                    int insert = Queries2.InsertGiftOption(giftid, Request.Form[giftoptionDropDownList4.UniqueID], vouchernoTextBox4.Text, "", Session["ProfileID"].ToString(), item, tg4);
                    int update1 = Queries.UpdateGiftValue(office, DateTime.Now.Year);
                }
                ...
                if (Request.Form[giftoptionDropDownList5.UniqueID] != "")
                {
                    ...
                    string item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList5.UniqueID]);
                    if (item == "" || item == null)
                    {
                        item = "";
                    }
                    ...
                    {
                        item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList5.UniqueID]);
                    }

                    int insert = Queries2.InsertGiftOption(giftid, giftoptionDropDownList5.SelectedItem.Text, vouchernoTextBox5.Text, "", Session["ProfileID"].ToString(), item, tg5);
                    int update1 = Queries.UpdateGiftValue(office, DateTime.Now.Year);
                }
                if (Request.Form[giftoptionDropDownList6.UniqueID] != "")
                {
                    ...
                    string item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList6.UniqueID]);
                    if (item == "" || item == null)
                    {
                        item = "";
                    }
                    ...
                    {
                        item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList6.UniqueID]);
                    }

                    int insert = Queries2.InsertGiftOption(giftid, Request.Form[giftoptionDropDownList6.UniqueID], vouchernoTextBox6.Text, "", Session["ProfileID"].ToString(), item, tg6);
                    int update1 = Queries.UpdateGiftValue(office, DateTime.Now.Year);
                }
                if (Request.Form[giftoptionDropDownList7.UniqueID] != "")
                {
                    ...
                    string item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList7.UniqueID]);
                    if (item == "" || item == null)
                    {
                        item = "";
                    }
                    ...
                    {
                        item = Queries.GetItemOnGift(Request.Form[giftoptionDropDownList7.UniqueID]);
                    }

                    int insert = Queries2.InsertGiftOption(giftid, Request.Form[giftoptionDropDownList7.UniqueID], vouchernoTextBox7.Text, "", Session["ProfileID"].ToString(), item, tg7);
                    int update1 = Queries.UpdateGiftValue(office, DateTime.Now.Year);
                }
