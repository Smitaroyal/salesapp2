<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DSR_INDIA Accounts.aspx.cs" Inherits="WebSite5_production_DSR_INDIA" %>
   ...
   <script>
            ...
            $("#country").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA Accounts.aspx/getVenue',
            ...
            $("#venue").change(function () {
              ...
              //  alert(office);
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA Accounts.aspx/getVenueGroup',
                    contentType: "application/json; charset=utf-8",
                    data: "{'Venue':'" + Venue + "'}",
                    async: false,
                    success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'DSR_INDIA Accounts.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA Accounts.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'DSR_INDIA Accounts.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
