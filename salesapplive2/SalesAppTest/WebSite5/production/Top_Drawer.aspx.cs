...
public partial class WebSite5_production_Top_Drawer : System.Web.UI.Page
{
    ...
    private void show_report(string country,string venue,string venueGroup)
    {
        ...
        DateTime dtt1 = DateTime.ParseExact(TextBox1.Text, "dd-MM-yyyy", CultureInfo.InvariantCulture);
        string date1 = dtt1.ToString("yyyy-MM-dd");
        ReportViewer1.Reset();

        DataTable dt1 = Queries2.topdrawer1_1(date, date1, country, venue, venueGroup);
        DataTable dt1_2 = Queries2.topdrawer1_2(date, date1, country, venue, venueGroup);
        DataTable dt2 = Queries2.topdrawer2(date, date1, country, venue, venueGroup);
        ...
        {
            new ReportParameter("SDATE",date),
            new ReportParameter("EDATE",date1),
