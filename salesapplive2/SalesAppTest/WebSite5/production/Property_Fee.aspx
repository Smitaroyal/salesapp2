...
.has-search .form-control {
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #update, #chargeID, #head, #noOfPoints, #propertyFeePerYear, #directory, #insert, 
        #propertyFee, #memberFee, #totalCharge, #chargeYear, #Status, #propertyFeePerYear1,#memberFee1,#chargeID {
            display: none;
        }
                                       ...
                                       <%--     <div class="col-md-2 col-sm-3" id="noOfPoints">
                                            ...
                                            <div class="col-md-2 col-sm-2" id="propertyFeePerYear">
                                             ...
                                             <div class="col-md-2 col-sm-2" id="memberFee">
                                              ...
                                              <div class="col-md-2 col-sm-2" id="propertyFeePerYear1">
                                                <div class="form-group">
                                                    <label for="sel1">Fee Per Year Alt:</label>
                                                    <asp:TextBox ID="TextBox2" class="form-control pull-right" runat="server"></asp:TextBox>
                                                </div>
                                            </div>

                                             <div class="col-md-2 col-sm-2" id="memberFee1">
                                                <div class="form-group">
                                                    <label for="sel1">Member Fee Alt:</label>
                                                    <asp:TextBox ID="TextBox4" class="form-control pull-right" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-hover" id="task-table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>CHARGE YEAR</th>
                                                            <th>STATUS</th>
                                                             <th>FEE PER YEAR ALT</th>
                                                            <th>MEMBER FEE ALT</th>
                                                            <th>EDIT</th>
                                                            <th>DELETE</th>
                                                        </tr>
                                                    </thead >
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#insert").click(function () {
                    ...
                    var propertyPerYearAlt = $("#TextBox2").val();
                    if (propertyPerYearAlt == "" || propertyPerYearAlt == null) {
                        propertyPerYearAlt = "";
                    } else {
                        propertyPerYearAlt = $("#TextBox2").val();
                    }
                    ...
                    var memberFeeAlt = $("#TextBox4").val();
                    if (memberFeeAlt == "" || memberFeeAlt == null) {
                        memberFeeAlt = "";
                    } else {
                        memberFeeAlt = $("#TextBox4").val();
                    }
                    ...
                    $.ajax({
                        ...
                        data: "{'propertyPerYear':'" + propertyPerYear + "','memberFee':'" + memberFee + "','ChargeYear':'" + ChargeYear + "','propertyPerYearAlt':'" + propertyPerYearAlt + "','memberFeeAlt':'" + memberFeeAlt + "'}",
                        async: false,
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.edit-btn', function () {
                  ...
                  //  $("#chargeID").show();
                    ...
                    var propertyFeePerYearAlt = row.find("td:eq(5)").text();
                    var memberFeeAlt = row.find("td:eq(6)").text();

                    $("#TextBox1").val(chargeID);
                    $("#TextBox2").val(propertyFeePerYearAlt);
                    $("#TextBox4").val(memberFeeAlt);
                        ...
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
            ...
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        data: "{'chargeID':'" + chargeID + "','propertyPerYear':'" + propertyPerYear + "','memberFee':'" + memberFee + "','ChargeYear':'" + ChargeYear + "','status':'" + status + "','propertyPerYearAlt':'" + propertyPerYearAlt + "','memberFeeAlt':'" + memberFeeAlt + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox1").val("");
                            $("#TextBox2").val("");
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Property_Fee.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Property_Fee.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
