<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Management_Chart.aspx.cs" Inherits="WebSite5_production_Management_Chart" %>
...
<head runat="server">
    ...
    <style>
        ...
        #img {
         ...
         #update,#managementID,#head,#Year,#Currency,#directory,#insert,#Type,#RoomType,#WeekNo,#Club,#PropertyFee,#MemberFee,#MemberCGST,#MemberSGST,#Status,#timeMemberCGST,#timeMemberSGST{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h5 class="text-center">ADD MANAGEMENT CHARGE CHART</h5>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row"> 
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="managementID">
                  <div class="form-group">
                      <label for="sel1">Management Charge ID:</label>
                      <asp:TextBox ID="TextBox1" class="form-control pull-right"  runat="server" ReadOnly></asp:TextBox>
                     
                  </div>
              </div>

                <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="Type">
                  <div class="form-group">
                   ...
                   <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="Year">
                  <div class="form-group">
                   ...
                   <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="Currency">
                  <div class="form-group">
                ...
                <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="WeekNo">
                  <div class="form-group">
                      <label for="sel1">No Of Weeks:</label>
                      <select class="form-control"  id="weekNos">
                          <option disabled selected value>--Select an Option--</option>
                        <% Response.Write(NoWeeks()); %>
                      </select>
                  </div>
              </div>
                <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="RoomType">
                  <div class="form-group">
                      <label for="sel1">Room Type:</label>
                      <select class="form-control"  id="roomtype">
                          <option disabled selected value>--Select an Option--</option>
                        <% Response.Write(RoomType()); %>
                      </select>
                  </div>
              </div>

                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="Club">
                  <div class="form-group">
                 ...
                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="PropertyFee">
                  <div class="form-group">
                ...
                <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="MemberFee">
                  <div class="form-group">
                      <label for="sel1">Memeber Fee:</label>
                      <asp:TextBox ID="TextBox3" class="form-control pull-right"  runat="server" ></asp:TextBox>
                     
                  </div>
              </div>

                  <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="timeMemberCGST">
                  <div class="form-group">
                      <label for="sel1">Memeber CGST:</label>
                      <asp:TextBox ID="TextBox7" class="form-control pull-right"  runat="server" ></asp:TextBox>
                     
                  </div>
              </div>

                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="timeMemberSGST">
                  <div class="form-group">
                      <label for="sel1">Memeber SGST:</label>
                      <asp:TextBox ID="TextBox8" class="form-control pull-right"  runat="server" ></asp:TextBox>
                     
                  </div>
              </div>

                  <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="Status">
                  <div class="form-group">
              ...
              <div class="row">
                 ...
                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="MemberCGST">
                  <div class="form-group">
                      <label for="sel1">Memeber CGST:</label>
                 ...
                 <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="MemberSGST">
                  <div class="form-group">
                      <label for="sel1">Memeber SGST:</label>
          ...
          <div class="row">
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h5 class="text-center"> MANAGEMENT CHARGE DIRECTORY</h5>
                               </div>
              ...
              $("#Type").change(function () {
                  ...
                  if (type == "TimeShare") {
                      ...
                      $.ajax({
                          ...
                          type: 'Post',
                          url: 'Management_Chart.aspx/getClub',
                          contentType: "application/json; charset=utf-8",
                          data: "{'type':'" + type + "'}",
                          async: false,
                          success: function (data) {
                              $("#club").empty();
                              $("#club").append("<option disabled selected value>Select an Option</option>");
                              ...
                              $.each(subJson, function (key, value) {
                                  ...
                                  $.each(value, function (index1, value1) {
                                      ...
                                      $("#club").append("<option value='" + value1[0] + "'>" + value1[0] + "</option>");
                                  });
                              });
                          },
                          error: function () {
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var propertyFee = $("#TextBox2").val();
                if (propertyFee == "" || propertyFee == "") {
                    propertyFee = "";
                } else {
                    var propertyFee = $("#TextBox2").val();
                ...
                var MemberFee = $("#TextBox3").val();
                if (MemberFee == "" || MemberFee == "") {
                    MemberFee = "";
                } else {
                    var MemberFee = $("#TextBox3").val();
                ...
                var MemberCGST = $("#TextBox4").val();
                if (MemberCGST == "" || MemberCGST == "") {
                    MemberCGST = "";
                } else {
                    var MemberCGST = $("#TextBox4").val();
                ...
                var MemberSGST = $("#TextBox6").val();
                if (MemberSGST == "" || MemberSGST == "") {
                    MemberSGST = "";
                } else {
                    var MemberSGST = $("#TextBox6").val();
                ...
                var timeMemberCGST = $("#TextBox7").val();
                if (timeMemberCGST == "" || timeMemberCGST == "") {
                    timeMemberCGST = "";
                } else {
                    var timeMemberCGST = $("#TextBox7").val();
                ...
                var timeMemberSGST = $("#TextBox8").val();
                if (timeMemberSGST == "" || timeMemberSGST == "") {
                    timeMemberSGST = "";
                } else {
                    var timeMemberSGST = $("#TextBox8").val();
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Management_Chart.aspx/insertManagement_Chart',
                    contentType:"application/json; charset=utf-8",
                    data: "{'type':'" + type + "','Year':'" + Year + "','Currency':'" + Currency + "','NoWeek':'" + NoWeek + "','roomtype':'" + roomtype + "','club':'" + club + "','propertyFee':'" + propertyFee + "','MemberFee':'" + MemberFee + "','MemberCGST':'" + MemberCGST + "','MemberSGST':'" + MemberSGST + "','timeMemberCGST':'" + timeMemberCGST + "','timeMemberSGST':'" + timeMemberSGST + "'}",
                    async: false,
                    success: function (data) {
                        $("#TextBox2").val("");
                        $("#TextBox3").val("");
            ...
            $(document).ready(function () {
                ...
                $("#view").click(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Management_Chart.aspx/getAllManagement_Chart',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                        ...
                                        $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td>" + value1[6] + "</td><td>" + value1[7] + "</td><td>" + value1[8] + "</td><td>" + value1[9] + "</td><td>" + value1[10] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >In Active</button></td><td><button type='button'  class='delete-btn btn btn-primary col-md-12' >Delete</button></td></tr>");
            ...
            $(document).ready(function () {
                $(document).on('click', '.delete-btn', function () {
                    ...
                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Management_Chart.aspx/deleteManagement_Chart',
                            contentType: "application/json; charset=utf-8",
                ...
                $(document).on('click', '.edit-btn', function () {
                    var row = $(this).closest("tr");
                    var ID = row.find("td:eq(0)").text();
                    var confirmation = confirm("are you sure you want to In Active ?");

                    if (confirmation) {
                        $.ajax({
                            type: 'POST',
                            url: 'Management_Chart.aspx/EditManagement_Chart',
                            contentType: "application/json; charset=utf-8",
                            data: "{'ID':'" + ID + "'}",
                            async: false,
                            success: function (data) {
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Management_Chart.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Management_Chart.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Management_Chart.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
