<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Finance_Initials.aspx.cs" Inherits="WebSite5_production_Country" %>
    ...
    padding-left: 34px;
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#finance_iniID,#head,#Venue,#directory,#insert,#financeType,#FinanceCode,#Value,#Status{
             display:none;
         }
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">ADD FINANCE INITIALS</h3>
              </div>
              </div>
            </div>
              <br /><br />
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="finance_iniID">
                  <div class="form-group">
                      <label for="sel1">Finance Initial ID:</label>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="financeType">
                  <div class="form-group">
                      <label for="sel1">Finance Type:</label>
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-xs-12 col-sm-3 col-md-3" id="FinanceCode">
                  <div class="form-group">
                      <label for="sel1">Finance Code:</label>
                ...
                <button type="button"  runat="server" id="insert" class="btn btn-primary pull-right btn-block" >Insert</button>
                 ...
                 <button type="button"  runat="server" id="update" class="btn btn-primary pull-right btn-block">Update</button>
                   ...
                   <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " "><br />
                        <h5 class="text-center"> FINANCE DETAILS DIRECTORY</h5>
                               </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                var fianceMethod = $("#financetype").val();
                if (fianceMethod == "" || fianceMethod == null) {
                    fianceMethod = "";
                } else {
                    fianceMethod = $("#financetype").val();
                }


                var financeCode = $("#TextBox3").val();
                if (financeCode == "" || financeCode == null) {
                    financeCode = "";
                } else {
                    financeCode = $("#TextBox3").val();
                }
                ...
                $.ajax({
                    ...
                    type:'Post',
                    url: 'Finance_Initials.aspx/insertFinanceInitials',
                    contentType:"application/json; charset=utf-8",
                    data: "{'venue':'" + venue + "','fianceMethod':'" + fianceMethod + "','financeCode':'" + financeCode + "','inc':'" + inc + "'}",
                    async: false,
     ...
     <script>
            $(document).ready(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Finance_Initials.aspx/getFinanceMethod',
                        contentType: "application/json; charset=utf-8",
                        data: "{}",
                        async: false,
                        success: function (data) {
                           
                            $("#financetype").append("<option disabled selected value>Select an Option</option>");
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#financetype").append("<option value='" + value1[0] + "'>" + value1[0] + "</option>");
                                });
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('click','.edit-btn', function () {
                    ...
                    var financeType = row.find("td:eq(1)").text();
                   
                    var status = row.find("td:eq(2)").text();
                  
                    var venue = row.find("td:eq(3)").text();
                    var code = row.find("td:eq(4)").text();
                    var inc = row.find("td:eq(5)").text();
               
                    $("#TextBox1").val(ID);
                    $("#financetype option[value='" + financeType + "']").prop('selected', true);
            ...
            $(document).ready(function () {
                ...
                $("#TextBox5").keyup(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'Finance_Initials.aspx/getFinanceInitials',
                        contentType: "application/json; charset=utf-8",
                        data: "{'value':'" + value + "'}",
                        async: false,
                        success: function (data) {
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#task-table tbody").append("<tr><td>" + value1[0] + "</td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td><td>" + value1[5] + "</td><td><button type='button'  class='edit-btn btn btn-primary col-md-12' >Edit</button></td></tr>");
        ...
        <script>
            $(document).ready(function () {
                $("#update").click(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Finance_Initials.aspx/updateFinanceInitials',
                        contentType: "application/json; charset=utf-8",
                        data: "{'financeID':'" + financeID + "','venue':'" + venue + "','fianceMethod':'" + fianceMethod + "','financeCode':'" + financeCode + "','inc':'" + inc + "','status':'" + status + "'}",
                        async: false,
                        success: function (data) {
                            $("#TextBox2").val("");
                            $("#TextBox3").val("");
    ...
    (function (document) {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Finance_Initials.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $("#searchPro").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Finance_Initials.aspx/searchProfile',
                    contentType: "application/json; charset=utf-8",
            ...
            $(document).on('click','#profileclick',function() {
              ...
              //  var profileID = $("#profileclick").text();
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'Finance_Initials.aspx/getlink',
                    contentType: "application/json; charset=utf-8",
                    data: "{'profileID':'" + profileID + "'}",
                    async: false,
                    success: function (data) {
