                                              ...
                                              <div class="modal-body">
                                                  <div class="container-fluid">
                                                      ...
                                                      <div class="table-responsive">
                                                          ...
                                                          <table class="table table-striped table-hover" id="task-table7">
                                                              <thead>
                                                                  <tr>
                                                                      <th>Name</th>
                                                                  </tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'Admin_Fee.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {

                    $("#task-table7 tbody").empty();
                    ...
                    $.each(subJson, function (key, value) {
                        ...
                        $.each(value, function (index1, value1) {
                                ...
                                $("#task-table7 tbody").append("<tr><td><a href='"+value1[1]+"'>"+value1[0]+"</a></td></tr>");
