...
public class Queries2
{
 ...
 public static DataSet LoadVenueCountry1()
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Venue_Country_Name  from VenueCountry where Venue_Country_Status = 'Active'", cs1);
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
            da.Fill(ds);
        }
 ...
 public static int InsertProfile(string Profile_ID, DateTime Profile_Date_Of_Insertion, string Profile_Created_By, string Profile_Venue_Country, string Profile_Venue, string Profile_Group_Venue, string Profile_Marketing_Program, string Profile_Agent, string Profile_Agent_Code, string Profile_Member_Type1, string Profile_Member_Number1, string Profile_Member_Type2, string Profile_Member_Number2, string Profile_Employment_status, string Profile_Marital_status, string Profile_NOY_Living_as_couple, string Office, string Comments, string Manager, string Photo_identity, string Card_Holder, string Reception, string SubVenue, string regTerms, string VP_ID, string Company_Name, string RegTerms2,string  Secondary_Employment_Status, string Lead_Source ,string Pre_Arrival,string comment2,string Verification,string Promo_Source,string Tele_agent)
    {

        int rowsAffected = 0;
 	string subVenueGroup="";
	string leadOffices=""; string Sale_Marketing_Source="";
        SqlDataAdapter da = new SqlDataAdapter();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Profile values(@Profile_ID,	@Profile_Date_Of_Insertion,	@Profile_Created_By,	@Profile_Venue_Country,	@Profile_Venue,	@Profile_Group_Venue,	@Profile_Marketing_Program,	@Profile_Agent,	@Profile_Agent_Code,	@Profile_Member_Type1,	@Profile_Member_Number1,	@Profile_Member_Type2,	@Profile_Member_Number2,	@Profile_Employment_status,	@Profile_Marital_status,	@Profile_NOY_Living_as_couple,@Office,@Comments,@Manager,@Photo_identity,@Card_Holder,@Reception,@SubVenue,@regTerms,@VP_ID,@Company_Name,@RegTerms2,@Secondary_Employment_Status,@Lead_Source,@Pre_Arrival,@comment2,@Verification,@Promo_Source,@Tele_agent,@subVenueGroup,@leadOffices,@Sale_Marketing_Source)", cs1);
                da.InsertCommand.Parameters.Add("@Profile_ID", SqlDbType.VarChar).Value = Profile_ID;
                da.InsertCommand.Parameters.Add("@Profile_Date_Of_Insertion", SqlDbType.DateTime).Value = Profile_Date_Of_Insertion;
                da.InsertCommand.Parameters.Add("@Profile_Created_By", SqlDbType.VarChar).Value = Profile_Created_By;
                da.InsertCommand.Parameters.Add("@Profile_Venue_Country", SqlDbType.VarChar).Value = Profile_Venue_Country;
    ...
    public static int InsertSecondaryProfile(string Profile_Secondary_ID, string Profile_Secondary_Title, string Profile_Secondary_Fname, string Profile_Secondary_Lname, string Profile_Secondary_DOB, string Profile_Secondary_Nationality, string Profile_Secondary_Country, string Profile_ID, string Secondary_Age, string Secondary_Designation, string Secondary_Language)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            catch (Exception ex)
            {
                ...
                //throw new Exception(msg, ex);
                string msg = "Error in Insert Secondary Profile Query FN: InsertSecondaryProfile " + " " + ex.Message;
    ...
    public static int InsertSub_Profile1(string Sub_Profile1_ID, string Sub_Profile1_Title, string Sub_Profile1_Fname, string Sub_Profile1_Lname, string Sub_Profile1_DOB, string Sub_Profile1_Nationality, string Sub_Profile1_Country, string Profile_ID, string Sub_Profile1_Age)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            ...
            catch (Exception ex)
            {
                ...
                string msg = "Error in Insert Sub Profile1 Query  FN: InsertSub_Profile1 " + " " + ex.Message;
    ...
    public static int InsertSub_Profile2(string Sub_Profile2_ID, string Sub_Profile2_Title, string Sub_Profile2_Fname, string Sub_Profile2_Lname, string Sub_Profile2_DOB, string Sub_Profile2_Nationality, string Sub_Profile2_Country, string Profile_ID, string Sub_Profile2_Age)
    {
        ...
        using (SqlConnection cs2 = Queries.GetDBConnection())
        {
            ...
            catch (Exception ex)
            {
                ...
                string msg = "Error in Insert Sub Profile2 Query FN: InsertSub_Profile2 " + " " + ex.Message;
    ...
    public static int InsertSub_Profile3(string Sub_Profile3_ID, string Sub_Profile3_Title, string Sub_Profile3_Fname, string Sub_Profile3_Lname, string Sub_Profile3_DOB, string Sub_Profile3_Nationality, string Sub_Profile3_Country, string Profile_ID, string Sub_Profile3_Age)
    {
        ...
        using (SqlConnection cs2 = Queries.GetDBConnection())
        {
            ...
            catch (Exception ex)
            {
                ...
                string msg = "Error in Insert Sub Profile3 Query FN: InsertSub_Profile3  " + " " + ex.Message;
    ...
    public static int InsertSub_Profile4(string Sub_Profile4_ID, string Sub_Profile4_Title, string Sub_Profile4_Fname, string Sub_Profile4_Lname, string Sub_Profile4_DOB, string Sub_Profile4_Nationality, string Sub_Profile4_Country, string Profile_ID, string Sub_Profile4_Age)
    {
        ...
        using (SqlConnection cs2 = Queries.GetDBConnection())
        {
            ...
            catch (Exception ex)
            {
                ...
                string msg = "Error in Insert Sub Profile4 Query FN: InsertSub_Profile4 " + " " + ex.Message;
    ...
    {
        int rowsAffected = 0;
 string Primary_home_cc=""; string Primary_home_num=""; string Secondary_home_cc="";string Secondary_home_num="";
   ...
   /* public static DataSet LoadProfileOnCreation(string profileid)
    ...
    public static DataSet LoadContResort(string office)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Contract_Resort_Name from Contract_Resort where Contract_Resort_Status='Active' and office='"+office+"' order by 1", cs1);
            //SqlCmd.Parameters.Add("@conttype", SqlDbType.VarChar).Value = conttype;
            //SqlCmd.Parameters.Add("@Printpdf_office", SqlDbType.VarChar).Value = office;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
   ...
   public static int InserPurchaseService(string PS_ID, string PS_Deposit_Pay_Method, string PS_Deposit, string PS_Deposit_PA, string PS_Deposit_SA, string PS_PA_Admission, string PS_SA_Application, string PS_PA_Administration, string PS_SA_Administration, string PS_Total_Purchase, string PS_Total_Service, string PS_Country_Tax, string PS_Grand_Total, string PS_PA_Balance_Due, string PS_SA_Balance_Due, string PS_PA_No_Install, string PS_SA_No_Install, string PS_PA_FInstall_Date, string PS_SA_FInstall_Date, string PS_PA_Install_Amt, string PS_SA_Install_Amt, string PS_PA_FInstall_Amt, string PS_SA_FInstall_Amt, string PS_PA_Balance_Due_Dates, string PS_SA_Balance_Due_Dates, string PS_Remarks, string PS_EURO_Rate, string PS_AUS_Rate, string PS_GBP_Rate, string PS_IDA_Rate, string PS_Pay_Protect, string PS_YOInterest, string Profile_ID, string Contract_Finance_ID, string Total_Balance, DateTime PS_Date_Of_Insert, string office, string PS_PA_Balance_Due_Dates2, string PS_SA_Balance_Due_Dates2, string PS_Remarks2, string PS_Initial_Deposit, string PS_Bal_Deposit,string PS_Deposit_Date,string PS_CPA_Commnet,string PS_Ini_Bal_Install,string PS_Ini_Bal_Install_Amt,string PS_Balloon_Pay,string PS_PA_Last_Install_Date,string PS_Deposit_Comment,string PS_BalanceDue_TD,string PS_Deposit_Old,string PS_Country_Tax_Old)
    ...
    public static string getExchangeRate(string midval)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            if (midval == "EUR")
            {
                SqlCommand scmd = new SqlCommand("select ERates_EUR from Exchange_Rate where ERates_Status ='Active'and office='IVO'", cs1);
                //scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
            ...
            {
                SqlCommand scmd = new SqlCommand("select ERates_AUD from Exchange_Rate where ERates_Status ='Active' and office='IVO'", cs1);
                //scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                //val = (float)scmd.ExecuteScalar();
                val = (double)scmd.ExecuteScalar();
            ...
            {
                SqlCommand scmd = new SqlCommand("select ERates_GBP from Exchange_Rate where ERates_Status ='Active' and office='IVO'", cs1);
                //scmd.Parameters.Add("@midval", SqlDbType.VarChar).Value = midval;
                //val = (float)scmd.ExecuteScalar();
                val = (double)scmd.ExecuteScalar();
                // = scmd.ExecuteScalar().tostring();
 ...
 public static SqlDataReader getgiftoption(string ProfileID)
   ...
   public static string LoadPointCont(string office,string club_name,string venuecountry, string venue, string mark, string markp)
    ...
    public static string LoadFracCont(string office, string club_name, string venuecountry, string venue, string mark, string markp,string resort)
    {
        //SqlDataAdapter da;
        //DataSet dt = new DataSet();
 ...
 public static int InsertTourDetails(string Tour_Details_ID, string Tour_Details_Guest_Status, string Tour_Details_Guest_Sales_Rep, string Tour_Details_Tour_Date, string Tour_Details_Sales_Deck_Check_In, string Tour_Details_Sales_Deck_Check_Out, string Tour_Details_Taxi_In_Price, string Tour_Details_Taxi_In_Ref, string Tour_Details_Taxi_Out_Price, string Tour_Details_Taxi_Out_Ref, string Profile_ID, string Tour_Details_Qualified_Status,int Week_number)
    ...
    public static int UpdateProfile(string ProfileID, string Profile_Venue_Country, string Profile_Venue, string Profile_Group_Venue, string Profile_Marketing_Program, string Profile_Agent, string Profile_Agent_Code, string Profile_Member_Type1, string Profile_Member_Number1, string Profile_Member_Type2, string Profile_Member_Number2, string Profile_Employment_status, string Profile_Marital_status, string Profile_NOY_Living_as_couple, string manager, string Photo_identity, string Card_Holder, string Comments, string reception, string SubVenue, string regTerms,string VP_ID, string regTerms2,string Secondemploymentstatus, string Leadsource, string Pre_Arrival,string verifi, string Promo_Source, string Tele_Agent)
    {
        int rowsaffected = 0;
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
...
public static int UpdateTourDetails(string ProfileID, string Tour_Details_Guest_Status, string Tour_Details_Guest_Sales_Rep, string Tour_Details_Tour_Date, string Tour_Details_Sales_Deck_Check_In, string Tour_Details_Sales_Deck_Check_Out, string Tour_Details_Taxi_In_Price, string Tour_Details_Taxi_In_Ref, string Tour_Details_Taxi_Out_Price, string Tour_Details_Taxi_Out_Ref, string QualiStatus, int Week_number)
  ...
  public static DataTable Seapdate(string date)
    ...
    public static DataSet LoadSubVenue(string venue1, string subvenue)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select SVenue_Name from Sub_Venue where Venue2_ID in (select Venue2_ID from venue2 where Venue2_Name=@venue) and SVenue_Name <> '" + subvenue + "' and SVenue_Status='Active'", cs1);
    ...
    public static DataSet LoadFlybuyAgent()
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select FAgent_Name,LEFT(FAgent_Name,PATINDEX('%[0-9]%',FAgent_Name)-1) as alpha,SUBSTRING(FAgent_Name,PATINDEX('%[0-9]%',FAgent_Name),LEN(FAgent_Name)) as num from Flybuy_Agent where fAgent_status = 'Active' order by LEFT(FAgent_Name, PATINDEX('%[0-9]%', FAgent_Name) - 1), convert(int, SUBSTRING(FAgent_Name, PATINDEX('%[0-9]%', FAgent_Name), LEN(FAgent_Name)))", cs1);
            //SqlCmd.Parameters.Add("@ProfileID", SqlDbType.VarChar).Value = ProfileID;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
            da.Fill(ds);
    ...
    public static DataSet LoadPreArrival()
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Pre_Arrival_Name,LEFT(Pre_Arrival_Name,PATINDEX('%[0-9]%',Pre_Arrival_Name)-1) as alpha,SUBSTRING(Pre_Arrival_Name,PATINDEX('%[0-9]%',Pre_Arrival_Name),LEN(Pre_Arrival_Name)) as num  from Flybuy_Pre_Arrival where Pre_Arrival_Status='Active' and Pre_Arrival_Expiry_Date='' order by LEFT(Pre_Arrival_Name, PATINDEX('%[0-9]%', Pre_Arrival_Name) - 1), convert(int, SUBSTRING(Pre_Arrival_Name, PATINDEX('%[0-9]%', Pre_Arrival_Name), LEN(Pre_Arrival_Name)))", cs1);
            //SqlCmd.Parameters.Add("@ProfileID", SqlDbType.VarChar).Value = ProfileID;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
            da.Fill(ds);
    ...
    public static DataSet LoadVerification()
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Verification_Name, LEFT(Verification_Name, PATINDEX('%[0-9]%', Verification_Name) - 1) as alpha, SUBSTRING(Verification_Name, PATINDEX('%[0-9]%', Verification_Name), LEN(Verification_Name)) as num from flybuy_verification where Verification_Status = 'Active' and Verification_Expiry_Date = '' order by LEFT(Verification_Name, PATINDEX('%[0-9]%', Verification_Name) - 1), convert(int, SUBSTRING(Verification_Name, PATINDEX('%[0-9]%', Verification_Name), LEN(Verification_Name)))", cs1);
            //SqlCmd.Parameters.Add("@ProfileID", SqlDbType.VarChar).Value = ProfileID;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
            da.Fill(ds);
...
public static DataTable Yearbudget(string input, string country)
    {

        using (SqlConnection cs1 = Queries2.GetDBConnection())
        {

            SqlCommand cmd_sp = new SqlCommand("YearlyBudget", cs1);
            // cmd.CommandText = "holiday_confirm";
            cmd_sp.CommandType = CommandType.StoredProcedure;
            cmd_sp.Parameters.AddWithValue("@input", input);
            cmd_sp.Parameters.AddWithValue("@country", country);
...
public static DataSet LoadPrintFiles2(string conttype, string office, string globContClub, string PaymentMethod2,string affil2, string CrownCurr , string FracMem)
    {
        SqlDataAdapter da;
        DataSet ds = new DataSet();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active' and Printpdf_Affil='' and Printpdf_Fina='' and Printpdf_Fina_Curr='' and Printpdf_FracMem=@frac_mem union  select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active' and Printpdf_Affil=@affil and Printpdf_Fina='' and Printpdf_Fina_Curr='' and Printpdf_FracMem=@frac_mem union select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active'  and Printpdf_Affil=@affil and Printpdf_Fina=@fina and Printpdf_Fina_Curr='' and Printpdf_FracMem=@frac_mem union select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active'  and Printpdf_Affil='' and Printpdf_Fina=@fina and Printpdf_Fina_Curr='' and Printpdf_FracMem=@frac_mem union select LTRIM(RTRIM(p.Printpdf_name)) as Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office and p.Print_pdf_Club=@Print_pdf_Club and Printpdf_Status='Active'  and Printpdf_Affil='' and Printpdf_Fina=@fina and Printpdf_Fina_Curr= @fina_curr and Printpdf_FracMem=@frac_mem ", cs1);
            SqlCmd.Parameters.Add("@ContractType_name", SqlDbType.VarChar).Value = conttype;
            SqlCmd.Parameters.Add("@Printpdf_office", SqlDbType.VarChar).Value = office;
            SqlCmd.Parameters.Add("@Print_pdf_Club", SqlDbType.VarChar).Value = globContClub;
            ...
            SqlCmd.Parameters.Add("@frac_mem", SqlDbType.VarChar).Value = FracMem;
