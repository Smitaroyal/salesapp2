...
#FTotalTaxTextBox,#TotalTaxTextBox{
    display:none;
}
</style>
            ...
            <table style="width:100%;">
               ...
               <tr>
                ...
                <td><asp:TextBox ID="ContractdetailsIDTextBox" Font-Size="Small" style="width:200px; height:20px" runat="server" Enabled="True" Visible="False"></asp:TextBox></td>
                    ...
                    <tr>
                    <td width="100px" ><asp:Label ID="lblwoldLoanAgreement" runat="server" Font-Size="Small" Text="Label">Old Loan Agreement No</asp:Label></td>
