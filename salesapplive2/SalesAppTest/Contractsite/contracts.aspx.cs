...
public partial class _Default : System.Web.UI.Page
{
  ...
  //  static string ogiftprice1, ogiftprice2, ogiftprice3, ogiftprice4, ogiftprice5, ogiftprice6, ogiftprice7;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string user1 = "administrator";//(string)Session["username"];
        if (user1 == null)
        {
...
Array.Clear(er, 0, er.Length);
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                test1 = helo1(VenueCountryDropDownList.SelectedItem.Text, VenueDropDownList.SelectedItem.Text, club, GroupVenueDropDownList.SelectedItem.Text, conttype, MarketingPrgmDropDownList.SelectedItem.Text,resort);
                GenContNumb = test1;
          ...
          /*  if (ContUPDG != "UPDW")
            ...
            else if (conttype == "Trade Into Points")
            {
              ...
              //  string DepositPayMethodTP = "";//DPMTPointsDropDownList.SelectedItem.Text;
                ...
                BalanceDueDatesSATP, remarkTP, EuroRatesP, AusRatesP, GbpRates, IdaRates, UsePayProtectP, YearOfInterestP, ProfileIDTextBox.Text, contfinaid, TotalBalanceTP, DateTime.Now, Session["GlobOffice"].ToString(),BalanceDueDatesPATP2,BalanceDueDatesSATP2,remarkTP2,InitDepotp,BalDepotp,DepoDatetp,CPATP,IniBalNoInstallTP,IniBalInstAmtTP,BalloonPay,LastInstDate,CPADepoTP, BalanceDuePATPTD, UDOldDeposit, UDOldTax);
            ...
            string ContType1 = DropDownList40.SelectedItem.Text;
            DataSet ds21 = Queries2.LoadPrintFiles2(ContType1, Session["GlobOffice"].ToString(),GlobContClub, PaymentMethod2, affil2, CrownCurr,resort);
   ...
   /* protected void Button5_Click(object sender, EventArgs e)
    ...
    public static string helo1(string name,string venue,string club,string mark, string conttype, string markp,string resort)
    {
        //return "Hello "+name;
        string finaInstI = "";
        ...
        {
             finaInstI = Queries2.LoadFracCont(HttpContext.Current.Session["GlobOffice"].ToString(), club, name, venue, mark,markp,resort);
        }
        //using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnectionString"].ConnectionString))
        //{
        //    /*SqlCommand SqlCmd = new SqlCommand("select Contract_Code from Contract_Club where Contract_Club_Name=@club_name  and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)and Venue_ID in (select Venue_ID from venue where Venue_Name = @venue)", cs1);
