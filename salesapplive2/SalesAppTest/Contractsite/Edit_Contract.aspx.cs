...
public partial class Contractsite_Edit_Contract : System.Web.UI.Page
{
 ...
 //   static string text11,desc,text12,amot1,text13,date,text14,curr, GenContNumbglob, DealRegDate, regTerms, regTerms2,scweekno;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string contractno = "KRRM9/191218/18642";
        //user = "Administrator";
        // officeo = "ivo";

        TextContractNumb.Text = contractno;

        string office = "IVO";//Queries.GetOffice(user);
...
Array.Clear(er, 0, er.Length);
    ...
    public void Button5_Click(object sender, EventArgs e)
    {
            ...
            if (String.Compare(Session["oDealDrawer"].ToString(), DealDrawer) != 0)
        {
            ...
            int statchange = Queries2.InsertStatusChange(scid, Session["oDealDrawer"].ToString(), DealDrawer, SC_Cancel_Group_Venue, SC_Cancel_Reason, SC_Cancel_Date, user, Session["ProfileIDo"].ToString(), Session["fracido"].ToString(), DateTime.Now.ToString(),"");
        }
            else
        {
            if(Session["oDealDrawer"].ToString() == "Cancel")
            {
                     ...
                     if (String.Compare(oCGroupvenueDropDownList, SC_Cancel_Group_Venue) != 0 || String.Compare(oCReasonDropDownList, SC_Cancel_Reason) != 0 || String.Compare(oCancelDateTextBox, SC_Cancel_Date) != 0)
                {
                    //SC_Cancel_Group_Venue,SC_Cancel_Reason,SC_Cancel_Date
                      ...
                      int updstatuschange = Queries2.Update_Status_change(SC_Cancel_Group_Venue, SC_Cancel_Reason, SC_Cancel_Date,DateTime.Now.ToString(), Session["oDealDrawer"].ToString(), Session["fracido"].ToString());
                }
