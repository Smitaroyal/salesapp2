                       ...
                       if (dealstat == 'Deal' || dealstat == 'Top Drawer'){
                           ...
                           } else if (conttype == 'Trade Into Points')
                           {
                              ...
                              // resort = "";
                               ...
                               v5 = document.getElementById("ResortDropDownListTF");
                               resort1 = v5.options[v5.selectedIndex].text;
                               ...
                               club = "";
                               v5 = document.getElementById("ResortDropDownListF");
                               resort1 = v5.options[v5.selectedIndex].text;
                               if(resort1 == 'FRACTIONAL MEMBER')
                               {
                                   resort = 'FM';
                         ...
                         //  alert('kkk');
                           $.ajax({
                               ...
                               data: "{'name': '" + ven + "','venue': '" + venue + "','club': '" + club + "','mark': '" + mark + "','conttype': '" + conttype + "','markp': '" + markp + "','resort': '" + resort + "'}",
                               dataType: "json",
                               //called on jquery ajax call success
                               success: function (data) {
                                   // alert(data.d);
           ...
           function adminfee()
           {
              ...
              else if (conttype == "Trade Into Points")
              {
                 ...
                 // document.getElementById("TextAppliFeesTP").value = result;
                  document.getElementById("TextCountryTaxTP").value = Math.round((parseInt(PurchaseP) * 0.4762 ) * 0.1);
