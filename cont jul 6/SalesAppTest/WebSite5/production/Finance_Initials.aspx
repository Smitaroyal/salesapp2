...
<head runat="server">
    ...
    <style>
        ...
        #img1 {
         ...
         #update,#finance_iniID,#head,#Type,#Venue,#directory,#insert,#financeType,#FinanceCode,#Value,#Status{
             display:none;
         }
        ...
        $(document).ready(function () {
            ...
            $("#insert").click(function () {
                ...
                $.ajax({
                    ...
                    data: "{'venue':'" + venue + "','fianceMethod':'" + fianceMethod + "','financeCode':'" + financeCode + "','inc':'" + inc + "','type':'" + type + "'}",
                    async: false,
