...
public partial class WebSite5_production_Users : System.Web.UI.Page
{
   static string office1;
    ...
    public static string getAllUsers()
    {
        ...
        SqlConnection sqlcon = new SqlConnection(conn);
        String JSON = "{\n \"names\":[";
        string query = "select u.username,u.password,u.name,u.userstatus,u.office,d.[Dept Code],d.[Dept Name],g.[Group Id],g.[Group Name],u.Email,u.Title from users u join Department d on u.Dept=d.[Dept Code] join user_Group g on u.[Group Id]=g.[Group Id] where Office='"+office1+"' ;";
        sqlcon.Open();
        SqlCommand cmd = new SqlCommand(query, sqlcon);
        SqlDataReader reader = cmd.ExecuteReader();
        while (reader.Read())
