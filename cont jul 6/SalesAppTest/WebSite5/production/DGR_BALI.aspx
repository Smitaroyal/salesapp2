<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DGR_BALI.aspx.cs" Inherits="WebSite5_production_Reports" %>
...
<body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <h3 class="text-center">DGR BALI</h3>
              </div>
              </div>
            </div>
              <br /><br />
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="">
                               <div class="form-group">
                                    ...
                                    <asp:TextBox ID="TextBox1" placeholder="Select Date" class="form-control" runat="server" value="DGR" ReadOnly="true"></asp:TextBox>
     				 ...
     				 <div class="input-group-addon">
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="Vcountry">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="venueCountry" id="venueCountry" >
                                           <option disabled selected value>--Select an Option--</option>
                                        <%Response.Write(getvenueCountry()); %>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="hell1">
                                <div class="row">
                            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="marketingProgram">
                                <div class="form-group">
                                    <label for="sel1">Marketing Program:</label>
                                    <select class="form-control" name="marktProgram2" id="marktProgram2" multiple="multiple">
                                        <%--<option disabled selected value>--Select an Option--</option>--%>
        ...
        $(document).ready(function () {
            ...
            $("#venue").change(function () {
                    ...
                    $.ajax({
                        ...
                        type: 'Post',
                        url: 'DGR_BALI.aspx/getMarketingProgram',
                          ...
                          //  alert(data.d);
                            ...
                            $.each(subJson, function (key, value) {
                                ...
                                $.each(value, function (index1, value1) {
                                    ...
                                    $("#marktProgram2").append("<option value='" + value1[0] + "'>" + value1[0] + "</option>");
                                });
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                type: 'Post',
                url: 'DGR_BALI.aspx/getAdminRights',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                async: false,
                success: function (data) {
