                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                <br />
                                <h5 class="text-center">SEAP RECAP</h5>
                            </div>
                        </div>
                    </div>
                    <br />
 				...
 				<div class="input-group-addon">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="venueGroup" id="venueGroup" multiple="multiple">
                         ...
                         <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="subVenue" id="subVenue" multiple="multiple">
