...
public partial class Contractsite_ProfileDetailsView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblcomments.Text = ds2.Tables[0].Rows[0]["comments"].ToString();
        ...
        lblmale0.Text = ds2.Tables[0].Rows[0]["Profile_Primary_DOB"].ToString();
        lblfemale0.Text = ds2.Tables[0].Rows[0]["Profile_Secondary_DOB"].ToString();
...
salesrepDropDownList.Items.Insert(0, new ListItem(ds2.Tables[0].Rows[0]["Tour_Details_Guest_Sales_Rep"].ToString(), ""));
    ...
    {
        DataSet dsprofile = Queries.LoadProfielDetailsFull(lblprofileid.Text);
